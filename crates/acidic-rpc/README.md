...
Run `nx build acidic-rpc` to build the library.

### Running unit tests

Run `nx test acidic-rpc` to execute the unit tests via [Jest](https://jestjs.io).

### Linting

Run `nx lint acidic-rpc` to run [ESLint](https://eslint.org/) on the package.
