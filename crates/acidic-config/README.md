...
# Acidic Configuration Crate

A crate used to determine the Acidic configuration options during execution.
...
Run `nx build acidic-config` to build the library.

### Running unit tests

Run `nx test acidic-config` to execute the unit tests via [Jest](https://jestjs.io).

### Linting

Run `nx lint acidic-config` to run [ESLint](https://eslint.org/) on the package.
