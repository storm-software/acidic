...
A core crate containing the Acidic Engine definitions and validation logic. It is used by various other Acidic packages to run their processes.
...
Run `nx build acidic-server` to build the library.

### Running unit tests

Run `nx test acidic-server` to execute the unit tests via [Jest](https://jestjs.io).

### Linting

Run `nx lint acidic-server` to run [ESLint](https://eslint.org/) on the package.
