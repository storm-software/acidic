...
impl NativeTypeErrorFactory {
  ...
  pub fn new_scale_larger_than_precision_error(self, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
  ...
  pub fn new_incompatible_native_type_with_index(self, message: &str, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
  ...
  pub fn new_incompatible_native_type_with_unique(self, message: &str, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
  ...
  pub fn new_incompatible_native_type_with_id(self, message: &str, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
  ...
  pub fn new_argument_m_out_of_range_error(self, message: &str, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
  ...
  pub fn native_type_name_unknown(self, span: Span) -> SchemaError {
    SchemaError::new(
      format!(
