...
impl SchemaError {
  ...
  pub fn new_literal_parser_error(literal_type: &str, raw_value: &str, span: Span) -> SchemaError {
    Self::new(
  ...
  pub fn new_invalid_prefix_for_native_types(
    ...
    SchemaError::new(msg, span)
  }

  pub fn new_native_types_not_supported(connector_name: String, span: Span) -> SchemaError {
    let msg = format!("Native types are not supported with {connector_name} connector");
    Self::new(msg, span)
  }

  pub fn new_reserved_scalar_type_error(type_name: &str, span: Span) -> SchemaError {
    let msg = format!("\"{type_name}\" is a reserved scalar type name and cannot be used.");
    Self::new(msg, span)
  }

  pub fn new_duplicate_enum_database_name_error(span: Span) -> SchemaError {
  ...
  pub fn new_duplicate_default_argument_error(arg_name: &str, span: Span) -> SchemaError {
  ...
  pub fn new_enum_validation_error(message: &str, enum_name: &str, span: Span) -> SchemaError {
    Self::new(
  ...
  pub fn new_legacy_parser_error(message: impl Into<Cow<'static, str>>, span: Span) -> SchemaError {
  ...
  pub fn new_environment_functional_evaluation_error(var_name: String, span: Span) -> SchemaError {
  ...
  pub fn new_default_unknown_function(function_name: &str, span: Span) -> SchemaError {
  ...
  pub fn new_invalid_model_error(msg: &str, span: Span) -> SchemaError {
    SchemaError::new(format!("Invalid model: {msg}"), span)
  }
  ...
  pub fn new_native_type_parser_error(native_type: &str, span: Span) -> SchemaError {
  ...
  pub fn new_type_mismatch_error(
    ...
    let msg =
      format!("Expected a {expected_type} value, but received {received_type} value `{raw}`.");
    Self::new(msg, span)
  }

  pub fn new_schemas_array_empty_error(span: Span) -> SchemaError {
    let msg = "If provided, the schemas array can not be empty.".to_string();
    Self::new(msg, span)
  }

  pub fn new_referential_integrity_and_relation_mode_cooccur_error(span: Span) -> SchemaError {
