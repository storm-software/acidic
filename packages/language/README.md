...
This package contains a [JSON Schema v7 definition](./res/acidic.schema.json) for the Acidic language. This is not used by the Acidic Language Server, but is provided for use by other tools that may need to validate Acidic files.
