import type { AsyncStringStorage, SyncStringStorage } from "jotai/vanilla/utils/atomWithStorage";

const vsCode = (global as any)?.Window?.acquireVsCodeApi();

export const createVsCodeStorage = (): AsyncStringStorage | SyncStringStorage => {
