...
import { TreeItem, TreeItemCollapsibleState, type TreeView, Uri } from "vscode";
...
export class ActionsTreeItem extends TreeItem {
  ...
  constructor(
    ...
    this.command = {
      title: commandString,
      command: commandString === "generate" ? "nxConsole.revealWebViewPanel" : "nx.run",
      tooltip: "",
      arguments:
  ...
  static getIconUri(extensionPath: string): { light: Uri; dark: Uri } | undefined {
    return {
