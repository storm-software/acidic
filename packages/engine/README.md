...
This package contains the engine functionality of Acidic. It is used by various other Acidic packages to run their processes.
...
Run `nx lint engine` to run [ESLint](https://eslint.org/) on the package.
