...
var il = (ze, Ce, We) =>
  Ce in ze
    ? rl(ze, Ce, { enumerable: !0, configurable: !0, writable: !0, value: We })
    : (ze[Ce] = We);
var ft = (ze, Ce, We) => (il(ze, typeof Ce != "symbol" ? Ce + "" : Ce, We), We);
(function () {
  "use strict";
  class ze {
    constructor() {
...
` +
  ...
  function Dn(e) {
    if (e instanceof Error) {
      ...
      return {
        ...
        message: n,
        stack: r,
        noTelemetry: Ge.isErrorNoTelemetry(e)
      };
    }
    return e;
  }
  ...
  function ra(e) {
    return e instanceof ia
      ? !0
      : e instanceof Error && e.name === qt && e.message === qt;
  }
  ...
  (function (e) {
    function t(M) {
      return (
        M && typeof M == "object" && typeof M[Symbol.iterator] == "function"
      );
    }
    e.is = t;
    ...
    e.first = u;
    function o(M, z) {
      for (const D of M) if (z(D)) return !0;
      return !1;
    }
    e.some = o;
    function c(M, z) {
      for (const D of M) if (z(D)) return D;
    }
    e.find = c;
    function* h(M, z) {
      for (const D of M) z(D) && (yield D);
    }
    e.filter = h;
    function* d(M, z) {
      let D = 0;
      for (const p of M) yield z(p, D++);
    }
    e.map = d;
    function* f(...M) {
      for (const z of M) for (const D of z) yield D;
    }
    e.concat = f;
    function* g(M) {
      for (const z of M) for (const D of z) yield D;
    ...
    function v(M, z, D) {
      let p = D;
      for (const m of M) p = z(p, m);
      return p;
    }
    e.reduce = v;
    function w(M, z) {
      let D = 0;
      for (const p of M) z(p, D++);
    }
    e.forEach = w;
    function* y(M, z, D = M.length) {
      for (
        z < 0 && (z += M.length),
          D < 0 ? (D += M.length) : D > M.length && (D = M.length);
        z < D;
        z++
      )
        yield M[z];
    ...
    function L(M, z, D = (p, m) => p === m) {
      ...
      for (;;) {
        const b = p.next(),
          I = m.next();
        if (b.done !== I.done) return !1;
        if (b.done) return !0;
        if (!D(b.value, I.value)) return !1;
      }
    }
    e.equals = L;
  })(mt || (mt = {}));
  ...
  const fa =
    typeof ((Vt = ie == null ? void 0 : ie.versions) === null || Vt === void 0
      ? void 0
      : Vt.electron) == "string" &&
    (ie == null ? void 0 : ie.type) === "renderer";
  if (typeof navigator == "object" && !fa)
    (Se = navigator.userAgent),
      (jt = Se.indexOf("Windows") >= 0),
      (Gt = Se.indexOf("Macintosh") >= 0),
      (Se.indexOf("Macintosh") >= 0 ||
        Se.indexOf("iPad") >= 0 ||
        Se.indexOf("iPhone") >= 0) &&
        !!navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0,
      ($t = Se.indexOf("Linux") >= 0),
      (Nn = !0),
      ha({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
      (bt = et),
      (Xt = bt);
  else if (typeof ie == "object") {
    (jt = ie.platform === "win32"),
      (Gt = ie.platform === "darwin"),
      ($t = ie.platform === "linux"),
      $t && !!ie.env.SNAP && ie.env.SNAP_REVISION,
      ie.env.CI || ie.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
      (bt = et),
      (Xt = et);
    ...
    if (e)
      try {
        ...
        (bt = t.locale), (Xt = n || et), (da = t._translationsConfigFile);
      } catch {}
  ...
  Nn && re.importScripts;
  const ye = Se,
    pa = typeof re.postMessage == "function" && !re.importScripts;
  (() => {
    if (pa) {
      const e = [];
  ...
  const ga = !!(ye && ye.indexOf("Chrome") >= 0);
  ye && ye.indexOf("Firefox") >= 0,
    !ga && ye && ye.indexOf("Safari") >= 0,
    ye && ye.indexOf("Edg/") >= 0,
    ye && ye.indexOf("Android") >= 0;
  const ba = re.performance && typeof re.performance.now == "function";
  class wt {
    constructor(t) {
      (this._highResolution = ba && t),
  ...
  (function (e) {
    ...
    function t(D) {
      return (p, m = null, b) => {
        ...
        return (
          (C = D(
            x => {
              if (!I) return C ? C.dispose() : (I = !0), p.call(m, x);
            },
            null,
            b
          )),
    ...
    function l(...D) {
      return (p, m = null, b) =>
        oa(...D.map(I => I(C => p.call(m, C), null, b)));
    }
    e.any = l;
    function u(D, p, m, b) {
      let I = m;
    ...
    e.latch = h;
    function d(D, p, m) {
      return [e.filter(D, p, m), e.filter(D, b => !p(b), m)];
    }
    e.split = d;
    function f(D, p = !1, m = []) {
      let b = m.slice(),
    ...
    class g {
      constructor(p) {
        (this.event = p), (this.disposables = new Fe());
      }
      map(p) {
    ...
    function w(D, p, m = b => b) {
      const b = (...W) => x.fire(m(...W)),
        I = () => D.on(p, b),
        C = () => D.removeListener(p, b),
        x = new Te({ onFirstListenerAdd: I, onLastListenerRemove: C });
      return x.event;
    }
    e.fromNodeEventEmitter = w;
    function y(D, p, m = b => b) {
      const b = (...W) => x.fire(m(...W)),
        I = () => D.addEventListener(p, b),
        C = () => D.removeEventListener(p, b),
        x = new Te({ onFirstListenerAdd: I, onLastListenerRemove: C });
      return x.event;
    }
    ...
    function L(D, p) {
      let m = null;
      function b(C) {
        m == null || m.dispose(), (m = new Fe()), p(C, m);
      }
      b(void 0);
      const I = D(C => b(C));
      return pt(() => {
  ...
  class vt {
    constructor(t) {
      (this._listenerCount = 0),
        ...
        (this._name = `${t}_${vt._idPool++}`);
    }
    start(t) {
      (this._stopWatch = new wt(!0)), (this._listenerCount = t);
    }
    stop() {
      if (this._stopWatch) {
...
`)
  ...
  class Te {
    constructor(t) {
      ...
      (this._disposed = !1),
        ...
        (this._perfMon =
          !((n = this._options) === null || n === void 0) && n._profName
            ? new vt(this._options._profName)
            : void 0),
        (this._deliveryQueue =
    ...
    get event() {
      return (
        this._event ||
          (this._event = (t, n, r) => {
            var i, s, l;
            this._listeners || (this._listeners = new gt());
            ...
            this._leakageMon &&
              ...
              ((c = Qt.create()),
              (o = this._leakageMon.check(c, this._listeners.size + 1)));
            const h = new wa(t, n, c),
            ...
            return (
              r instanceof Fe ? r.add(f) : Array.isArray(r) && r.push(f), f
            );
          }),
        this._event
      );
    ...
    fire(t) {
      var n, r;
      if (this._listeners) {
        this._deliveryQueue || (this._deliveryQueue = new _a());
  ...
  function Yt(e) {
    const t = [];
    for (const n of Ta(e)) typeof e[n] == "function" && t.push(n);
    return t;
  }
  function ka(e, t) {
    const n = i =>
  ...
  (In = ge),
    (ge.ambiguousCharacterData = new Un(() =>
      JSON.parse(
    ...
    (ge.cache = new Ca(e => {
      ...
      function r(c, h) {
        if (!c) return h;
        const d = new Map();
        for (const [f, g] of c) h.has(f) && d.set(f, g);
        return d;
      }
      const i = In.ambiguousCharacterData.getValue();
  ...
  class Ba {
    ...
    sendMessage(t, n) {
      ...
      return new Promise((i, s) => {
        (this._pendingReplies[r] = { resolve: i, reject: s }),
          this._send(new Ha(this._workerId, r, t, n));
      });
    }
    listen(t, n) {
      let r = null;
      const i = new Te({
        onFirstListenerAdd: () => {
          (r = String(++this._lastSentReq)),
            ...
            this._send(new za(this._workerId, r, t, n));
        },
        onLastListenerRemove: () => {
          this._pendingEmitters.delete(r),
            this._send(new Fa(this._workerId, r)),
            (r = null);
        }
      });
      return i.event;
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        i => {
          this._send(new zn(this._workerId, n, i, void 0));
        },
        i => {
          i.detail instanceof Error && (i.detail = Dn(i.detail)),
            this._send(new zn(this._workerId, n, void 0, Dn(i)));
        }
      );
    }
    _handleSubscribeEventMessage(t) {
      const n = t.req,
        r = this._handler.handleEvent(
          ...
          this._send(new Wa(this._workerId, n, i));
        });
  ...
  function Wn(e) {
    return e[0] === "o" && e[1] === "n" && Hn(e.charCodeAt(2));
  }
  function Fn(e) {
    return /^onDynamic/.test(e) && Hn(e.charCodeAt(9));
  }
  function Pa(e, t, n) {
    const r = l =>
        function () {
  ...
  class qa {
    ...
    _handleMessage(t, n) {
      if (t === Ia) return this.initialize(n[0], n[1], n[2], n[3]);
    ...
    initialize(t, n, r, i) {
      ...
      const u = Pa(
        i,
        (o, c) => this._protocol.sendMessage(o, c),
        (o, c) => this._protocol.listen(o, c)
      );
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(u)),
          Promise.resolve(Yt(this._requestHandler)))
        : (n &&
  ...
  function Oa(e, t) {
    t = Bn(149417, t);
    for (let n = 0, r = e.length; n < r; n++) t = Bn(e.charCodeAt(n), t);
    return t;
  }
  class Pn {
    constructor(t) {
  ...
  function Va(e, t, n) {
    return new Ee(new Pn(e), new Pn(t)).ComputeDiff(n).changes;
  }
  class $e {
    static Assert(t, n) {
  ...
  class Ee {
    constructor(t, n, r = null) {
      ...
      const [i, s, l] = Ee._getElements(t),
        [u, o, c] = Ee._getElements(n);
    ...
    static _getElements(t) {
      ...
      if (Ee._isStringArray(n)) {
        ...
        for (let i = 0, s = n.length; i < s; i++) r[i] = Oa(n[i], 0);
        return [n, r, !0];
      }
    ...
    ElementsAreStrictEqual(t, n) {
      ...
      const r = Ee._getStrictElement(this._originalSequence, t),
        i = Ee._getStrictElement(this._modifiedSequence, n);
      return r === i;
    }
    ...
    _ComputeDiff(t, n, r, i, s) {
      ...
      return (
        s && (u = this.PrettifyChanges(u)), { quitEarly: l[0], changes: u }
      );
    }
    ComputeDiffRecursive(t, n, r, i, s) {
      ...
      const l = [0],
        u = [0],
        o = this.ComputeRecursionPoint(t, n, r, i, l, u, s),
        c = l[0],
        h = u[0];
      if (o !== null) return o;
      if (!s[0]) {
        ...
        return (
          s[0]
            ? (f = [new Le(c + 1, n - (c + 1) + 1, h + 1, i - (h + 1) + 1)])
            : (f = this.ComputeDiffRecursive(c + 1, n, h + 1, i, s)),
          this.ConcatenateChanges(d, f)
        );
      }
      return [new Le(t, n - t + 1, r, i - r + 1)];
    }
    WALKTRACE(t, n, r, i, s, l, u, o, c, h, d, f, g, v, w, y, k, _) {
      ...
      do {
        ...
        C === D || (C < p && c[C - 1] < c[C + 1])
          ? ((d = c[C + 1]),
            (v = d - m - i),
            d < b && z.MarkNextChange(),
            (b = d),
            z.AddModifiedElement(d + 1, v),
            (m = C + 1 - t))
          : ((d = c[C - 1] + 1),
            (v = d - m - i),
            d < b && z.MarkNextChange(),
            (b = d - 1),
            z.AddOriginalElement(d, v + 1),
            (m = C - 1 - t)),
          I >= 0 &&
            ((c = this.m_forwardHistory[I]),
            (t = c[0]),
            (D = 1),
            (p = c.length - 1));
      } while (--I >= -1);
      if (((L = z.getReverseChanges()), _[0])) {
        ...
        if (L !== null && L.length > 0) {
          ...
          (C = Math.max(C, W.getOriginalEnd())),
            (x = Math.max(x, W.getModifiedEnd()));
        }
        M = [new Le(C, f - C + 1, x, w - x + 1)];
      } else {
        (z = new qn()),
          (D = l),
          (p = u),
        ...
        do {
          ...
          C === D || (C < p && h[C - 1] >= h[C + 1])
            ? ((d = h[C + 1] - 1),
              ...
              d > b && z.MarkNextChange(),
              (b = d + 1),
              z.AddOriginalElement(d + 1, v + 1),
              (m = C + 1 - s))
            : ((d = h[C - 1]),
              (v = d - m - o),
              d > b && z.MarkNextChange(),
              (b = d),
              z.AddModifiedElement(d + 1, v + 1),
              (m = C - 1 - s)),
            I >= 0 &&
              ((h = this.m_reverseHistory[I]),
              (s = h[0]),
              (D = 1),
              (p = h.length - 1));
        } while (--I >= -1);
    ...
    ComputeRecursionPoint(t, n, r, i, s, l, u) {
      ...
      for (let m = 1; m <= v / 2 + 1; m++) {
        let b = 0,
          I = 0;
        (h = this.ClipDiagonalBound(_ - m, m, _, w)),
          (d = this.ClipDiagonalBound(_ + m, m, _, w));
        for (let x = h; x <= d; x += 2) {
          x === h || (x < d && y[x - 1] < y[x + 1])
            ? (o = y[x + 1])
            : (o = y[x - 1] + 1),
          ...
          if (
            ((y[x] = o),
            o + c > b + I && ((b = o), (I = c)),
            !p && Math.abs(x - L) <= m - 1 && o >= k[x])
          )
            return (
              (s[0] = o),
              (l[0] = c),
              W <= k[x] && 1447 > 0 && m <= 1447 + 1
                ? this.WALKTRACE(
                    _,
                    h,
                    d,
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(b, C)
        )
          return (
            (u[0] = !0),
            (s[0] = b),
            ...
            C > 0 && 1447 > 0 && m <= 1447 + 1
              ...
              : (t++, r++, [new Le(t, n - t + 1, r, i - r + 1)])
          );
        (f = this.ClipDiagonalBound(L - m, m, L, w)),
          (g = this.ClipDiagonalBound(L + m, m, L, w));
        for (let x = f; x <= g; x += 2) {
          x === f || (x < g && k[x - 1] >= k[x + 1])
            ? (o = k[x + 1] - 1)
            : (o = k[x - 1]),
        ...
        if (m <= 1447) {
          ...
          (x[0] = _ - h + 1),
            Xe.Copy2(y, h, x, 1, d - h + 1),
            this.m_forwardHistory.push(x),
            (x = new Int32Array(g - f + 2)),
            (x[0] = L - f + 1),
            Xe.Copy2(k, f, x, 1, g - f + 1),
    ...
    PrettifyChanges(t) {
      ...
      for (let n = t.length - 1; n >= 0; n--) {
        ...
        for (let d = 1; ; d++) {
          ...
          if (
            f < i ||
            g < s ||
            (l && !this.OriginalElementsAreEqual(f, f + r.originalLength)) ||
            (u && !this.ModifiedElementsAreEqual(g, g + r.modifiedLength))
          )
            break;
          const w =
            (f === i && g === s ? 5 : 0) +
      ...
      if (this._hasStrings)
        for (let n = 1, r = t.length; n < r; n++) {
          const i = t[n - 1],
            s = t[n],
            l = s.originalStart - i.originalStart - i.originalLength,
            u = i.originalStart,
          ...
          if (l < 5 && c < 20 && f < 20) {
            ...
            if (g) {
              ...
              (v !== i.originalStart + i.originalLength ||
                w !== i.modifiedStart + i.modifiedLength) &&
                ((i.originalLength = v - i.originalStart),
                (i.modifiedLength = w - i.modifiedStart),
                (s.originalStart = v + l),
                (s.modifiedStart = w + l),
    ...
    _boundaryScore(t, n, r, i) {
      const s = this._OriginalRegionIsBoundary(t, n) ? 1 : 0,
        l = this._ModifiedRegionIsBoundary(r, i) ? 1 : 0;
      return s + l;
    }
    ConcatenateChanges(t, n) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
        ...
        return (
          ...
          (i[t.length - 1] = r[0]),
          Xe.Copy(n, 1, i, t.length, n.length - 1),
          i
        );
      } else {
        const i = new Array(t.length + n.length);
        return (
          Xe.Copy(t, 0, i, 0, t.length), Xe.Copy(n, 0, i, t.length, n.length), i
        );
      }
    }
  ...
  if (typeof re.vscode < "u" && typeof re.vscode.process < "u") {
    ...
    typeof process < "u"
      ...
      : (Je = {
          get platform() {
            return tt ? "win32" : ma ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function K(e, t) {
    if (typeof e != "string") throw new On(t, "string", e);
  }
  function V(e) {
    return e === te || e === le;
  }
        ...
        if (!(l === c - 1 || u === 1))
          if (u === 2) {
            if (
              i.length < 2 ||
              s !== 2 ||
              i.charCodeAt(i.length - 1) !== Me ||
              i.charCodeAt(i.length - 2) !== Me
            ) {
              if (i.length > 2) {
  ...
  function Vn(e, t) {
    if (t === null || typeof t != "object")
      throw new On("pathObject", "Object", t);
  ...
  const se = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= -1; i--) {
          let s;
          if (i >= 0) {
            if (((s = e[i]), K(s, "path"), s.length === 0)) continue;
          } else
            t.length === 0
              ? (s = Kt())
              : ((s = ja[`=${t}`] || Kt()),
          ...
          if (l === 1) V(h) && ((u = 1), (c = !0));
            ...
            if (((c = !0), V(s.charCodeAt(1)))) {
              let d = 2,
                f = d;
              for (; d < l && !V(s.charCodeAt(d)); ) d++;
              if (d < l && d !== f) {
                const g = s.slice(f, d);
                for (f = d; d < l && V(s.charCodeAt(d)); ) d++;
                if (d < l && d !== f) {
                  for (f = d; d < l && !V(s.charCodeAt(d)); ) d++;
                  (d === l || d !== f) &&
                    ((o = `\\\\${g}\\${s.slice(f, d)}`), (u = d));
      ...
      normalize(e) {
        ...
        if (t === 1) return en(s) ? "\\" : e;
        if (V(s))
          if (((i = !0), V(e.charCodeAt(1)))) {
            let u = 2,
              o = u;
            for (; u < t && !V(e.charCodeAt(u)); ) u++;
            if (u < t && u !== o) {
              const c = e.slice(o, u);
              for (o = u; u < t && V(e.charCodeAt(u)); ) u++;
              if (u < t && u !== o) {
                for (o = u; u < t && !V(e.charCodeAt(u)); ) u++;
        ...
        let l = n < t ? _t(e.slice(n), !i, "\\", V) : "";
        return (
          l.length === 0 && !i && (l = "."),
          l.length > 0 && V(e.charCodeAt(t - 1)) && (l += "\\"),
          r === void 0 ? (i ? `\\${l}` : l) : i ? `${r}\\${l}` : `${r}${l}`
        );
      },
      isAbsolute(e) {
        K(e, "path");
        ...
        return (
          V(n) ||
          (t > 2 && Re(n) && e.charCodeAt(1) === De && V(e.charCodeAt(2)))
        );
      },
      join(...e) {
      ...
      relative(e, t) {
        ...
        const n = se.resolve(e),
          r = se.resolve(t);
        if (n === r || ((e = n.toLowerCase()), (t = r.toLowerCase()), e === t))
          return "";
        let i = 0;
        for (; i < e.length && e.charCodeAt(i) === le; ) i++;
        let s = e.length;
        for (; s - 1 > i && e.charCodeAt(s - 1) === le; ) s--;
        const l = s - i;
        let u = 0;
        for (; u < t.length && t.charCodeAt(u) === le; ) u++;
        let o = t.length;
        for (; o - 1 > u && t.charCodeAt(o - 1) === le; ) o--;
        const c = o - u,
          h = l < c ? l : c;
        let d = -1,
          f = 0;
        ...
        if (f !== h) {
          ...
          if (c > h) {
            if (t.charCodeAt(u + f) === le) return r.slice(u + f + 1);
            if (f === 2) return r.slice(u + f);
          }
          l > h && (e.charCodeAt(i + f) === le ? (d = f) : f === 2 && (d = 3)),
            d === -1 && (d = 0);
        }
        let g = "";
        for (f = i + d + 1; f <= s; ++f)
          (f === s || e.charCodeAt(f) === le) &&
            (g += g.length === 0 ? ".." : "\\..");
        return (
          (u += d),
          g.length > 0
            ? `${g}${r.slice(u, o)}`
            : (r.charCodeAt(u) === le && ++u, r.slice(u, o))
        );
      },
      toNamespacedPath(e) {
        if (typeof e != "string") return e;
        if (e.length === 0) return "";
        const t = se.resolve(e);
        if (t.length <= 2) return e;
        if (t.charCodeAt(0) === le) {
          if (t.charCodeAt(1) === le) {
            const n = t.charCodeAt(2);
            if (n !== Qa && n !== Me) return `\\\\?\\UNC\\${t.slice(2)}`;
          }
        } else if (
          Re(t.charCodeAt(0)) &&
          t.charCodeAt(1) === De &&
    ...
    ue = {
      resolve(...e) {
        ...
        for (let r = e.length - 1; r >= -1 && !n; r--) {
          const i = r >= 0 ? e[r] : Kt();
          K(i, "path"),
            i.length !== 0 && ((t = `${i}/${t}`), (n = i.charCodeAt(0) === te));
        }
        return (t = _t(t, !n, "/", en)), n ? `/${t}` : t.length > 0 ? t : ".";
      },
      normalize(e) {
      ...
      relative(e, t) {
        if (
          (K(e, "from"),
          K(t, "to"),
          e === t || ((e = ue.resolve(e)), (t = ue.resolve(t)), e === t))
        )
          return "";
        const n = 1,
          r = e.length,
        ...
        if (c === u)
          if (l > u) {
            if (t.charCodeAt(s + c) === te) return t.slice(s + c + 1);
            if (c === 0) return t.slice(s + c);
          } else
            i > u &&
              (e.charCodeAt(n + c) === te ? (o = c) : c === 0 && (o = 0));
        let h = "";
        for (c = n + o + 1; c <= r; ++c)
          (c === r || e.charCodeAt(c) === te) &&
            (h += h.length === 0 ? ".." : "/..");
  ...
  (ue.win32 = se.win32 = se),
    (ue.posix = se.posix = ue),
    Be === "win32" ? se.normalize : ue.normalize,
    Be === "win32" ? se.resolve : ue.resolve,
    Be === "win32" ? se.relative : ue.relative,
    Be === "win32" ? se.dirname : ue.dirname,
    Be === "win32" ? se.basename : ue.basename,
    Be === "win32" ? se.extname : ue.extname,
    Be === "win32" ? se.sep : ue.sep;
  const Ya = /^\w[\w\d+.-]*$/,
    Za = /^\//,
    Ka = /^\/\//;
  function jn(e, t) {
  ...
  class Pe {
    constructor(t, n, r, i, s, l = !1) {
      typeof t == "object"
        ? ((this.scheme = t.scheme || Y),
          (this.authority = t.authority || Y),
          (this.path = t.path || Y),
          (this.query = t.query || Y),
          (this.fragment = t.fragment || Y))
        : ((this.scheme = es(t, l)),
          (this.authority = n || Y),
          (this.path = ts(this.scheme, r || Y)),
          (this.query = i || Y),
          (this.fragment = s || Y),
          jn(this, l));
    }
    ...
    with(t) {
      ...
      return (
        n === void 0 ? (n = this.scheme) : n === null && (n = Y),
        r === void 0 ? (r = this.authority) : r === null && (r = Y),
        i === void 0 ? (i = this.path) : i === null && (i = Y),
        s === void 0 ? (s = this.query) : s === null && (s = Y),
        l === void 0 ? (l = this.fragment) : l === null && (l = Y),
        n === this.scheme &&
        r === this.authority &&
        i === this.path &&
        s === this.query &&
    ...
    static file(t) {
      let n = Y;
      if ((tt && (t = t.replace(/\\/g, be)), t[0] === be && t[1] === be)) {
        const r = t.indexOf(be, 2);
        r === -1
          ? ((n = t.substring(2)), (t = be))
          : ((n = t.substring(2, r)), (t = t.substring(r) || be));
      }
      return new Qe("file", n, t, Y, Y);
    }
    static from(t) {
    ...
    static joinPath(t, ...n) {
      ...
      return (
        tt && t.scheme === "file"
          ? (r = Pe.file(se.join(tn(t, !0), ...n)).path)
          : (r = ue.join(t.path, ...n)),
        t.with({ path: r })
      );
    }
      ...
      if (t) {
        if (t instanceof Pe) return t;
        {
          ...
          return (
            ...
            (n._fsPath = t._sep === Gn ? t.fsPath : null),
            n
          );
        }
      } else return t;
  ...
  const Gn = tt ? 1 : void 0;
  class Qe extends Pe {
    constructor() {
      super(...arguments), (this._formatted = null), (this._fsPath = null);
    }
    get fsPath() {
      return this._fsPath || (this._fsPath = tn(this, !1)), this._fsPath;
    }
    toString(t = !1) {
      return t
        ? nn(this, !0)
        : (this._formatted || (this._formatted = nn(this, !1)),
          this._formatted);
    }
    toJSON() {
      const t = { $mid: 1 };
  ...
  function Xn(e, t) {
    ...
    for (let i = 0; i < e.length; i++) {
      ...
      if (
        ...
        r !== -1 && ((n += encodeURIComponent(e.substring(r, i))), (r = -1)),
    ...
    return (
      r !== -1 && (n += encodeURIComponent(e.substring(r))),
      n !== void 0 ? n : e
    );
  }
  function rs(e) {
  ...
  function nn(e, t) {
    const n = t ? rs : Xn;
    let r = "",
      { scheme: i, authority: s, path: l, query: u, fragment: o } = e;
    if (
      (i && ((r += i), (r += ":")),
      (s || i === "file") && ((r += be), (r += be)),
      s)
      ...
      (s = s.toLowerCase()),
        ...
        c === -1
          ? (r += n(s, !1))
          : ((r += n(s.substr(0, c), !1)), (r += s.substr(c)));
    }
    if (l) {
  ...
  function Jn(e) {
    try {
      ...
      return e.length > 3 ? e.substr(0, 3) + Jn(e.substr(3)) : e;
    }
  }
  const Qn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
  function yt(e) {
    return e.match(Qn) ? e.replace(Qn, t => Jn(t)) : e;
  }
  class ce {
    constructor(t, n) {
  ...
  class Z {
    ...
    static plusRange(t, n) {
      ...
      return (
        ...
        n.endLineNumber > t.endLineNumber
          ? ((s = n.endLineNumber), (l = n.endColumn))
          : n.endLineNumber === t.endLineNumber
            ? ((s = n.endLineNumber), (l = Math.max(n.endColumn, t.endColumn)))
    ...
    static intersectRanges(t, n) {
      ...
      const u = n.startLineNumber,
        ...
        h = n.endColumn;
      return (
        r < u ? ((r = u), (i = o)) : r === u && (i = Math.max(i, o)),
        s > c ? ((s = c), (l = h)) : s === c && (l = Math.min(l, h)),
        r > s || (r === s && i > l) ? null : new Z(r, i, s, l)
      );
    }
    equalsRange(t) {
  ...
  class Zn {
    ...
    createCharSequence(t, n, r) {
      ...
      let u = 0;
      for (let o = n; o <= r; o++) {
        const c = this.lines[o],
          h = t ? this._startColumns[o] : 1,
          d = t ? this._endColumns[o] : c.length + 1;
        for (let f = h; f < d; f++)
          (i[u] = c.charCodeAt(f - 1)), (s[u] = o + 1), (l[u] = f), u++;
        !t &&
          o < r &&
          ((i[u] = 10), (s[u] = o + 1), (l[u] = c.length + 1), u++);
      }
      return new as(i, s, l);
    }
  }
  ...
  function ss(e) {
    ...
    for (let r = 1, i = e.length; r < i; r++) {
      const s = e[r],
        l = s.originalStart - (n.originalStart + n.originalLength),
  ...
  class rt {
    ...
    static createFromDiffResult(t, n, r, i, s, l, u) {
      ...
      if (
        (n.originalLength === 0
          ? ((o = r.getStartLineNumber(n.originalStart) - 1), (c = 0))
        ...
        if (g.getElements().length > 0 && v.getElements().length > 0) {
          let w = Yn(g, v, s, !0).changes;
          u && (w = ss(w)), (f = []);
          for (let y = 0, k = w.length; y < k; y++)
            f.push(nt.createFromDiffChange(w[y], g, v));
        }
      }
      return new rt(o, c, h, d, f);
    }
  }
  class os {
    constructor(t, n, r) {
      (this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.original = new Zn(t)),
        (this.modified = new Zn(n)),
        (this.continueLineDiff = Kn(r.maxComputationTime)),
        (this.continueCharDiff = Kn(
    ...
    computeDiff() {
      ...
      if (this.shouldIgnoreTrimWhitespace) {
        ...
        return { quitEarly: r, changes: u };
      }
      const i = [];
      let s = 0,
        l = 0;
      for (let u = -1, o = n.length; u < o; u++) {
        const c = u + 1 < o ? n[u + 1] : null,
          h = c ? c.originalStart : this.originalLines.length,
          d = c ? c.modifiedStart : this.modifiedLines.length;
        for (; s < h && l < d; ) {
          const f = this.originalLines[s],
            g = this.modifiedLines[l];
          if (f !== g) {
            {
              let v = rn(f, 1),
                w = rn(g, 1);
              for (; v > 1 && w > 1; ) {
                const y = f.charCodeAt(v - 2),
                  k = g.charCodeAt(w - 2);
                if (y !== k) break;
                v--, w--;
              }
              (v > 1 || w > 1) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, 1, v, l + 1, 1, w);
            }
            {
              let v = an(f, 1),
                w = an(g, 1);
              const y = f.length + 1,
                k = g.length + 1;
              for (; v < y && w < k; ) {
                const _ = f.charCodeAt(v - 1),
                  L = f.charCodeAt(w - 1);
                if (_ !== L) break;
                v++, w++;
              }
              (v < y || w < k) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, v, y, l + 1, w, k);
            }
          }
          s++, l++;
        }
    ...
    _pushTrimWhitespaceCharChange(t, n, r, i, s, l, u) {
      if (this._mergeTrimWhitespaceCharChange(t, n, r, i, s, l, u)) return;
      let o;
      this.shouldComputeCharChanges && (o = [new nt(n, r, n, i, s, l, s, u)]),
        t.push(new rt(n, n, s, s, o));
    }
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ...
        : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === s
          ? ((c.originalEndLineNumber = n),
            ...
            this.shouldComputeCharChanges &&
              c.charChanges &&
              c.charChanges.push(new nt(n, r, n, i, s, l, s, u)),
            !0)
          : !1;
    }
  }
  ...
  function ds(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const n of hs) e.indexOf(n) >= 0 || (t += "\\" + n);
  ...
  const rr = new gt();
  rr.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  function sn(e, t, n, r, i) {
    if ((i || (i = mt.first(rr)), n.length > i.maxLen)) {
      let c = e - i.maxLen / 2;
      return (
        c < 0 ? (c = 0) : (r += c),
        (n = n.substring(c, e + i.maxLen / 2)),
        sn(e, t, n, r, i)
      );
    }
    const s = Date.now(),
  ...
  class on {
    constructor(t) {
      ...
      (this._defaultValue = n),
        (this._asciiMap = on._createAsciiMap(n)),
        (this._map = new Map());
    }
      ...
      for (let s = 1, l = t.getLineCount(); s <= l; s++) {
        ...
        for (; c < o; ) {
          ...
          if (f === 13) {
            ...
            let L;
            _ === 91 ? ((v = !0), (L = 0)) : (L = r.get(_)),
              L === 1 ? (k = !0) : (f = 13);
          } else (f = n.nextState(f, _)), f === 0 && (k = !0);
          k && ((f = 1), (g = !1), (v = !1), (y = !1), (h = c + 1), (d = _)),
            c++;
        }
  ...
  (function (e) {
    function t(n) {
      return n === e.None || n === e.Cancelled || n instanceof At
        ? !0
        : !n || typeof n != "object"
          ? !1
    ...
    (e.isCancellationToken = t),
      (e.None = Object.freeze({
        ...
        onCancellationRequested: Jt.None
      })),
  ...
  class _s {
    ...
    cancel() {
      this._token
        ? this._token instanceof At && this._token.cancel()
    ...
    dispose(t = !1) {
      t && this.cancel(),
        ...
        this._token
          ? this._token instanceof At && this._token.dispose()
          : (this._token = kt.None);
    }
  }
  class cn {
  ...
  (function () {
    ...
    for (const i of t) {
      ...
      if (
        (r[u] || ((r[u] = !0), (Ts[o] = u), (ks[o.toLowerCase()] = u)), !n[c])
      ) {
        if (((n[c] = !0), !h))
          throw new Error(
            `String representation missing for key code ${c} around scan code ${o}`
          );
        Ct.define(c, h), hn.define(c, g || h), dn.define(c, v || g || h);
      }
      d && (ys[d] = c);
    }
  })();
  ...
  (function (e) {
    function t(u) {
      return Ct.keyCodeToStr(u);
    }
    e.toString = t;
    function n(u) {
      return Ct.strToKeyCode(u);
    }
    e.fromString = n;
    function r(u) {
      return hn.keyCodeToStr(u);
    }
    ...
    function s(u) {
      return hn.strToKeyCode(u) || dn.strToKeyCode(u);
    }
    e.fromUserSettings = s;
    function l(u) {
      if (u >= 93 && u <= 108) return null;
      switch (u) {
        case 16:
          return "Up";
        case 18:
  ...
  function Ds(e, t, n, r, i) {
    return Es(e, t, n, r, i) && Ms(e, t, n, r, i);
  }
  class Rs {
    constructor(t, n) {
    ...
    next(t) {
      ...
      do {
        ...
        if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Ra(t, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Ds(this._wordSeparators, t, n, i, s))
        )
          return r;
      } while (r);
      return null;
  ...
  class Ns {
    static computeUnicodeHighlights(t, n, r) {
      const i = r ? r.startLineNumber : 1,
        ...
        l = new Yr(n),
        u = l.getCandidateCodePoints();
      let o;
      u === "allNonBasicAscii"
        ? (o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (o = new RegExp(`${Us(Array.from(u))}`, "g"));
      const c = new Rs(null, o),
        h = [];
      let d = !1,
        f,
        g = 0,
        v = 0,
        w = 0;
      e: for (let y = i, k = s; y <= k; y++) {
        const _ = t.getLineContent(y),
          L = _.length;
        c.reset(0);
        do
          if (((f = c.next(_)), f)) {
            ...
            const D = _.substring(M, z),
              p = sn(M + 1, nr, _, 0),
              m = l.shouldHighlightNonBasicASCII(D, p ? p.word : null);
            if (m !== 0) {
              m === 3 ? g++ : m === 2 ? v++ : m === 1 ? w++ : Aa();
              const b = 1e3;
              if (h.length >= b) {
                d = !0;
                break e;
      ...
      switch (r.shouldHighlightNonBasicASCII(t, null)) {
        ...
        case 3: {
          const s = t.codePointAt(0),
            l = r.ambiguousCharacters.getPrimaryConfusable(s),
            u = ge
              .getLocales()
              .filter(
                o =>
  ...
  function Us(e, t) {
    return `[${Sa(e.map(r => String.fromCodePoint(r)).join(""))}]`;
  }
  class Yr {
    constructor(t) {
      (this.options = t),
    ...
    getCandidateCodePoints() {
      ...
      if (this.options.invisibleCharacters)
        for (const n of xe.codePoints) Zr(String.fromCodePoint(n)) || t.add(n);
...
` ||
  ...
  class Is extends cs {
    ...
    getWordAtPosition(t, n) {
      const r = sn(t.column, fs(n), this._lines[t.lineNumber - 1], 0);
      return r
    ...
    getValueInRange(t) {
      ...
      for (let l = r + 1; l < i; l++) s.push(this._lines[l]);
  ...
  class Oe {
    ...
    computeUnicodeHighlights(t, n, r) {
      return qe(this, void 0, void 0, function* () {
        ...
        return i
          ? Ns.computeUnicodeHighlights(i, n, r)
          : {
              ranges: [],
              hasMore: !1,
    ...
    computeDiff(t, n, r, i) {
      return qe(this, void 0, void 0, function* () {
        const s = this._getModel(t),
          l = this._getModel(n);
        return !s || !l ? null : Oe.computeDiff(s, l, r, i);
      });
    }
    static computeDiff(t, n, r, i) {
      const s = t.getLinesContent(),
        ...
        c = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
      return { quitEarly: o.quitEarly, identical: c, changes: o.changes };
    }
    ...
    computeMoreMinimalEdits(t, n) {
      return qe(this, void 0, void 0, function* () {
        ...
        for (let { range: l, text: u, eol: o } of n) {
          if ((typeof o == "number" && (s = o), Z.isEmpty(l) && !u)) continue;
          const c = r.getValueInRange(l);
          if (((u = u.replace(/\r\n|\n|\r/g, r.eol)), c === u)) continue;
          if (Math.max(u.length, c.length) > Oe._diffLimit) {
            i.push({ range: l, text: u });
            continue;
          }
          const h = Va(c, u, !1),
            d = r.offsetAt(Z.lift(l).getStartPosition());
          for (const f of h) {
            const g = r.positionAt(d + f.originalStart),
              v = r.positionAt(d + f.originalStart + f.originalLength),
              w = {
        ...
        e: for (const o of t) {
          ...
          if (!!c) {
            for (const h of c.words(l))
              if (
                !(h === n || !isNaN(Number(h))) &&
                (u.add(h), u.size > Oe._suggestionsLimit)
              )
                break e;
          }
        }
    ...
    navigateValueSet(t, n, r, i, s) {
      return qe(this, void 0, void 0, function* () {
        ...
        return un.INSTANCE.navigateValueSet(n, o, c, h, r);
      });
    }
    loadForeignModule(t, n, r) {
      const l = {
        host: ka(r, (u, o) => this._host.fhr(u, o)),
        getMirrorModels: () => this._getModels()
      };
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(l, n)),
          Promise.resolve(Yt(this._foreignModule)))
  ...
  (Oe._diffLimit = 1e5),
    (Oe._suggestionsLimit = 1e4),
    typeof importScripts == "function" && (re.monaco = Ls());
  let wn = !1;
  function Kr(e) {
    if (wn) return;
    wn = !0;
  ...
  (function (e) {
    ...
    function n(r) {
      var i = r;
      return (
        A.defined(i) && X.is(i.range) && (A.string(i.uri) || A.undefined(i.uri))
      );
    }
    e.is = n;
  })(xt || (xt = {}));
  ...
  (function (e) {
    ...
    function n(r) {
      ...
      return (
        ...
        (X.is(i.targetSelectionRange) || A.undefined(i.targetSelectionRange)) &&
        (X.is(i.originSelectionRange) || A.undefined(i.originSelectionRange))
      );
    }
    e.is = n;
  })(ti || (ti = {}));
  ...
  (function (e) {
    function t(r, i, s, l) {
      return { red: r, green: i, blue: s, alpha: l };
    }
    e.create = t;
    function n(r) {
      var i = r;
  ...
  (function (e) {
    ...
    function n(r) {
      var i = r;
      return X.is(i.range) && _n.is(i.color);
    }
    e.is = n;
  })(ni || (ni = {}));
  var ri;
  ...
  (function (e) {
    function t(r, i, s, l, u) {
      var o = { startLine: r, endLine: i };
      return (
        A.defined(s) && (o.startCharacter = s),
        A.defined(l) && (o.endCharacter = l),
        A.defined(u) && (o.kind = u),
        o
      );
    }
    e.create = t;
  ...
  (function (e) {
    function t(r, i, s, l, u, o) {
      ...
      return (
        A.defined(s) && (c.severity = s),
        A.defined(l) && (c.code = l),
        A.defined(u) && (c.source = u),
        A.defined(o) && (c.relatedInformation = o),
        c
      );
    }
    e.create = t;
    function n(r) {
      ...
      return (
        ...
        (A.undefined(s.relatedInformation) ||
          A.typedArray(s.relatedInformation, yn.is))
      );
    }
    e.is = n;
  })(Et || (Et = {}));
  ...
  (function (e) {
    function t(r, i, s) {
      var l = { label: r };
      return (
        i !== void 0 && (l.needsConfirmation = i),
        s !== void 0 && (l.description = s),
        l
      );
    }
    e.create = t;
  ...
  (function (e) {
    ...
    function i(s) {
      var l = s;
      return ee.is(l) && (Ze.is(l.annotationId) || ae.is(l.annotationId));
    }
    e.is = i;
  })(Ne || (Ne = {}));
  var Mt;
  (function (e) {
    ...
    function n(r) {
      var i = r;
      return A.defined(i) && Rt.is(i.textDocument) && Array.isArray(i.edits);
    }
    e.is = n;
  })(Mt || (Mt = {}));
  var ot;
  (function (e) {
    ...
    function n(r) {
      ...
      return (
        ...
        (i.annotationId === void 0 || ae.is(i.annotationId))
      );
    }
    e.is = n;
  })(ot || (ot = {}));
  ...
  (function (e) {
    function t(r, i, s, l) {
      var u = { kind: "rename", oldUri: r, newUri: i };
      return (
        s !== void 0 &&
          (s.overwrite !== void 0 || s.ignoreIfExists !== void 0) &&
          (u.options = s),
        l !== void 0 && (u.annotationId = l),
        u
      );
    }
    e.create = t;
      ...
      (this._textEditChanges = Object.create(null)),
        t !== void 0
          ? ((this._workspaceEdit = t),
            t.documentChanges
              ? ((this._changeAnnotations = new li(t.changeAnnotations)),
    ...
    return (
        ...
        if (Rt.is(t)) {
          ...
          if (!r) {
            ...
            this._workspaceEdit.documentChanges.push(s),
              (r = new Dt(i, this._changeAnnotations)),
      ...
      (e.prototype.initDocumentChanges = function () {
        this._workspaceEdit.documentChanges === void 0 &&
          ...
          ((this._changeAnnotations = new li()),
      ...
      (e.prototype.createFile = function (t, n, r) {
        ...
        var i;
        Ze.is(n) || ae.is(n) ? (i = n) : (r = n);
        var s, l;
        if (
          (i === void 0
            ? (s = ot.create(t, r))
            : ((l = ae.is(i) ? i : this._changeAnnotations.manage(i)),
              (s = ot.create(t, r, l))),
          this._workspaceEdit.documentChanges.push(s),
          l !== void 0)
        )
      ...
      (e.prototype.renameFile = function (t, n, r, i) {
        ...
        var s;
        Ze.is(r) || ae.is(r) ? (s = r) : (i = r);
        var l, u;
        if (
          (s === void 0
            ? (l = lt.create(t, n, i))
            : ((u = ae.is(s) ? s : this._changeAnnotations.manage(s)),
              (l = lt.create(t, n, i, u))),
  ...
  (function (e) {
    function t(n) {
      var r = n;
      return A.objectLiteral(n) && we.is(r.kind) && A.string(r.value);
    }
    e.is = t;
  })(kn || (kn = {}));
  var he;
  ...
  (function (e) {
    function t(n, r) {
      ...
      var l = { label: n };
      return (
        A.defined(r) && (l.documentation = r),
        A.defined(i) ? (l.parameters = i) : (l.parameters = []),
        l
      );
    }
    e.create = t;
  ...
  (function (e) {
    function t(n, r, i, s, l) {
      var u = { name: n, kind: r, location: { uri: s, range: i } };
  ...
  (function (e) {
    function t(r, i, s, l, u, o) {
      var c = { name: r, detail: i, kind: s, range: l, selectionRange: u };
  ...
  (function (e) {
    ...
    function n(r) {
      ...
      return (
        A.defined(i) &&
        A.typedArray(i.diagnostics, Et.is) &&
  ...
  (function (e) {
    ...
    function n(r) {
      ...
      return (
        i &&
        A.string(i.title) &&
        (i.diagnostics === void 0 || A.typedArray(i.diagnostics, Et.is)) &&
        (i.kind === void 0 || A.string(i.kind)) &&
        (i.edit !== void 0 || i.command !== void 0) &&
        (i.command === void 0 || st.is(i.command)) &&
        (i.isPreferred === void 0 || A.boolean(i.isPreferred)) &&
        (i.edit === void 0 || Tn.is(i.edit))
      );
    }
    e.is = n;
  })(Si || (Si = {}));
  ...
  (function (e) {
    ...
    function n(r) {
      ...
      return (
        A.defined(i) &&
        X.is(i.range) &&
        (A.undefined(i.command) || st.is(i.command))
      );
    }
    e.is = n;
  })(xi || (xi = {}));
  ...
  (function (e) {
    ...
    function n(r) {
      var i = r;
      return (
        i !== void 0 && X.is(i.range) && (i.parent === void 0 || e.is(i.parent))
      );
    }
    e.is = n;
  })(It || (It = {}));
  ...
  (function (e) {
    ...
    function n(s) {
      ...
      return !!(
        A.defined(l) &&
        A.string(l.uri) &&
        (A.undefined(l.languageId) || A.string(l.languageId)) &&
        A.uinteger(l.lineCount) &&
        A.func(l.getText) &&
        A.func(l.positionAt) &&
        A.func(l.offsetAt)
      );
      ...
      for (
        var u = s.getText(),
          o = i(l, function (v, w) {
            ...
            return y === 0
              ? v.range.start.character - w.range.start.character
              : y;
          }),
          c = u.length,
          h = o.length - 1;
        ...
        var d = o[h],
          f = s.offsetAt(d.range.start),
          g = s.offsetAt(d.range.end);
        if (g <= c)
    ...
    function i(s, l) {
      ...
      for (; h < o.length; ) s[f++] = o[h++];
      for (; d < c.length; ) s[f++] = c[d++];
      return s;
    }
  })(Mi || (Mi = {}));
  var Ws = (function () {
...
` &&
  ...
  var Ht = class {
      ...
      update(e, t) {
        for (let n of e)
          if (Ht.isIncremental(n)) {
            const r = Ri(n.range),
              i = this.offsetAt(r.start),
              s = this.offsetAt(r.end);
            this._content =
              this._content.substring(0, i) +
              n.text +
              this._content.substring(s, this._content.length);
            const l = Math.max(r.start.line, 0),
              u = Math.max(r.end.line, 0);
            let o = this._lineOffsets;
            const c = Di(n.text, !1, i);
            if (u - l === c.length)
              for (let d = 0, f = c.length; d < f; d++) o[d + l + 1] = c[d];
            else
              c.length < 1e4
                ? o.splice(l + 1, u - l, ...c)
                : (this._lineOffsets = o =
                    o.slice(0, l + 1).concat(c, o.slice(u + 1)));
      ...
      getLineOffsets() {
        return (
          this._lineOffsets === void 0 &&
            (this._lineOffsets = Di(this._content, !0)),
          this._lineOffsets
        );
      }
      positionAt(e) {
  ...
  (function (e) {
    function t(i, s, l, u) {
      return new Ht(i, s, l, u);
    }
    e.create = t;
    function n(i, s, l) {
      if (i instanceof Ht) return i.update(s, l), i;
      throw new Error(
  ...
  (function (e) {
    e.LATEST = {
      textDocument: {
        completion: {
          completionItem: { documentationFormat: [we.Markdown, we.PlainText] }
        },
        hover: { contentFormat: [we.Markdown, we.PlainText] }
      }
    };
  })(Ni || (Ni = {}));
  var xn;
    ...
    Bs = (function () {
      ...
      return (
        ...
        (e.prototype.advanceIfChar = function (t) {
          return t === this.source.charCodeAt(this.position)
            ? (this.position++, !0)
            : !1;
        }),
        ...
        (e.prototype.skipWhitespace = function () {
          var t = this.advanceWhileChar(function (n) {
            return n === $s || n === Xs || n === Vs || n === Gs || n === js;
          });
          return t > 0;
        }),
...
`.charCodeAt(0),
    ...
    $s = " ".charCodeAt(0),
    Xs = "	".charCodeAt(0),
    Js = { "text/x-handlebars-template": !0, "text/html": !0 };
  function fe(e, t, n, r) {
    t === void 0 && (t = 0),
      n === void 0 && (n = O.WithinContent),
      r === void 0 && (r = !1);
    var i = new Bs(e, t),
      s = n,
      l = 0,
    ...
    function y() {
      ...
      return M !== N.EOS &&
        _ === i.pos() &&
        !(r && (M === N.StartTagClose || M === N.EndTagClose))
        ? (console.log(
    ...
    function k() {
      var _ = i.pos();
      if (i.eos()) return w(_, N.EOS);
      var L;
      switch (s) {
        case O.WithinComment:
          return i.advanceIfChars([Ke, Ke, ke])
            ? ((s = O.WithinContent), w(_, N.EndCommentTag))
            : (i.advanceUntilChars([Ke, Ke, ke]), w(_, N.Comment));
        case O.WithinDoctype:
          return i.advanceIfChar(ke)
            ? ((s = O.WithinContent), w(_, N.EndDoctypeTag))
            : (i.advanceUntilChar(ke), w(_, N.Doctype));
        case O.WithinContent:
          if (i.advanceIfChar(zt)) {
            if (!i.eos() && i.peekChar() === Ui) {
              if (i.advanceIfChars([Ui, Ke, Ke]))
                return (s = O.WithinComment), w(_, N.StartCommentTag);
              if (i.advanceIfRegExp(/^!doctype/i))
                return (s = O.WithinDoctype), w(_, N.StartDoctypeTag);
            }
            return i.advanceIfChar(Ln)
              ? ((s = O.AfterOpeningEndTag), w(_, N.EndTagOpen))
              : ((s = O.AfterOpeningStartTag), w(_, N.StartTagOpen));
          }
          return i.advanceUntilChar(zt), w(_, N.Content);
        case O.AfterOpeningEndTag:
          var M = g();
          return M.length > 0
            ? ((s = O.WithinEndTag), w(_, N.EndTag))
            : i.skipWhitespace()
              ? w(
                  _,
                  N.Whitespace,
              ...
              : ((s = O.WithinEndTag),
                i.advanceUntilChar(ke),
                _ < i.pos()
                  ? w(
                      _,
                      N.Unknown,
                      Ue("error.endTagNameExpected", "End tag name expected.")
                    )
                  : k());
        case O.WithinEndTag:
          if (i.skipWhitespace()) return w(_, N.Whitespace);
          if (i.advanceIfChar(ke))
            return (s = O.WithinContent), w(_, N.EndTagClose);
          if (r && i.peekChar() === zt)
            return (
              (s = O.WithinContent),
              w(
                _,
                N.EndTagClose,
                Ue("error.closingBracketMissing", "Closing bracket missing.")
              )
            );
          L = Ue("error.closingBracketExpected", "Closing bracket expected.");
          break;
        case O.AfterOpeningStartTag:
          return (
            ...
            (d = void 0),
            h.length > 0
              ? ((c = !1), (s = O.WithinTag), w(_, N.StartTag))
              : i.skipWhitespace()
                ? w(
                    _,
                    N.Whitespace,
        ...
        case O.WithinTag:
          return i.skipWhitespace()
            ? ((c = !0), w(_, N.Whitespace))
            : c && ((d = v()), d.length > 0)
              ? ((s = O.AfterAttributeName), (c = !1), w(_, N.AttributeName))
              : i.advanceIfChars([Ln, ke])
                ? ((s = O.WithinContent), w(_, N.StartTagSelfClose))
                : i.advanceIfChar(ke)
                  ? (h === "script"
                      ? f && Js[f]
                        ? (s = O.WithinContent)
                        : (s = O.WithinScriptContent)
                      : h === "style"
                        ? (s = O.WithinStyleContent)
                        : (s = O.WithinContent),
                    w(_, N.StartTagClose))
                  : r && i.peekChar() === zt
                    ? ((s = O.WithinContent),
        ...
        case O.AfterAttributeName:
          return i.skipWhitespace()
            ? ((c = !0), w(_, N.Whitespace))
            : i.advanceIfChar(Ps)
              ? ((s = O.BeforeAttributeValue), w(_, N.DelimiterAssign))
              : ((s = O.WithinTag), k());
        case O.BeforeAttributeValue:
          ...
          if (z.length > 0)
            return (
              i.peekChar() === ke &&
                i.peekChar(-1) === Ln &&
                (i.goBack(1), (z = z.substr(0, z.length - 1))),
              d === "type" && (f = z),
              (s = O.WithinTag),
              (c = !1),
              w(_, N.AttributeValue)
            );
          var D = i.peekChar();
          return D === Os || D === qs
            ? (i.advance(1),
              i.advanceUntilChar(D) && i.advance(1),
              d === "type" && (f = i.getSource().substring(_ + 1, i.pos() - 1)),
              (s = O.WithinTag),
              (c = !1),
              w(_, N.AttributeValue))
            : ((s = O.WithinTag), (c = !1), k());
        case O.WithinScriptContent:
          for (var p = 1; !i.eos(); ) {
            ...
            if (m.length === 0) return i.goToEnd(), w(_, N.Script);
            if (m === "<!--") p === 1 && (p = 2);
            else if (m === "-->") p = 1;
            else if (m[1] !== "/") p === 2 && (p = 3);
            else if (p === 3) p = 2;
          ...
          return (s = O.WithinContent), _ < i.pos() ? w(_, N.Script) : k();
        case O.WithinStyleContent:
          return (
            i.advanceUntilRegExp(/<\/style/i),
            (s = O.WithinContent),
            _ < i.pos() ? w(_, N.Styles) : k()
          );
      }
      return i.advance(1), (s = O.WithinContent), w(_, N.Unknown, L);
    }
    return {
      scan: y,
  ...
  function Wt(e) {
    return (
      !!e &&
      Qs(Ys, e.toLowerCase(), function (t, n) {
  ...
  function zi(e) {
    for (
      var t = fe(e, void 0, void 0, !0),
        n = new Hi(0, e.length, [], void 0),
        r = n,
        i = -1,
        s = void 0,
        l = null,
      ...
      switch (u) {
        case N.StartTagOpen:
          var o = new Hi(t.getTokenOffset(), e.length, [], r);
          ...
          r.parent &&
            ...
            t.getTokenLength()
              ? ((r.startTagEnd = t.getTokenEnd()),
                r.tag && Wt(r.tag) && ((r.closed = !0), (r = r.parent)))
              : (r = r.parent));
          break;
        ...
        case N.EndTag:
          ...
          break;
        case N.EndTagClose:
          for (var c = r; !c.isSameTag(s) && c.parent; ) c = c.parent;
          if (c.parent) {
...
`,
  ...
  function ht(e, t) {
    ...
    return (Ks <= n && n <= eo) || (to <= n && n <= no) || (ro <= n && n <= io);
  }
  function Ft(e) {
    return typeof e < "u";
  }
        ...
        var s = function (u) {
            u.forEach(function (o) {
              o.name.toLowerCase() === n &&
                ...
                o.valueSet &&
                  r._valueSetMap[o.valueSet] &&
                  r._valueSetMap[o.valueSet].forEach(function (c) {
                    i.push(c);
                  }));
            });
          },
...
`),
        n
          ? (r.value += e.references
              .map(function (s) {
                return "[".concat(s.name, "](").concat(s.url, ")");
              })
              .join(" | "))
          : (r.value += e.references.map(function (s) {
              return "".concat(s.name, ": ").concat(s.url);
            }).join(`
`))),
      r.value !== "")
    ...
    so = (function () {
      ...
      return (
        (e.prototype.onHtmlAttributeValue = function (t) {
          co(t.tag, t.attribute) && this.atributeCompletions.push(t);
        }),
        (e.prototype.computeCompletions = function (t, n) {
          return Bi(this, void 0, void 0, function () {
            var r, i, s, l, u, o, c, h, d, f;
            return Pi(this, function (g) {
              switch (g.label) {
                case 0:
                  (r = { items: [], isIncomplete: !1 }),
                    (i = 0),
                    (s = this.atributeCompletions),
                    (g.label = 1);
                case 1:
                  return i < s.length
                    ? ((l = s[i]),
                      (u = lo(t.getText(l.range))),
                      uo(u)
                        ? u === "." || u === ".."
                ...
                case 2:
                  return (
                    (o = ho(l.value, u, l.range)),
                    [4, this.providePathSuggestions(l.value, o, t, n)]
                  );
                case 3:
          ...
          return Bi(this, void 0, void 0, function () {
            ...
            return Pi(this, function (v) {
              switch (v.label) {
                case 0:
                  if (
                    ((s = t.substring(0, t.lastIndexOf("/") + 1)),
                    (l = i.resolveReference(s || ".", r.uri)),
                    !l)
                  )
                    return [3, 4];
                  v.label = 1;
  ...
  function ho(e, t, n) {
    ...
    if (i === -1) r = mo(n, 1, -1);
      ...
      var s = t.slice(i + 1),
        l = dt(n.end, -1 - s.length),
        u = s.indexOf(" "),
        o = void 0;
      u !== -1 ? (o = dt(l, u)) : (o = dt(n.end, -1)), (r = X.create(l, o));
    }
    return r;
  }
  function fo(e, t, n) {
    return t
      ...
      : { label: e, kind: he.File, textEdit: ee.replace(n, e) };
  }
  function dt(e, t) {
      ...
      return (
            ...
            return bo(this, function (h) {
              switch (h.label) {
                case 0:
                  ...
                  (l = new so(this.lsOptions.fileSystemProvider.readDirectory)),
                    (u = this.completionParticipants),
                    (this.completionParticipants = [l].concat(u)),
                    (o = this.doComplete(t, n, r, s)),
                    (h.label = 1);
                case 1:
                  return (
                    h.trys.push([1, , 3, 4]), [4, l.computeCompletions(t, i)]
                  );
                case 2:
                  return (
                    (c = h.sent()),
        ...
        (e.prototype._doComplete = function (t, n, r, i) {
          var s = { isIncomplete: !1, items: [] },
            ...
            u = this.dataManager.getDataProviders().filter(function (R) {
              return (
                R.isApplicable(t.languageId) && (!i || i[R.getId()] !== !1)
              );
            }),
          ...
          function w(R, U) {
            return (
              U === void 0 && (U = h),
              R > h && (R = h),
              { start: t.positionAt(R), end: t.positionAt(U) }
            );
          }
          function y(R, U) {
            var F = w(R, U);
...
\r`.indexOf(F) >= 0
          ...
          function _(R, U, F) {
            F === void 0 && (F = h);
            var G = w(R, F),
              $ = qi(c, F, O.WithinEndTag, N.EndTagClose) ? "" : ">",
              j = d;
            for (U && (j = j.parent); j; ) {
              var J = j.tag;
              if (J && (!j.closed || (j.endTagStart && j.endTagStart > h))) {
                var oe = {
                  ...
                  Ae = k(j.start),
                  He = k(R - 1);
                if (Ae !== null && He !== null && Ae !== He) {
                  var pe = Ae + "</" + J + $;
                  (oe.textEdit = ee.replace(w(R - 1 - He.length), pe)),
                    (oe.filterText = He + "</" + J);
                }
                return s.items.push(oe), s;
              }
              j = j.parent;
            }
            return (
              U ||
                u.forEach(function (je) {
                  je.provideTags().forEach(function (_e) {
                    s.items.push({
                      label: "/" + _e.name,
                      kind: he.Property,
                      documentation: Ve(_e, void 0, o),
                      filterText: "/" + _e.name + $,
                      textEdit: ee.replace(G, "/" + _e.name + $),
                      insertTextFormat: ve.PlainText
                    });
                  });
                }),
          ...
          function L(R, U) {
            if (i && i.hideAutoCompleteProposals) return s;
            if (!Wt(U)) {
          ...
          function M(R, U) {
            return y(R, U), _(R, !0, U), s;
          }
          function z() {
            var R = Object.create(null);
            return (
              d.attributeNames.forEach(function (U) {
                R[U] = !0;
              }),
              R
            );
          ...
          function D(R, U) {
            var F;
            U === void 0 && (U = h);
            for (var G = h; G < U && c[G] !== "<"; ) G++;
            var $ = c.substring(R, U),
              j = w(R, G),
              J = "";
            if (!qi(c, U, O.AfterAttributeName, N.DelimiterAssign)) {
              var oe =
                (F = i == null ? void 0 : i.attributeDefaultValue) !== null &&
                F !== void 0
                  ? F
                  : "doublequotes";
              oe === "empty"
            ...
            return (
              ...
              u.forEach(function (He) {
                He.provideAttributes(g).forEach(function (pe) {
                  if (!Ae[pe.name]) {
                    Ae[pe.name] = !0;
                    var je = pe.name,
                      _e;
                    pe.valueSet !== "v" &&
                      ...
                      s.items.push({
                        label: pe.name,
                        kind:
                          pe.valueSet === "handler" ? he.Function : he.Value,
                        documentation: Ve(pe, void 0, o),
                        textEdit: ee.replace(j, je),
                        insertTextFormat: ve.Snippet,
                        command: _e
                      });
                  }
          ...
          function m(R, U) {
            ...
            if (h > R && h <= U && _o(c[R])) {
              ...
              var oe = yo(c, h, j),
                Ae = To(c, h, J);
              (F = w(oe, Ae)),
                ($ = h >= j && h <= J ? c.substring(j, h) : ""),
                (G = !1);
            } else (F = w(R, U)), ($ = c.substring(R, h)), (G = !0);
            if (l.length > 0)
              for (
                var He = g.toLowerCase(),
                  pe = v.toLowerCase(),
                  je = w(R, U),
                  _e = 0,
                  ea = l;
            ...
            return (
              u.forEach(function (nl) {
                nl.provideValues(g, v).forEach(function (Pt) {
                  var na = G ? '"' + Pt.name + '"' : Pt.name;
                  s.items.push({
                    label: Pt.name,
                    filterText: na,
                    kind: he.Unit,
                    documentation: Ve(Pt, void 0, o),
                    textEdit: ee.replace(F, na),
                    insertTextFormat: ve.PlainText
                  });
                });
              }),
          ...
          function b(R) {
            return h === f.getTokenEnd() &&
              ((W = f.scan()), W === R && f.getTokenOffset() === h)
              ? f.getTokenEnd()
              : h;
          }
          function I() {
            for (var R = 0, U = l; R < U.length; R++) {
              var F = U[R];
          ...
          function C() {
            for (var R = h - 1, U = n.character; R >= 0 && ht(c, R); ) R--, U--;
            if (R >= 0 && c[R] === "&") {
              var F = X.create(ne.create(n.line, U - 1), n);
              for (var G in ct)
                if (Zs(G, ";")) {
                  var $ = "&" + G;
                  s.items.push({
                    ...
                    documentation: wo(
                      "entity.propose",
                      "Character entity representing '".concat(ct[G], "'")
                    ),
          ...
          for (var W = f.scan(); W !== N.EOS && f.getTokenOffset() <= h; ) {
            switch (W) {
              case N.StartTagOpen:
                if (f.getTokenEnd() === h) {
                  var B = b(N.StartTag);
              ...
              case N.EndTag:
                if (h <= f.getTokenEnd())
                  for (var E = f.getTokenOffset() - 1; E >= 0; ) {
                    var H = c.charAt(E);
                    if (H === "/") return _(E, !1, f.getTokenEnd());
                    if (!Bt(H)) break;
                    E--;
                  }
                break;
              case N.StartTagClose:
                ...
                break;
              case N.Content:
                if (h <= f.getTokenEnd()) return I();
                break;
              default:
                if (h <= f.getTokenEnd()) return s;
                break;
            }
            W = f.scan();
          }
        ...
        (e.prototype.doQuoteComplete = function (t, n, r, i) {
          ...
          if (l <= 0) return null;
          var u =
            (s = i == null ? void 0 : i.attributeDefaultValue) !== null &&
            s !== void 0
              ? s
              : "doublequotes";
          ...
          if (o !== "=") return null;
          var c = u === "doublequotes" ? '"$1"' : "'$1'",
            h = r.findNodeBefore(l);
          if (
            h &&
            h.attributes &&
            h.start < l &&
            (!h.endTagStart || h.endTagStart > l)
          )
            for (
              var d = fe(t.getText(), h.start), f = d.scan();
              f !== N.EOS && d.getTokenEnd() <= l;
              ...
              if (f === N.AttributeName && d.getTokenEnd() === l - 1)
                return (
                  (f = d.scan()),
                  f !== N.DelimiterAssign ||
                  ((f = d.scan()), f === N.Unknown || f === N.AttributeValue)
                    ? null
                    : c
                );
              f = d.scan();
        ...
        (e.prototype.doTagComplete = function (t, n, r) {
          ...
          if (s === ">") {
            ...
            if (
              ...
              !Wt(l.tag) &&
              l.start < i &&
              (!l.endTagStart || l.endTagStart > i)
            )
              for (
                var u = fe(t.getText(), l.start), o = u.scan();
                o !== N.EOS && u.getTokenEnd() <= i;
            ...
            for (
              var l = r.findNodeBefore(i);
              l && l.closed && !(l.endTagStart && l.endTagStart > i);
        ...
        (e.prototype.doesSupportMarkdown = function () {
          var t, n, r;
          if (!Ft(this.supportsMarkdown)) {
            if (!Ft(this.lsOptions.clientCapabilities))
              ...
              (r =
                (n =
                  (t = this.lsOptions.clientCapabilities.textDocument) ===
                    null || t === void 0
                    ? void 0
                    : t.completion) === null || n === void 0
                  ? void 0
                  : n.completionItem) === null || r === void 0
                ? void 0
                : r.documentationFormat;
            this.supportsMarkdown =
              Array.isArray(i) && i.indexOf(we.Markdown) !== -1;
          }
  ...
  function qi(e, t, n, r) {
    for (var i = fe(e, t, n), s = i.scan(); s === N.Whitespace; ) s = i.scan();
    return s === r;
  }
  function yo(e, t, n) {
    for (; t > n && !Bt(e[t - 1]); ) t--;
    ...
    Ao = (function () {
      ...
      return (
        (e.prototype.doHover = function (t, n, r, i) {
          var s = this.convertContents.bind(this),
          ...
          function d(x, W, B) {
            for (
              var P = function (H) {
                  var R = null;
                  if (
                    (H.provideTags().forEach(function (U) {
                      if (U.name.toLowerCase() === x.toLowerCase()) {
                        var F = Ve(U, i, l);
                        F ||
                          (F = {
          ...
          function f(x, W, B) {
            for (
              var P = function (H) {
                  var R = null;
                  if (
                    (H.provideAttributes(x).forEach(function (U) {
                      if (W === U.name && U.description) {
                        var F = Ve(U, i, l);
          ...
          function g(x, W, B, P) {
            for (
              var q = function (R) {
                  var U = null;
                  if (
                    (R.provideValues(x, W).forEach(function (F) {
                      if (B === F.name && F.description) {
                        var G = Ve(F, i, l);
                        G ? (U = { contents: G, range: P }) : (U = null);
                      }
                    }),
                    U)
                  )
                    return (U.contents = s(U.contents)), { value: U };
                },
                S = 0,
                T = h;
              S < T.length;
          ...
          function v(x, W) {
            ...
            for (var P in ct) {
              var q = null,
                S = "&" + P;
              if (B === S) {
                var T = ct[P].charCodeAt(0).toString(16).toUpperCase(),
                  E = "U+";
                if (T.length < 4)
                ...
                var U = ko(
                  ...
                  "Character entity representing '"
                    .concat(ct[P], "', unicode equivalent '")
                    .concat(E, "'")
                );
                U ? (q = { contents: U, range: W }) : (q = null);
              }
              if (q) return (q.contents = s(q.contents)), q;
            }
            return null;
          }
          function w(x, W) {
            for (
              var B = fe(t.getText(), W), P = B.scan();
              P !== N.EOS &&
              (B.getTokenEnd() < u || (B.getTokenEnd() === u && P !== x));

            )
              P = B.scan();
            return P === x && u <= B.getTokenEnd()
              ? {
          ...
          function y() {
            for (var x = u - 1, W = n.character; x >= 0 && ht(c, x); ) x--, W--;
            for (var B = x + 1, P = W; ht(c, B); ) B++, P++;
            if (x >= 0 && c[x] === "&") {
              var q = null;
              return (
                c[B] === ";"
                  ? (q = X.create(
                      ne.create(n.line, W),
                      ne.create(n.line, P + 1)
                    ))
                  : (q = X.create(ne.create(n.line, W), ne.create(n.line, P))),
                q
              );
            }
            return null;
          ...
          function k(x) {
            for (var W = u - 1, B = "&"; W >= 0 && ht(x, W); ) W--;
            for (W = W + 1; ht(x, W); ) (B += x[W]), (W += 1);
            return (B += ";"), B;
          }
          if (o.endTagStart && u >= o.endTagStart) {
            var _ = w(N.EndTag, o.endTagStart);
            return _ ? d(o.tag, _) : null;
          }
          var L = w(N.StartTag, o.start);
          if (L) return d(o.tag, L);
          var M = w(N.AttributeName, o.start);
          if (M) {
            var z = o.tag,
              D = t.getText(M);
            return f(z, D, M);
          ...
          function m(x, W) {
            for (
              var B = fe(t.getText(), x), P = B.scan(), q = void 0;
              P !== N.EOS && B.getTokenEnd() <= W;

            )
              (P = B.scan()), P === N.AttributeName && (q = B.getTokenText());
            return q;
          }
          var b = w(N.AttributeValue, o.start);
          if (b) {
            var z = o.tag,
              I = Co(t.getText(b)),
              C = m(o.start, t.offsetAt(b.start));
            if (C) return g(z, C, I, b);
          }
          return null;
        }),
        ...
        (e.prototype.doesSupportMarkdown = function () {
          ...
          if (!Ft(this.supportsMarkdown)) {
            ...
            var i =
              (r =
                (n =
                  (t = this.lsOptions.clientCapabilities) === null ||
                  t === void 0
                    ? void 0
                    : t.textDocument) === null || n === void 0
                  ? void 0
                  : n.hover) === null || r === void 0
                ? void 0
                : r.contentFormat;
            this.supportsMarkdown =
              Array.isArray(i) && i.indexOf(we.Markdown) !== -1;
          ...
          (s.prototype.clone_empty = function () {
            ...
            (s.prototype.has_match = function (o) {
              for (var c = this.__items.length - 1; c >= 0; c--)
                if (this.__items[c].match(o)) return !0;
              return !1;
            }),
            (s.prototype.set_indent = function (o, c) {
              this.is_empty() &&
                ((this.__indent_count = o || 0),
                (this.__alignment_count = c || 0),
...
`);
              c !== -1
                ? (this.__character_count = o.length - c)
          ...
          function l(o, c) {
            (this.__cache = [""]),
              ...
              (c = c || ""),
              o.indent_level > 0 &&
                (c = new Array(o.indent_level + 1).join(this.__indent_string)),
              (this.__base_string = c),
              (this.__base_string_length = c.length);
          }
          (l.prototype.get_indent_size = function (o, c) {
            ...
            (l.prototype.__add_column = function () {
              ...
              this.__indent_size &&
                ...
                ((c = Math.floor(o / this.__indent_size)),
                (o -= c * this.__indent_size),
                (h = new Array(c + 1).join(this.__indent_string))),
                o && (h += new Array(o + 1).join(" ")),
                this.__cache.push(h);
            });
          function u(o, c) {
            (this.__indent_cache = new l(o, c)),
              (this.raw = !1),
...
` && (h = h.replace(/[\n]/g, o)),
            ...
            (u.prototype.set_indent = function (o, c) {
              return (
                (o = o || 0),
                (c = c || 0),
                this.next_line.set_indent(o, c),
                this.__lines.length > 1
                  ? (this.current_line.set_indent(o, c), !0)
                  : (this.current_line.set_indent(), !1)
              );
            }),
            (u.prototype.add_raw_token = function (o) {
              for (var c = 0; c < o.newlines; c++) this.__add_outputline();
              this.current_line.set_indent(-1),
          ...
          (l.prototype.restart = function () {
            ...
            (l.prototype.read = function (u, o, c) {
              var h = "",
                d;
              return (
                u && ((d = this.match(u)), d && (h += d[0])),
                o && (d || !u) && (h += this.readUntil(o, c)),
                h
              );
            }),
            (l.prototype.readUntil = function (u, o) {
              ...
              return (
                d
                  ? ((h = d.index), o && (h += d[0].length))
                  : (h = this.__input_length),
                (c = this.__input.substring(this.__position, h)),
                (this.__position = h),
                c
              );
            }),
          ...
          function s(l, u) {
            (l = typeof l == "string" ? l : l.source),
              ...
              (this.__directives_block_pattern = new RegExp(
                l + / beautify( \w+[:]\w+)+ /.source + u,
                "g"
              )),
              (this.__directive_pattern = / (\w+)[:](\w+)/g),
              (this.__directives_end_ignore_pattern = new RegExp(
                l + /\sbeautify\signore:end\s/.source + u,
                "g"
              ));
          }
          (s.prototype.get_directives = function (l) {
            if (!l.match(this.__directives_block_pattern)) return null;
            var u = {};
...
`
            ...
            (_.prototype.eatWhitespace = function (L) {
              for (
                var M = v.test(this._input.peek()), z = 0;
                ...
                (this._ch = this._input.next()),
                  L &&
                    this._ch ===
                      `
` &&
                    (z === 0 || z < this._options.max_preserve_newlines) &&
                    (z++, this._output.add_new_line(!0));
              return M;
            }),
...
`
              ...
              var z = L.match(/^[\t ]*/)[0];
              (this._output = new o(this._options, z)),
                (this._input = new c(L)),
                (this._indentLevel = 0),
                (this._nestedLevel = 0),
                (this._ch = null);
                ...
                if (this._ch === "/" && this._input.peek() === "*") {
                  ...
                  if ((this.preserveSingleSpace(B), this._input.peek() === "{"))
                    ...
                    T.match(/[ :]$/) &&
                      ...
                      (this._output.space_before_token = !0)),
                      (T = T.replace(/\s$/, "")),
                      T === "extend" ? (I = !0) : T === "import" && (C = !0),
                      T in this.NESTED_AT_RULE
                        ? ((this._nestedLevel += 1),
                          T in this.CONDITIONAL_GROUP_RULE && (b = !0))
                        : !p &&
                          D === 0 &&
                          T.indexOf(":") !== -1 &&
                          ((m = !0), this.indent());
...
You passed in: '` +
        ...
        function (i, s, l) {
          var u = l(8).InputScanner,
            o = l(3).Token,
            c = l(10).TokenStream,
            h = l(11).WhitespacePattern,
          ...
          (f.prototype.tokenize = function () {
            ...
            for (
              var g, v = new o(d.START, ""), w = null, y = [], k = new c();
              v.type !== d.EOF;

            ) {
              for (g = this._get_next_token(v, w); this._is_comment(g); )
                k.add(g), (g = this._get_next_token(v, w));
              k.isEmpty() || ((g.comments_before = k), (k = new c())),
                (g.parent = w),
                this._is_opening(g)
                  ? (y.push(w), (w = g))
                  : w &&
                    this._is_closing(g, w) &&
                    ((g.opened = w),
                    (w.closed = g),
                    (w = y.pop()),
                    (g.parent = w)),
        ...
        function (i) {
          ...
          (s.prototype.restart = function () {
            ...
            (s.prototype.next = function () {
              ...
              return (
                this.hasNext() &&
                  ((l = this.__tokens[this.__position]),
                  (this.__position += 1)),
                l
              );
            }),
            (s.prototype.peek = function (l) {
              ...
              return (
                (l = l || 0),
                (l += this.__position),
                l >= 0 && l < this.__tokens_length && (u = this.__tokens[l]),
                u
              );
            }),
            (s.prototype.add = function (l) {
              this.__parent_token && (l.parent = this.__parent_token),
                this.__tokens.push(l),
        ...
        function (i, s, l) {
          ...
          (o.prototype = new u()),
            (o.prototype.__set_whitespace_patterns = function (c, h) {
              (c += "\\t "),
                (h += "\\n\\r"),
            ...
            (o.prototype.__split = function (c, h) {
              ...
              for (var d = 0, f = [], g = c.exec(h); g; )
                f.push(h.substring(d, g.index)),
                  ...
                  (g = c.exec(h));
              return (
                d < h.length ? f.push(h.substring(d, h.length)) : f.push(""), f
              );
            }),
        ...
        function (i) {
          ...
          (s.prototype.read = function () {
            ...
            (s.prototype.until_after = function (l) {
              ...
              return (
                (u._until_after = !0),
                (u._until_pattern = this._input.get_regexp(l)),
                u._update(),
                u
              );
            }),
            ...
            (s.prototype.starting_with = function (l) {
              var u = this._create();
              return (
                (u._starting_pattern = this._input.get_regexp(l, !0)),
                u._update(),
                u
              );
            }),
            (s.prototype.matching = function (l) {
              var u = this._create();
              return (
                (u._match_pattern = this._input.get_regexp(l, !0)),
                u._update(),
                u
              );
            }),
        ...
        function (i, s, l) {
          var u = l(12).Pattern,
            o = { django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1 };
          function c(h, d) {
            u.call(this, h, d),
          ...
          (c.prototype = new u()),
            ...
            (c.prototype.read_options = function (h) {
              var d = this._create();
              for (var f in o) d._disabled[f] = h.templating.indexOf(f) === -1;
              return d._update(), d;
            }),
        ...
        function (i, s, l) {
          ...
          (g.prototype.current_line_has_match = function (p) {
            ...
            (g.prototype.print_preserved_newlines = function (p) {
              ...
              for (var b = 0; b < m; b++) this.print_newline(b > 0);
              return m !== 0;
            }),
          ...
          var v = function (p) {
              for (
                var m = null, b = p.next;
                b.type !== h.EOF && p.closed !== b;

              ) {
                if (b.type === h.ATTRIBUTE && b.text === "type") {
                  b.next &&
                    b.next.type === h.EQUALS &&
                    b.next.next &&
                    b.next.next.type === h.VALUE &&
                    (m = b.next.next.text);
                  break;
                }
                b = b.next;
...
`
            ...
            var b = p.match(/^[\t ]*/)[0],
              I = { text: "", type: "" },
              C = new M(),
              x = new g(this._options, b),
              W = new c(p, this._options).tokenize();
            this._tag_stack = new _(x);
            for (var B = null, P = W.next(); P.type !== h.EOF; )
              P.type === h.TAG_OPEN || P.type === h.COMMENT
                ? ((B = this._handle_tag_open(x, P, C, I)), (C = B))
                : P.type === h.ATTRIBUTE ||
                    P.type === h.EQUALS ||
                    P.type === h.VALUE ||
                    (P.type === h.TEXT && !C.tag_complete)
                  ? (B = this._handle_inside_tag(x, P, C, W))
                  : P.type === h.TAG_CLOSE
                    ? (B = this._handle_tag_close(x, P, C))
                    : P.type === h.TEXT
                      ? (B = this._handle_text(x, P, C))
                      : x.add_raw_token(P),
                (I = B),
                (P = W.next());
            ...
            (L.prototype._handle_inside_tag = function (p, m, b, I) {
              var C = b.has_wrapped_attrs,
                x = { text: m.text, type: m.type };
              if (
                (p.set_space_before_token(
                  m.newlines || m.whitespace_before !== "",
                  !0
                ...
                if (
                  (m.type === h.ATTRIBUTE
                    ? (p.set_space_before_token(!0), (b.attr_count += 1))
                    : (m.type === h.EQUALS ||
                  ...
                  m.type === h.ATTRIBUTE &&
                    ...
                    ((this._is_wrap_attributes_preserve ||
                      this._is_wrap_attributes_preserve_aligned) &&
                      (p.traverse_whitespace(m), (C = C || m.newlines !== 0)),
                    this._is_wrap_attributes_force))
                ) {
                ...
                p.print_token(m),
                  ...
                  (b.has_wrapped_attrs = C);
              }
              return x;
            }),
            (L.prototype._handle_text = function (p, m, b) {
              var I = { text: m.text, type: "TK_CONTENT" };
              return (
                b.custom_beautifier_name
                  ? this._print_custom_beatifier_text(p, m, b)
                  : b.is_unformatted || b.is_content_unformatted
                    ? p.add_raw_token(m)
              ...
              if (m.text !== "") {
                ...
                typeof this._js_beautify == "function"
                  ...
                  : b.custom_beautifier_name === "css" &&
                    ...
                    ? (x = this._css_beautify)
                    : b.custom_beautifier_name === "html" &&
                      (x = function (R, U) {
                        var F = new L(R, U, I._js_beautify, I._css_beautify);
                        return F.beautify();
                      }),
              ...
              return (
                ...
                m.text.indexOf("</") === 0
                  ...
                  : (p.traverse_whitespace(m),
                    this._set_tag_position(p, m, C, b, I),
                ...
                (b.is_empty_element ||
                  (b.is_end_tag
                    ...
                    : (this._do_optional_end_element(b) &&
                        (b.is_inline_element || p.print_newline(!1)),
                      this._tag_stack.record_tag(b),
                      (b.tag_name === "script" || b.tag_name === "style") &&
                        !(b.is_unformatted || b.is_content_unformatted) &&
                        (b.custom_beautifier_name = w(b.tag_check, m)))),
                y(b.tag_check, this._options.extra_liners) &&
                  (p.print_newline(!1),
...
`) === -1) ||
                  (b.is_inline_element ||
                    b.is_unformatted ||
                    p.print_newline(!1),
                  this._calcluate_parent_multiline(p, b));
              } else if (b.is_end_tag) {
                var W = !1;
                (W = b.start_tag_token && b.start_tag_token.multiline_content),
                  (W =
                    W ||
                    (!b.is_inline_element &&
                      !(I.is_inline_element || I.is_unformatted) &&
                      !(C.type === h.TAG_CLOSE && b.start_tag_token === I) &&
                      C.type !== "TK_CONTENT")),
                  (b.is_content_unformatted || b.is_unformatted) && (W = !1),
                  W && p.print_newline(!1);
              } else
                (b.indent_content = !b.custom_beautifier_name),
                  ...
                  !(b.is_inline_element || b.is_unformatted) &&
                    (C.type !== "TK_CONTENT" || b.is_content_unformatted) &&
                    p.print_newline(!1),
                  this._calcluate_parent_multiline(p, b);
            }),
          ...
          (L.prototype._do_optional_end_element = function (p) {
            ...
            if (!(p.is_empty_element || !p.is_start_tag || !p.parent)) {
              if (p.tag_name === "body")
                ...
                p.parent.tag_name === "p" &&
                z.indexOf(p.tag_name) !== -1
              ) {
                var b = p.parent.parent;
                (!b || D.indexOf(b.tag_name) === -1) &&
                  (m = m || this._tag_stack.try_pop("p"));
              } else
                p.tag_name === "rp" || p.tag_name === "rt"
                  ? ((m = m || this._tag_stack.try_pop("rt", ["ruby", "rtc"])),
                    (m = m || this._tag_stack.try_pop("rp", ["ruby", "rtc"])))
                  : p.tag_name === "optgroup"
            ...
            v = function (w, y) {
              ...
              if (
                ...
                this.__patterns.unformatted_content_delimiter =
                  _.matching(L).until_after(L);
              }
            };
          (v.prototype = new u()),
            (v.prototype._is_comment = function (w) {
              return !1;
            }),
            ...
            (v.prototype._is_closing = function (w, y) {
              return (
                w.type === f.TAG_CLOSE &&
                y &&
                (((w.text === ">" || w.text === "/>") && y.text[0] === "<") ||
                  (w.text === "}}" && y.text[0] === "{" && y.text[1] === "{"))
              );
            }),
            ...
            (v.prototype._get_next_token = function (w, y) {
              ...
              return _ === null
                ...
                : ((k = k || this._read_open_handlebars(_, y)),
                  (k = k || this._read_attribute(_, w, y)),
                  (k = k || this._read_close(_, y)),
                  (k = k || this._read_raw_content(_, w, y)),
                  (k = k || this._read_content_word(_)),
                  (k = k || this._read_comment_or_cdata(_)),
                  (k = k || this._read_processing(_)),
                  (k = k || this._read_open(_, y)),
                  (k = k || this._create_token(f.UNKNOWN, this._input.next())),
                  k);
            }),
              ...
              return (
                y ||
                  (w === "<" &&
                    ...
                    (_ = this._create_token(f.TAG_OPEN, k)))),
                _
              );
            }),
                  ...
                  (this._options.indent_handlebars &&
                    ...
                    (this._input.peek(2) === "!"
                      ? ((k = this.__patterns.handlebars_comment.read()),
                        ...
                        (_ = this._create_token(f.COMMENT, k)))
            ...
            (v.prototype._read_close = function (w, y) {
              ...
              return (
                y &&
                  (y.text[0] === "<" &&
                  (w === ">" || (w === "/" && this._input.peek(1) === ">"))
                    ? ((k = this._input.next()),
                      w === "/" && (k += this._input.next()),
                      (_ = this._create_token(f.TAG_CLOSE, k)))
                    : y.text[0] === "{" &&
                      w === "}" &&
                      this._input.peek(1) === "}" &&
                      (this._input.next(),
                      this._input.next(),
                      (_ = this._create_token(f.TAG_CLOSE, "}}")))),
                _
              );
            }),
              ...
              if (k && k.text[0] === "<")
                if (w === "=")
                  ...
                  w === '"'
                    ...
                    (_ = this._create_token(f.VALUE, M));
                } else
                  (L = this.__patterns.attribute.read()),
                    L &&
                      (y.type === f.EQUALS
                        ? (_ = this._create_token(f.VALUE, L))
                        : (_ = this._create_token(f.ATTRIBUTE, L)));
              return _;
            }),
            (v.prototype._is_content_unformatted = function (w) {
              return (
                this._options.void_elements.indexOf(w) === -1 &&
                (this._options.content_unformatted.indexOf(w) !== -1 ||
                  this._options.unformatted.indexOf(w) !== -1)
              );
            }),
            (v.prototype._read_raw_content = function (w, y, k) {
              ...
              if (k && k.text[0] === "{")
                ...
                if (L === "script" || L === "style") {
                  ...
                  if (M) return (M.type = f.TEXT), M;
                  _ = this._input.readUntil(
                    new RegExp("</" + L + "[\\n\\r\\t ]*?>", "ig")
                  );
                } else
            ...
            (v.prototype._read_content_word = function (w) {
              ...
              if (
                (this._options.unformatted_content_delimiter &&
                  w === this._options.unformatted_content_delimiter[0] &&
  ...
  function Eo(e, t, n) {
    var r = e.getText(),
      ...
      l = n.tabSize || 4;
    if (t) {
      for (var u = e.offsetAt(t.start), o = u; o > 0 && Gi(r, o - 1); ) o--;
      o === 0 || ji(r, o - 1) ? (u = o) : o < u && (u = o + 1);
      for (var c = e.offsetAt(t.end), h = c; h < r.length && Gi(r, h); ) h++;
      (h === r.length || ji(r, h)) && (c = h),
        (t = X.create(e.positionAt(u), e.positionAt(c)));
      var d = r.substring(0, u);
      if (new RegExp(/.*[<][^>]*$/).test(d))
        return (r = r.substring(u, c)), [{ range: t, newText: r }];
      if (((i = c === r.length), (r = r.substring(u, c)), u !== 0)) {
        var f = e.offsetAt(ne.create(t.start.line, 0));
        s = Ro(e.getText(), f, n);
      }
    } else t = X.create(ne.create(0, 0), e.positionAt(r.length));
    var g = {
        indent_size: l,
        indent_char: n.insertSpaces ? " " : "	",
        indent_empty_lines: me(n, "indentEmptyLines", !1),
        wrap_line_length: me(n, "wrapLineLength", 120),
        unformatted: En(n, "unformatted", void 0),
        content_unformatted: En(n, "contentUnformatted", void 0),
        ...
        extra_liners: En(n, "extraLiners", void 0),
...
`,
      ...
      v = Lo(Mo(r), g);
    if (s > 0) {
      var w = n.insertSpaces ? Wi(" ", l * s) : Wi("	", s);
      (v = v
        .split(
          `
`
...
` + w
        ...
        t.start.character === 0 && (v = w + v);
    }
    return [{ range: t, newText: v }];
  }
  function Mo(e) {
    return e.replace(/^\s+/, "");
  }
...
`.indexOf(e.charAt(t)) !== -1
  ...
  $i = (() => {
    var e = {
        470: r => {
          ...
          function s(u, o) {
            for (
              var c, h = "", d = 0, f = -1, g = 0, v = 0;
              v <= u.length;
              ++v
            ) {
              if (v < u.length) c = u.charCodeAt(v);
              else {
                if (c === 47) break;
                c = 47;
              }
          ...
          var l = {
            resolve: function () {
              for (
                var u, o = "", c = !1, h = arguments.length - 1;
                h >= -1 && !c;
                h--
              ) {
                var d;
                h >= 0
                  ? (d = arguments[h])
                  : (u === void 0 && (u = process.cwd()), (d = u)),
                  i(d),
                  d.length !== 0 &&
                    ((o = d + "/" + o), (c = d.charCodeAt(0) === 47));
              }
              return (
                (o = s(o, !c)),
                c ? (o.length > 0 ? "/" + o : "/") : o.length > 0 ? o : "."
              );
            },
            normalize: function (u) {
              if ((i(u), u.length === 0)) return ".";
              var o = u.charCodeAt(0) === 47,
                c = u.charCodeAt(u.length - 1) === 47;
              return (
                (u = s(u, !o)).length !== 0 || o || (u = "."),
                u.length > 0 && c && (u += "/"),
                o ? "/" + u : u
              );
            },
            ...
            relative: function (u, o) {
              if (
                (i(u),
                i(o),
                u === o || (u = l.resolve(u)) === (o = l.resolve(o)))
              )
                return "";
              for (var c = 1; c < u.length && u.charCodeAt(c) === 47; ++c);
              for (
                var h = u.length, d = h - c, f = 1;
                f < o.length && o.charCodeAt(f) === 47;
                ++f
              );
              for (
                var g = o.length - f, v = d < g ? d : g, w = -1, y = 0;
                y <= v;
                ++y
              ) {
                if (y === v) {
                  if (g > v) {
                    if (o.charCodeAt(f + y) === 47) return o.slice(f + y + 1);
                    if (y === 0) return o.slice(f + y);
                  } else
                    d > v &&
                      (u.charCodeAt(c + y) === 47
                        ? (w = y)
                ...
                if (k !== o.charCodeAt(f + y)) break;
                k === 47 && (w = y);
              }
              var _ = "";
              for (y = c + w + 1; y <= h; ++y)
                (y !== h && u.charCodeAt(y) !== 47) ||
                  (_.length === 0 ? (_ += "..") : (_ += "/.."));
              return _.length > 0
                ? _ + o.slice(f + w)
                : ((f += w), o.charCodeAt(f) === 47 && ++f, o.slice(f));
            },
            ...
            basename: function (u, o) {
              ...
              if (o !== void 0 && o.length > 0 && o.length <= u.length) {
                ...
                return (
                  h === d ? (d = v) : d === -1 && (d = u.length), u.slice(h, d)
                );
              }
              for (c = u.length - 1; c >= 0; --c)
            ...
            extname: function (u) {
              i(u);
              for (
                var o = -1, c = 0, h = -1, d = !0, f = 0, g = u.length - 1;
                g >= 0;
                --g
              ) {
            ...
            parse: function (u) {
              ...
              d ? ((o.root = "/"), (c = 1)) : (c = 0);
              for (
                var f = -1, g = 0, v = -1, w = !0, y = u.length - 1, k = 0;
                y >= c;
                --y
              )
              ...
              return (
                ...
                (k === 1 && f === v - 1 && f === g + 1)
                  ? v !== -1 &&
                    (o.base = o.name =
                      g === 0 && d ? u.slice(1, v) : u.slice(g, v))
                  : (g === 0 && d
                      ? ((o.name = u.slice(1, f)), (o.base = u.slice(1, v)))
                      : ((o.name = u.slice(g, f)), (o.base = u.slice(g, v))),
                    (o.ext = u.slice(f, v))),
                g > 0 ? (o.dir = u.slice(0, g - 1)) : d && (o.dir = "/"),
                o
              );
            },
            sep: "/",
        ...
        447: (r, i, s) => {
            ...
            if (!S.scheme && T)
              throw new Error(
                '[UriError]: Scheme is missing: {scheme: "", authority: "'
                  .concat(S.authority, '", path: "')
                  .concat(S.path, '", query: "')
                  .concat(S.query, '", fragment: "')
                  .concat(S.fragment, '"}')
              );
              ...
              function S(T, E, H, R, U, F) {
                F === void 0 && (F = !1),
                  typeof T == "object"
                    ...
                    : ((this.scheme = (function (G, $) {
                        return G || $ ? G : "file";
                      })(T, F)),
                      (this.authority = E || w),
                      (this.path = (function (G, $) {
                        switch (G) {
                          case "https":
                          case "http":
                          case "file":
              ...
              return (
                ...
                (S.prototype.with = function (T) {
                  ...
                  var E = T.scheme,
                    ...
                    F = T.fragment;
                  return (
                    E === void 0 ? (E = this.scheme) : E === null && (E = w),
                    H === void 0 ? (H = this.authority) : H === null && (H = w),
                    R === void 0 ? (R = this.path) : R === null && (R = w),
                    U === void 0 ? (U = this.query) : U === null && (U = w),
                    F === void 0 ? (F = this.fragment) : F === null && (F = w),
                    E === this.scheme &&
                    H === this.authority &&
                    R === this.path &&
                    U === this.query &&
                ...
                (S.file = function (T) {
                  var E = w;
                  if (
                    (l && (T = T.replace(/\\/g, y)), T[0] === y && T[1] === y)
                  ) {
                    var H = T.indexOf(y, 2);
                    H === -1
                      ? ((E = T.substring(2)), (T = y))
                      : ((E = T.substring(2, H)), (T = T.substring(H) || y));
                  }
                ...
                (S.revive = function (T) {
                  if (T) {
                    ...
                    return (
                      ...
                      (E._fsPath = T._sep === L ? T.fsPath : null),
                      E
                    );
                  }
                  return T;
            ...
            M = (function (S) {
              ...
              return (
                ...
                Object.defineProperty(T.prototype, "fsPath", {
                  get: function () {
                    return (
                      this._fsPath || (this._fsPath = m(this, !1)), this._fsPath
                    );
                  },
                  enumerable: !1,
                  configurable: !0
          ...
          function D(S, T) {
            for (var E = void 0, H = -1, R = 0; R < S.length; R++) {
              ...
              if (
                ...
                H !== -1 &&
                  ((E += encodeURIComponent(S.substring(H, R))), (H = -1)),
                  E !== void 0 && (E += S.charAt(R));
              else {
            ...
            return (
              H !== -1 && (E += encodeURIComponent(S.substring(H))),
              E !== void 0 ? E : S
            );
          }
          function p(S) {
            ...
            return (
              (E =
                S.authority && S.path.length > 1 && S.scheme === "file"
                  ? "//".concat(S.authority).concat(S.path)
          ...
          function b(S, T) {
            ...
            if (
              ...
              (j = (U = U.toLowerCase()).indexOf(":")) === -1
                ? (H += E(U, !1))
                : ((H += E(U.substr(0, j), !1)), (H += U.substr(j)));
            }
            if (F) {
              if (
                F.length >= 3 &&
                ...
                (oe = F.charCodeAt(1)) >= 65 &&
                  oe <= 90 &&
                  (F = "/"
                    .concat(String.fromCharCode(oe + 32), ":")
                    .concat(F.substr(3)));
              else if (F.length >= 2 && F.charCodeAt(1) === 58) {
                var oe;
                (oe = F.charCodeAt(0)) >= 65 &&
                  oe <= 90 &&
                  (F = ""
                    .concat(String.fromCharCode(oe + 32), ":")
                    .concat(F.substr(2)));
          ...
          var W,
            ...
            P = function (S, T, E) {
              if (E || arguments.length === 2)
                for (var H, R = 0, U = T.length; R < U; R++)
                  (!H && R in T) ||
                    (H || (H = Array.prototype.slice.call(T, 0, R)),
                    (H[R] = T[R]));
          ...
          (function (S) {
            (S.joinPath = function (T) {
              ...
              (S.dirname = function (T) {
                ...
                return E.length === 1 && E.charCodeAt(0) === 46
                  ? T
                  : T.with({ path: E });
              }),
    ...
    return (
      (n.d = (r, i) => {
        for (var s in i)
          n.o(i, s) &&
            !n.o(r, s) &&
            Object.defineProperty(r, s, { enumerable: !0, get: i[s] });
      }),
  ...
  var { URI: No, Utils: ul } = $i;
  function Mn(e) {
    var t = e[0],
      n = e[e.length - 1];
    return (
      t === n && (t === "'" || t === '"') && (e = e.substr(1, e.length - 2)), e
    );
  }
  function Uo(e, t) {
  ...
  function Ho(e, t, n, r, i, s) {
    var l = Mn(n);
    if (!!Uo(l, e.languageId)) {
      l.length < n.length && (r++, i--);
      var u = Io(e.uri, l, t, s);
      if (!(!u || !zo(u)))
        return { range: X.create(e.positionAt(r), e.positionAt(i)), target: u };
    }
  }
  function zo(e) {
    try {
  ...
  function Wo(e, t) {
      ...
      switch (i) {
        ...
        case N.AttributeValue:
          if (s === "src" || s === "href") {
            ...
            if (!l) {
              var d = Ho(e, t, h, r.getTokenOffset(), r.getTokenEnd(), u);
              d && n.push(d);
            }
            l &&
              typeof u > "u" &&
              ((u = Mn(h)), u && t && (u = t.resolveReference(u, e.uri))),
              (l = !1),
              (s = void 0);
          } else if (s === "id") {
            var f = Mn(r.getTokenText());
    ...
    for (var g = 0, v = n; g < v.length; g++) {
      ...
      if (d.target && Ie(d.target, w)) {
        var y = d.target.substr(w.length),
          k = o[y];
        if (k !== void 0) {
  ...
  function Fo(e, t, n) {
    ...
    if (!i.tag) return [];
    var s = [],
      l = Qi(N.StartTag, e, i.start),
      u = typeof i.endTagStart == "number" && Qi(N.EndTag, e, i.endTagStart);
    return (
      ((l && Ji(l, t)) || (u && Ji(u, t))) &&
        (l && s.push({ kind: Ut.Read, range: l }),
        u && s.push({ kind: Ut.Read, range: u })),
      s
    );
  }
  function Xi(e, t) {
  ...
  function Qi(e, t, n) {
    for (var r = fe(t.getText(), n), i = r.scan(); i !== N.EOS && i !== e; )
      i = r.scan();
    return i !== N.EOS
      ? {
  ...
  function Yi(e, t, n, r) {
    var i = Po(t),
      s = xt.create(
        e.uri,
        X.create(e.positionAt(t.start), e.positionAt(t.end))
      ),
      l = { name: i, location: s, containerName: n, kind: An.Field };
    r.push(l),
  ...
  function Zi(e, t, n) {
    var r = e.offsetAt(t),
      i = n.findNodeAt(r),
      s = i.tag ? i.tag.length : 0;
    return i.endTagStart &&
      ((i.start + 1 <= r && r <= i.start + 1 + s) ||
        (i.endTagStart + 2 <= r && r <= i.endTagStart + 2 + s))
      ? [
          X.create(e.positionAt(i.start + 1), e.positionAt(i.start + 1 + s)),
          X.create(
            e.positionAt(i.endTagStart + 2),
            e.positionAt(i.endTagStart + 2 + s)
          )
        ]
      : null;
  }
  function jo(e, t) {
    ...
    for (
      ...
      if (!n) (n = o), l(u, 0);
        ...
        if (o.endLine <= n.endLine) r.push(n), (n = o), l(u, r.length);
  ...
  function Go(e, t) {
    ...
    for (; r !== N.EOS; ) {
      switch (r) {
        ...
        case N.EndTagClose:
        case N.StartTagSelfClose: {
          for (var d = s.length - 1; d >= 0 && s[d].tagName !== l; ) d--;
          if (d >= 0) {
            var f = s[d];
            s.length = d;
            var g = e.positionAt(n.getTokenOffset()).line,
              h = f.startLine,
              v = g - 1;
        ...
        case N.Comment: {
          var h = e.positionAt(n.getTokenOffset()).line,
            w = n.getTokenText(),
            y = w.match(/^\s*#(region\b)|(endregion\b)/);
          if (y)
            if (y[1]) s.push({ startLine: h, tagName: "" });
            else {
              for (var d = s.length - 1; d >= 0 && s[d].tagName.length; ) d--;
              if (d >= 0) {
                var f = s[d];
                s.length = d;
                var v = h;
                (h = f.startLine),
                  v > h &&
                    u !== h &&
                    o({ startLine: h, endLine: v, kind: Lt.Region });
              }
            }
          else {
  ...
  function $o(e, t) {
    function n(r) {
      for (
        var i = Xo(e, r), s = void 0, l = void 0, u = i.length - 1;
        u >= 0;
        u--
      ) {
        var o = i[u];
        (!s || o[0] !== s[0] || o[1] !== s[1]) &&
          (l = It.create(
            X.create(e.positionAt(i[u][0]), e.positionAt(i[u][1])),
            l
          )),
          (s = o);
      }
      return l || (l = It.create(X.create(r, r))), l;
    }
    return t.map(n);
  }
  function Xo(e, t) {
    ...
    if (i.startTagEnd && !i.endTagStart) {
      ...
      var l = X.create(
        ...
        u = e.getText(l);
      u === "/>"
        ? s.unshift([i.start + 1, i.startTagEnd - 2])
        : s.unshift([i.start + 1, i.startTagEnd - 1]);
      var o = Ki(e, i, r);
      return (s = o.concat(s)), s;
    }
    if (!i.startTagEnd || !i.endTagStart) return s;
    if ((s.unshift([i.start, i.end]), i.start < r && r < i.startTagEnd)) {
      ...
      return i.startTagEnd <= r && r <= i.endTagStart
        ? (s.unshift([i.startTagEnd, i.endTagStart]), s)
        : (r >= i.endTagStart + 2 && s.unshift([i.endTagStart + 2, i.end - 1]),
          s);
  }
  function Jo(e) {
    for (
  ...
  function Ki(e, t, n) {
    for (
      var r = X.create(e.positionAt(t.start), e.positionAt(t.end)),
        i = e.getText(r),
        s = n - t.start,
        l = fe(i),
        u = l.scan(),
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
    ...
    Yo = (function () {
      ...
      return (
        (e.prototype.setDataProviders = function (t, n) {
          var r;
          (this.dataProviders = []),
            t && this.dataProviders.push(new Fi("html5", Qo)),
  ...
  function Ko(e) {
    ...
    return {
      ...
      format: Eo,
      findDocumentHighlights: Fo,
      findDocumentLinks: Wo,
      findDocumentSymbols: Bo,
      getFoldingRanges: Go,
      getSelectionRanges: $o,
      doQuoteComplete: r.doQuoteComplete.bind(r),
      doTagComplete: r.doTagComplete.bind(r),
      doRename: qo,
      findMatchingTagPosition: Vo,
      findOnTypeRenameRanges: Zi,
      findLinkedEditingRanges: Zi
    };
  }
  function el(e, t) {
    return new Fi(e, t);
  ...
  var tl = class {
    constructor(e, t) {
      ...
      const n = this._languageSettings.data,
        r = n == null ? void 0 : n.useDefaultDataProvider,
        i = [];
      if (n != null && n.dataProviders)
        for (const s in n.dataProviders) i.push(el(s, n.dataProviders[s]));
      this._languageService = Ko({
    ...
    async format(e, t, n) {
      ...
      if (!r) return [];
      let i = { ...this._languageSettings.format, ...n },
    ...
    async doRename(e, t, n) {
      let r = this._getTextDocument(e);
      if (!r) return null;
      let i = this._languageService.parseHTMLDocument(r),
    ...
    _getTextDocument(e) {
      ...
      for (let n of t)
        if (n.uri.toString() === e)
          return Cn.create(e, this._languageId, n.version, n.getValue());
      return null;
    }
  };
  self.onmessage = () => {
