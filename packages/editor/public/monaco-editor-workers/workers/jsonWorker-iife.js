...
var ul = (Be, ke, qe) =>
  ke in Be
    ? ll(Be, ke, { enumerable: !0, configurable: !0, writable: !0, value: qe })
    : (Be[ke] = qe);
var Lt = (Be, ke, qe) => (ul(Be, typeof ke != "symbol" ? ke + "" : ke, qe), qe);
(function () {
  "use strict";
  class Be {
    constructor() {
...
` +
  ...
  function _a(e) {
    return e instanceof Sa
      ? !0
      : e instanceof Error && e.name === Kt && e.message === Kt;
  }
  ...
  (function (e) {
    function t(N) {
      return (
        N && typeof N == "object" && typeof N[Symbol.iterator] == "function"
      );
    }
    e.is = t;
    ...
    e.first = l;
    function u(N, x) {
      for (const w of N) if (x(w)) return !0;
      return !1;
    }
    e.some = u;
    function c(N, x) {
      for (const w of N) if (x(w)) return w;
    }
    e.find = c;
    function* h(N, x) {
      for (const w of N) x(w) && (yield w);
    }
    e.filter = h;
    function* f(N, x) {
      let w = 0;
      for (const b of N) yield x(b, w++);
    }
    e.map = f;
    function* d(...N) {
      for (const x of N) for (const w of x) yield w;
    }
    e.concat = d;
    function* m(N) {
      for (const x of N) for (const w of x) yield w;
    ...
    function v(N, x, w) {
      let b = w;
      for (const y of N) b = x(b, y);
      return b;
    }
    e.reduce = v;
    function p(N, x) {
      let w = 0;
      for (const b of N) x(b, w++);
    }
    e.forEach = p;
    function* g(N, x, w = N.length) {
      for (
        x < 0 && (x += N.length),
          w < 0 ? (w += N.length) : w > N.length && (w = N.length);
        x < w;
        x++
      )
        yield N[x];
    ...
    function C(N, x, w = (b, y) => b === y) {
      ...
      for (;;) {
        const _ = b.next(),
          k = y.next();
        if (_.done !== k.done) return !1;
        if (_.done) return !0;
        if (!w(_.value, k.value)) return !1;
      }
    }
    e.equals = C;
  })(kt || (kt = {}));
  ...
  $e.DISABLE_DISPOSED_WARNING = !1;
  class er {
    constructor() {
      (this._store = new $e()), this._store;
    }
    dispose() {
      this._store.dispose();
    }
  ...
  class Mt {
    ...
    _remove(t) {
      if (t.prev !== z.Undefined && t.next !== z.Undefined) {
        ...
        t.prev === z.Undefined && t.next === z.Undefined
          ? ((this._first = z.Undefined), (this._last = z.Undefined))
          : t.next === z.Undefined
            ? ((this._last = this._last.prev), (this._last.next = z.Undefined))
            : t.prev === z.Undefined &&
              ((this._first = this._first.next),
              (this._first.prev = z.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let t = this._first;
      for (; t !== z.Undefined; ) yield t.element, (t = t.next);
    }
  }
  ...
  let te;
  typeof ee.vscode < "u" && typeof ee.vscode.process < "u"
    ? (te = ee.vscode.process)
    : typeof process < "u" && (te = process);
  const Ea =
    typeof ((tr = te == null ? void 0 : te.versions) === null || tr === void 0
      ? void 0
      : tr.electron) == "string" &&
    (te == null ? void 0 : te.type) === "renderer";
  if (typeof navigator == "object" && !Ea)
    (Te = navigator.userAgent),
      (rr = Te.indexOf("Windows") >= 0),
      (nr = Te.indexOf("Macintosh") >= 0),
      (Te.indexOf("Macintosh") >= 0 ||
        Te.indexOf("iPad") >= 0 ||
        Te.indexOf("iPhone") >= 0) &&
        !!navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0,
      (ir = Te.indexOf("Linux") >= 0),
      (tn = !0),
      Pa({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
      (Pt = ut),
      (ar = Pt);
  else if (typeof te == "object") {
    (rr = te.platform === "win32"),
      (nr = te.platform === "darwin"),
      (ir = te.platform === "linux"),
      ir && !!te.env.SNAP && te.env.SNAP_REVISION,
      te.env.CI || te.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
      (Pt = ut),
      (ar = ut);
    ...
    if (e)
      try {
        ...
        (Pt = t.locale), (ar = r || ut), (Ta = t._translationsConfigFile);
      } catch {}
  ...
  tn && ee.importScripts;
  const ye = Te,
    Va = typeof ee.postMessage == "function" && !ee.importScripts;
  (() => {
    if (Va) {
      const e = [];
      ee.addEventListener("message", r => {
      ...
      return r => {
        ...
        e.push({ id: n, callback: r }),
          ee.postMessage({ vscodeScheduleAsyncWork: n }, "*");
      };
    }
    return e => setTimeout(e);
  })();
  const Ia = !!(ye && ye.indexOf("Chrome") >= 0);
  ye && ye.indexOf("Firefox") >= 0,
    !Ia && ye && ye.indexOf("Safari") >= 0,
    ye && ye.indexOf("Edg/") >= 0,
    ye && ye.indexOf("Android") >= 0;
  const Da = ee.performance && typeof ee.performance.now == "function";
  class Tt {
    constructor(t) {
      (this._highResolution = Da && t),
  ...
  (function (e) {
    ...
    function t(w) {
      return (b, y = null, _) => {
        ...
        return (
          (T = w(
            P => {
              if (!k) return T ? T.dispose() : (k = !0), b.call(y, P);
            },
            null,
            _
          )),
    ...
    function o(...w) {
      return (b, y = null, _) =>
        La(...w.map(k => k(T => b.call(y, T), null, _)));
    }
    e.any = o;
    function l(w, b, y, _) {
      let k = y;
    ...
    e.latch = h;
    function f(w, b, y) {
      return [e.filter(w, b, y), e.filter(w, _ => !b(_), y)];
    }
    e.split = f;
    function d(w, b = !1, y = []) {
      let _ = y.slice(),
    ...
    class m {
      constructor(b) {
        (this.event = b), (this.disposables = new $e());
      }
      map(b) {
    ...
    function p(w, b, y = _ => _) {
      const _ = (...I) => P.fire(y(...I)),
        k = () => w.on(b, _),
        T = () => w.removeListener(b, _),
        P = new Ce({ onFirstListenerAdd: k, onLastListenerRemove: T });
      return P.event;
    }
    e.fromNodeEventEmitter = p;
    function g(w, b, y = _ => _) {
      const _ = (...I) => P.fire(y(...I)),
        k = () => w.addEventListener(b, _),
        T = () => w.removeEventListener(b, _),
        P = new Ce({ onFirstListenerAdd: k, onLastListenerRemove: T });
      return P.event;
    }
    ...
    function C(w, b) {
      let y = null;
      function _(T) {
        y == null || y.dispose(), (y = new $e()), b(T, y);
      }
      _(void 0);
      const k = w(T => _(T));
      return xt(() => {
    ...
    class N {
      constructor(b, y) {
        ...
        (this.emitter = new Ce(_)), y && y.add(this.emitter);
      }
      beginUpdate(b) {
        this._counter++;
      }
  ...
  class Et {
    constructor(t) {
      (this._listenerCount = 0),
        ...
        (this._name = `${t}_${Et._idPool++}`);
    }
    start(t) {
      (this._stopWatch = new Tt(!0)), (this._listenerCount = t);
    }
    stop() {
      if (this._stopWatch) {
        ...
        (this._elapsedOverall += t),
          ...
          console.info(
            `did FIRE ${this._name}: elapsed_ms: ${t.toFixed(5)}, listener: ${
              this._listenerCount
  ...
  class or {
    ...
    static create() {
      var t;
      return new or((t = new Error().stack) !== null && t !== void 0 ? t : "");
    }
    print() {
      console.warn(
        this.value
...
`)
  ...
  class Ce {
    constructor(t) {
      ...
      (this._disposed = !1),
        ...
        (this._perfMon =
          !((r = this._options) === null || r === void 0) && r._profName
    ...
    get event() {
      return (
        this._event ||
          (this._event = (t, r, n) => {
            var i, s, o;
            this._listeners || (this._listeners = new Mt());
            ...
            this._leakageMon &&
              ...
              ((c = or.create()),
              (u = this._leakageMon.check(c, this._listeners.size + 1)));
            const h = new Ra(t, r, c),
            ...
            l &&
              ...
              !((o = this._options) === null || o === void 0) &&
                o.onListenerDidAdd &&
                this._options.onListenerDidAdd(this, t, r);
            ...
            return (
              n instanceof $e ? n.add(d) : Array.isArray(n) && n.push(d), d
            );
          }),
        this._event
      );
  ...
  function lr(e) {
    const t = [];
    for (const r of Ba(e)) typeof e[r] == "function" && t.push(r);
    return t;
  }
  function qa(e, t) {
    const r = i =>
  ...
  class Wa {
    ...
    get(t) {
      ...
      return (
        this.lastArgKey !== r &&
          ((this.lastArgKey = r), (this.lastCache = this.fn(t))),
        this.lastCache
      );
    }
  }
  ...
  (nn = ge),
    (ge.ambiguousCharacterData = new rn(() =>
      JSON.parse(
    ...
    (ge.cache = new Wa(e => {
      ...
      function n(c, h) {
        if (!c) return h;
        const f = new Map();
        for (const [d, m] of c) h.has(d) && f.set(d, m);
        return f;
      }
      const i = nn.ambiguousCharacterData.getValue();
    ...
    (ge._locales = new rn(() =>
      Object.keys(ge.ambiguousCharacterData.getValue()).filter(
        e => !e.startsWith("_")
      )
    ));
  class Ee {
  ...
  class as {
    ...
    sendMessage(t, r) {
      ...
      return new Promise((i, s) => {
        (this._pendingReplies[n] = { resolve: i, reject: s }),
          this._send(new ts(this._workerId, n, t, r));
      });
    }
    listen(t, r) {
      let n = null;
      const i = new Ce({
        onFirstListenerAdd: () => {
          (n = String(++this._lastSentReq)),
            ...
            this._send(new rs(this._workerId, n, t, r));
        },
        onLastListenerRemove: () => {
          this._pendingEmitters.delete(n),
            this._send(new is(this._workerId, n)),
            (n = null);
        }
      });
      return i.event;
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        ...
        i => {
          i.detail instanceof Error && (i.detail = Kr(i.detail)),
            this._send(new sn(this._workerId, r, void 0, Kr(i)));
        }
      );
    }
    _handleSubscribeEventMessage(t) {
      const r = t.req,
        n = this._handler.handleEvent(
          ...
          this._send(new ns(this._workerId, r, i));
        });
  ...
  class os {
    ...
    _handleMessage(t, r) {
      if (t === es) return this.initialize(r[0], r[1], r[2], r[3]);
      ...
      try {
        return Promise.resolve(
          this._requestHandler[t].apply(this._requestHandler, r)
        );
      } catch (n) {
    ...
    initialize(t, r, n, i) {
      ...
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(l)),
          Promise.resolve(lr(this._requestHandler)))
        : (r &&
            (typeof r.baseUrl < "u" && delete r.baseUrl,
            typeof r.paths < "u" &&
              typeof r.paths.vs < "u" &&
              delete r.paths.vs,
            typeof r.trustedTypesPolicy !== void 0 &&
              delete r.trustedTypesPolicy,
            (r.catchError = !0),
            ee.require.config(r)),
          new Promise((u, c) => {
            const h = ee.require;
  ...
  function ls(e, t) {
    t = un(149417, t);
    for (let r = 0, n = e.length; r < n; r++) t = un(e.charCodeAt(r), t);
    return t;
  }
  class cn {
    constructor(t) {
  ...
  function us(e, t, r) {
    return new Ve(new cn(e), new cn(t)).ComputeDiff(r).changes;
  }
  class Ye {
    static Assert(t, r) {
  ...
  class Ve {
    constructor(t, r, n = null) {
      ...
      const [i, s, o] = Ve._getElements(t),
        [l, u, c] = Ve._getElements(r);
    ...
    static _getElements(t) {
      ...
      if (Ve._isStringArray(r)) {
        const n = new Int32Array(r.length);
        for (let i = 0, s = r.length; i < s; i++) n[i] = ls(r[i], 0);
        return [r, n, !0];
      }
      return r instanceof Int32Array
        ? [[], r, !1]
        : [[], new Int32Array(r), !1];
    }
    ...
    ElementsAreStrictEqual(t, r) {
      ...
      const n = Ve._getStrictElement(this._originalSequence, t),
        i = Ve._getStrictElement(this._modifiedSequence, r);
      return n === i;
    }
    static _getStrictElement(t, r) {
      return typeof t.getStrictElement == "function"
        ? t.getStrictElement(r)
        : null;
    }
    ...
    _ComputeDiff(t, r, n, i, s) {
      ...
      return (
        s && (l = this.PrettifyChanges(l)), { quitEarly: o[0], changes: l }
      );
    }
    ComputeDiffRecursive(t, r, n, i, s) {
      ...
      const o = [0],
        l = [0],
        u = this.ComputeRecursionPoint(t, r, n, i, o, l, s),
        c = o[0],
        h = l[0];
      if (u !== null) return u;
      if (!s[0]) {
        ...
        return (
          s[0]
            ? (d = [new Fe(c + 1, r - (c + 1) + 1, h + 1, i - (h + 1) + 1)])
            : (d = this.ComputeDiffRecursive(c + 1, r, h + 1, i, s)),
          this.ConcatenateChanges(f, d)
        );
      }
      return [new Fe(t, r - t + 1, n, i - n + 1)];
    }
    WALKTRACE(t, r, n, i, s, o, l, u, c, h, f, d, m, v, p, g, A, S) {
      ...
      do {
        ...
        T === w || (T < b && c[T - 1] < c[T + 1])
          ? ((f = c[T + 1]),
            (v = f - y - i),
            f < _ && x.MarkNextChange(),
            (_ = f),
            x.AddModifiedElement(f + 1, v),
            (y = T + 1 - t))
          : ((f = c[T - 1] + 1),
            (v = f - y - i),
            f < _ && x.MarkNextChange(),
            (_ = f - 1),
            x.AddOriginalElement(f, v + 1),
            (y = T - 1 - t)),
          k >= 0 &&
            ((c = this.m_forwardHistory[k]),
            (t = c[0]),
            (w = 1),
            (b = c.length - 1));
      } while (--k >= -1);
      if (((C = x.getReverseChanges()), S[0])) {
        ...
        if (C !== null && C.length > 0) {
          ...
          (T = Math.max(T, I.getOriginalEnd())),
            (P = Math.max(P, I.getModifiedEnd()));
        }
        N = [new Fe(T, d - T + 1, P, p - P + 1)];
      } else {
        (x = new fn()),
          (w = o),
          (b = l),
        ...
        do {
          ...
          T === w || (T < b && h[T - 1] >= h[T + 1])
            ? ((f = h[T + 1] - 1),
              ...
              f > _ && x.MarkNextChange(),
              (_ = f + 1),
              x.AddOriginalElement(f + 1, v + 1),
              (y = T + 1 - s))
            : ((f = h[T - 1]),
              (v = f - y - u),
              f > _ && x.MarkNextChange(),
              (_ = f),
              x.AddModifiedElement(f + 1, v + 1),
              (y = T - 1 - s)),
            k >= 0 &&
              ((h = this.m_reverseHistory[k]),
              (s = h[0]),
              (w = 1),
              (b = h.length - 1));
        } while (--k >= -1);
    ...
    ComputeRecursionPoint(t, r, n, i, s, o, l) {
      ...
      for (let y = 1; y <= v / 2 + 1; y++) {
        let _ = 0,
          k = 0;
        (h = this.ClipDiagonalBound(S - y, y, S, p)),
          (f = this.ClipDiagonalBound(S + y, y, S, p));
        for (let P = h; P <= f; P += 2) {
          P === h || (P < f && g[P - 1] < g[P + 1])
            ? (u = g[P + 1])
            : (u = g[P - 1] + 1),
          ...
          if (
            ((g[P] = u),
            u + c > _ + k && ((_ = u), (k = c)),
            !b && Math.abs(P - C) <= y - 1 && u >= A[P])
          )
            return (
              (s[0] = u),
              (o[0] = c),
              I <= A[P] && 1447 > 0 && y <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    h,
                    f,
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(_, T)
        )
          return (
            (l[0] = !0),
            (s[0] = _),
            ...
            T > 0 && 1447 > 0 && y <= 1447 + 1
              ...
              : (t++, n++, [new Fe(t, r - t + 1, n, i - n + 1)])
          );
        (d = this.ClipDiagonalBound(C - y, y, C, p)),
          (m = this.ClipDiagonalBound(C + y, y, C, p));
        for (let P = d; P <= m; P += 2) {
          P === d || (P < m && A[P - 1] >= A[P + 1])
            ? (u = A[P + 1] - 1)
            : (u = A[P - 1]),
            (c = u - (P - C) - x);
          const I = u;
          for (; u > t && c > n && this.ElementsAreEqual(u, c); ) u--, c--;
          if (((A[P] = u), b && Math.abs(P - S) <= y && u <= g[P]))
            return (
              (s[0] = u),
              (o[0] = c),
              I >= g[P] && 1447 > 0 && y <= 1447 + 1
                ? this.WALKTRACE(
                    S,
                    h,
                    f,
      ...
      for (let r = t.length - 1; r >= 0; r--) {
        ...
        for (let f = 1; ; f++) {
          ...
          if (
            d < i ||
            m < s ||
            (o && !this.OriginalElementsAreEqual(d, d + n.originalLength)) ||
            (l && !this.ModifiedElementsAreEqual(m, m + n.modifiedLength))
          )
            break;
          const p =
            (d === i && m === s ? 5 : 0) +
            this._boundaryScore(d, n.originalLength, m, n.modifiedLength);
          p > c && ((c = p), (u = f));
        }
          ...
          if (o < 5 && c < 20 && d < 20) {
            ...
            if (m) {
              ...
              (v !== i.originalStart + i.originalLength ||
                ...
                ((i.originalLength = v - i.originalStart),
    ...
    _boundaryScore(t, r, n, i) {
      const s = this._OriginalRegionIsBoundary(t, r) ? 1 : 0,
        o = this._ModifiedRegionIsBoundary(n, i) ? 1 : 0;
      return s + o;
    }
    ConcatenateChanges(t, r) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], r[0], n)) {
        ...
        return (
          Ke.Copy(t, 0, i, 0, t.length - 1),
          (i[t.length - 1] = n[0]),
          Ke.Copy(r, 1, i, t.length, r.length - 1),
          i
        );
      } else {
        const i = new Array(t.length + r.length);
        return (
          Ke.Copy(t, 0, i, 0, t.length), Ke.Copy(r, 0, i, t.length, r.length), i
        );
      }
    }
    ChangesOverlap(t, r, n) {
      if (
        (Ye.Assert(
          t.originalStart <= r.originalStart,
          "Left change is not less than or equal to right change"
        ),
        Ye.Assert(
          t.modifiedStart <= r.modifiedStart,
          "Left change is not less than or equal to right change"
        ),
        ...
        return (
          ...
          t.modifiedStart + t.modifiedLength >= r.modifiedStart &&
            (l = r.modifiedStart + r.modifiedLength - t.modifiedStart),
          (n[0] = new Fe(i, s, o, l)),
          !0
        );
  ...
  if (typeof ee.vscode < "u" && typeof ee.vscode.process < "u") {
    ...
    typeof process < "u"
      ...
      : (et = {
          get platform() {
            return ct ? "win32" : Fa ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function dn(e, t) {
    if (t === null || typeof t != "object")
      throw new hn("pathObject", "Object", t);
  ...
  const ae = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= -1; i--) {
          let s;
          if (i >= 0) {
            if (((s = e[i]), Z(s, "path"), s.length === 0)) continue;
          } else
            t.length === 0
              ? (s = cr())
              : ((s = cs[`=${t}`] || cr()),
          ...
          if (o === 1) j(h) && ((l = 1), (c = !0));
            ...
            if (((c = !0), j(s.charCodeAt(1)))) {
              let f = 2,
                d = f;
              for (; f < o && !j(s.charCodeAt(f)); ) f++;
              if (f < o && f !== d) {
                const m = s.slice(d, f);
                for (d = f; f < o && j(s.charCodeAt(f)); ) f++;
                if (f < o && f !== d) {
                  for (d = f; f < o && !j(s.charCodeAt(f)); ) f++;
                  (f === o || f !== d) &&
                    ((u = `\\\\${m}\\${s.slice(d, f)}`), (l = f));
      ...
      normalize(e) {
        ...
        if (t === 1) return fr(s) ? "\\" : e;
        if (j(s))
          if (((i = !0), j(e.charCodeAt(1)))) {
            let l = 2,
              u = l;
            for (; l < t && !j(e.charCodeAt(l)); ) l++;
            if (l < t && l !== u) {
              const c = e.slice(u, l);
              for (u = l; l < t && j(e.charCodeAt(l)); ) l++;
              if (l < t && l !== u) {
                for (u = l; l < t && !j(e.charCodeAt(l)); ) l++;
          ...
          Re(s) &&
            ...
            ((n = e.slice(0, 2)),
            (r = 2),
            t > 2 && j(e.charCodeAt(2)) && ((i = !0), (r = 3)));
        let o = r < t ? Ft(e.slice(r), !i, "\\", j) : "";
        return (
          o.length === 0 && !i && (o = "."),
          o.length > 0 && j(e.charCodeAt(t - 1)) && (o += "\\"),
      ...
      isAbsolute(e) {
        ...
        return (
          j(r) ||
          (t > 2 && Re(r) && e.charCodeAt(1) === De && j(e.charCodeAt(2)))
        );
      },
      join(...e) {
      ...
      relative(e, t) {
        ...
        const r = ae.resolve(e),
          n = ae.resolve(t);
        if (r === n || ((e = r.toLowerCase()), (t = n.toLowerCase()), e === t))
          return "";
        let i = 0;
        for (; i < e.length && e.charCodeAt(i) === se; ) i++;
        let s = e.length;
        for (; s - 1 > i && e.charCodeAt(s - 1) === se; ) s--;
        const o = s - i;
        let l = 0;
        for (; l < t.length && t.charCodeAt(l) === se; ) l++;
        let u = t.length;
        for (; u - 1 > l && t.charCodeAt(u - 1) === se; ) u--;
        const c = u - l,
          h = o < c ? o : c;
        let f = -1,
          d = 0;
        ...
        if (d !== h) {
          ...
          if (c > h) {
            if (t.charCodeAt(l + d) === se) return n.slice(l + d + 1);
            if (d === 2) return n.slice(l + d);
          }
          o > h && (e.charCodeAt(i + d) === se ? (f = d) : d === 2 && (f = 3)),
            f === -1 && (f = 0);
        }
        let m = "";
        for (d = i + f + 1; d <= s; ++d)
          (d === s || e.charCodeAt(d) === se) &&
            (m += m.length === 0 ? ".." : "\\..");
        return (
          (l += f),
          m.length > 0
            ? `${m}${n.slice(l, u)}`
            : (n.charCodeAt(l) === se && ++l, n.slice(l, u))
        );
      },
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === se) {
          if (t.charCodeAt(1) === se) {
            ...
            if (r !== gs && r !== Ie) return `\\\\?\\UNC\\${t.slice(2)}`;
          }
        } else if (
          Re(t.charCodeAt(0)) &&
          t.charCodeAt(1) === De &&
      ...
      dirname(e) {
        ...
        if (j(i)) {
          ...
          Re(i) &&
            e.charCodeAt(1) === De &&
            ((r = t > 2 && j(e.charCodeAt(2)) ? 3 : 2), (n = r));
        let s = -1,
          o = !0;
        for (let l = t - 1; l >= n; --l)
          if (j(e.charCodeAt(l))) {
      ...
      parse(e) {
        ...
        if (j(i)) {
          if (((n = 1), j(e.charCodeAt(1)))) {
            let f = 2,
              d = f;
            for (; f < r && !j(e.charCodeAt(f)); ) f++;
            if (f < r && f !== d) {
              for (d = f; f < r && j(e.charCodeAt(f)); ) f++;
              if (f < r && f !== d) {
                for (d = f; f < r && !j(e.charCodeAt(f)); ) f++;
                f === r ? (n = f) : f !== d && (n = f + 1);
              }
        ...
        } else if (Re(i) && e.charCodeAt(1) === De) {
    ...
    oe = {
      resolve(...e) {
        ...
        for (let n = e.length - 1; n >= -1 && !r; n--) {
          const i = n >= 0 ? e[n] : cr();
          Z(i, "path"),
            i.length !== 0 && ((t = `${i}/${t}`), (r = i.charCodeAt(0) === K));
        }
        return (t = Ft(t, !r, "/", fr)), r ? `/${t}` : t.length > 0 ? t : ".";
      },
      normalize(e) {
      ...
      relative(e, t) {
        if (
          (Z(e, "from"),
          Z(t, "to"),
          e === t || ((e = oe.resolve(e)), (t = oe.resolve(t)), e === t))
        )
          return "";
        const r = 1,
          n = e.length,
        ...
        if (c === l)
          if (o > l) {
            if (t.charCodeAt(s + c) === K) return t.slice(s + c + 1);
            if (c === 0) return t.slice(s + c);
          } else
            i > l && (e.charCodeAt(r + c) === K ? (u = c) : c === 0 && (u = 0));
        let h = "";
        for (c = r + u + 1; c <= n; ++c)
          (c === n || e.charCodeAt(c) === K) &&
            (h += h.length === 0 ? ".." : "/..");
  ...
  (oe.win32 = ae.win32 = ae),
    (oe.posix = ae.posix = oe),
    We === "win32" ? ae.normalize : oe.normalize,
    We === "win32" ? ae.resolve : oe.resolve,
    We === "win32" ? ae.relative : oe.relative,
    We === "win32" ? ae.dirname : oe.dirname,
    We === "win32" ? ae.basename : oe.basename,
    We === "win32" ? ae.extname : oe.extname,
    We === "win32" ? ae.sep : oe.sep;
  const ps = /^\w[\w\d+.-]*$/,
    vs = /^\//,
    bs = /^\/\//;
  function mn(e, t) {
  ...
  class He {
    ...
    with(t) {
      ...
      return (
        r === void 0 ? (r = this.scheme) : r === null && (r = G),
        n === void 0 ? (n = this.authority) : n === null && (n = G),
        i === void 0 ? (i = this.path) : i === null && (i = G),
        s === void 0 ? (s = this.query) : s === null && (s = G),
        o === void 0 ? (o = this.fragment) : o === null && (o = G),
        r === this.scheme &&
        n === this.authority &&
        i === this.path &&
        s === this.query &&
    ...
    static file(t) {
      let r = G;
      if ((ct && (t = t.replace(/\\/g, ve)), t[0] === ve && t[1] === ve)) {
        const n = t.indexOf(ve, 2);
        n === -1
          ? ((r = t.substring(2)), (t = ve))
          : ((r = t.substring(2, n)), (t = t.substring(n) || ve));
      }
      return new tt("file", r, t, G, G);
    }
    static from(t) {
      const r = new tt(t.scheme, t.authority, t.path, t.query, t.fragment);
      return mn(r, !0), r;
    }
    static joinPath(t, ...r) {
      if (!t.path)
      ...
      return (
        ct && t.scheme === "file"
          ? (n = He.file(ae.join(hr(t, !0), ...r)).path)
          : (n = oe.join(t.path, ...r)),
        t.with({ path: n })
      );
    }
      ...
      if (t) {
        if (t instanceof He) return t;
        {
          ...
          return (
            ...
            (r._fsPath = t._sep === gn ? t.fsPath : null),
            r
          );
        }
      } else return t;
  ...
  class tt extends He {
    ...
    toJSON() {
      const t = { $mid: 1 };
      return (
        this._fsPath && ((t.fsPath = this._fsPath), (t._sep = gn)),
  ...
  function vn(e, t) {
    ...
    for (let i = 0; i < e.length; i++) {
      ...
      if (
        ...
        n !== -1 && ((r += encodeURIComponent(e.substring(n, i))), (n = -1)),
    ...
    return (
      n !== -1 && (r += encodeURIComponent(e.substring(n))),
      r !== void 0 ? r : e
    );
  }
  function _s(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      const n = e.charCodeAt(r);
      n === 35 || n === 63
        ? (t === void 0 && (t = e.substr(0, r)), (t += pn[n]))
        : t !== void 0 && (t += e[r]);
    }
    return t !== void 0 ? t : e;
  }
  ...
  function dr(e, t) {
    ...
    if (
      ...
      (s = s.toLowerCase()),
        ...
        c === -1
          ? (n += r(s, !1))
          : ((n += r(s.substr(0, c), !1)), (n += s.substr(c)));
    }
    if (o) {
  ...
  function Vt(e) {
    return e.match(wn) ? e.replace(wn, t => bn(t)) : e;
  }
  class le {
    constructor(t, r) {
  ...
  class J {
    ...
    static intersectRanges(t, r) {
      ...
      return (
        ...
        s > c ? ((s = c), (o = h)) : s === c && (o = Math.min(o, h)),
        n > s || (n === s && i > o) ? null : new J(n, i, s, o)
      );
    }
    equalsRange(t) {
    ...
    static lift(t) {
      return t
        ? new J(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
        : null;
    }
    static isIRange(t) {
      return (
  ...
  const Ss = 3;
  function yn(e, t, r, n) {
    return new Ve(e, t, r).ComputeDiff(n);
  }
  class Cn {
    constructor(t) {
      const r = [],
    ...
    createCharSequence(t, r, n) {
      ...
      for (let u = r; u <= n; u++) {
        const c = this.lines[u],
          h = t ? this._startColumns[u] : 1,
          f = t ? this._endColumns[u] : c.length + 1;
        for (let d = h; d < f; d++)
          (i[l] = c.charCodeAt(d - 1)), (s[l] = u + 1), (o[l] = d), l++;
        !t &&
          u < n &&
          ((i[l] = 10), (s[l] = u + 1), (o[l] = c.length + 1), l++);
      }
      return new As(i, s, o);
    }
  }
  ...
  class ft {
    ...
    static createFromDiffChange(t, r, n) {
      const i = r.getStartLineNumber(t.originalStart),
        ...
        o = r.getEndLineNumber(t.originalStart + t.originalLength - 1),
        l = r.getEndColumn(t.originalStart + t.originalLength - 1),
        u = n.getStartLineNumber(t.modifiedStart),
        c = n.getStartColumn(t.modifiedStart),
        h = n.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1),
        f = n.getEndColumn(t.modifiedStart + t.modifiedLength - 1);
      return new ft(i, s, o, l, u, c, h, f);
    }
  }
  function Ns(e) {
    ...
    for (let n = 1, i = e.length; n < i; n++) {
      const s = e[n],
        o = s.originalStart - (r.originalStart + r.originalLength),
        l = s.modifiedStart - (r.modifiedStart + r.modifiedLength);
      Math.min(o, l) < Ss
        ? ((r.originalLength =
            s.originalStart + s.originalLength - r.originalStart),
          (r.modifiedLength =
            s.modifiedStart + s.modifiedLength - r.modifiedStart))
        : (t.push(s), (r = s));
    }
    return t;
  }
  class ht {
    ...
    static createFromDiffResult(t, r, n, i, s, o, l) {
      ...
      if (
        (r.originalLength === 0
          ? ((u = n.getStartLineNumber(r.originalStart) - 1), (c = 0))
          : ((u = n.getStartLineNumber(r.originalStart)),
            (c = n.getEndLineNumber(r.originalStart + r.originalLength - 1))),
        r.modifiedLength === 0
          ? ((h = i.getStartLineNumber(r.modifiedStart) - 1), (f = 0))
          : ((h = i.getStartLineNumber(r.modifiedStart)),
  ...
  class Ls {
    constructor(t, r, n) {
      (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
        ...
        (this.original = new Cn(t)),
        (this.modified = new Cn(r)),
        (this.continueLineDiff = _n(n.maxComputationTime)),
        (this.continueCharDiff = _n(
    ...
    computeDiff() {
      ...
      if (this.shouldIgnoreTrimWhitespace) {
        ...
        return { quitEarly: n, changes: l };
      }
      const i = [];
      let s = 0,
        o = 0;
      for (let l = -1, u = r.length; l < u; l++) {
        const c = l + 1 < u ? r[l + 1] : null,
          ...
          if (d !== m) {
            {
              let v = mr(d, 1),
                p = mr(m, 1);
              for (; v > 1 && p > 1; ) {
                const g = d.charCodeAt(v - 2),
                  A = m.charCodeAt(p - 2);
                if (g !== A) break;
                v--, p--;
              }
              (v > 1 || p > 1) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, 1, v, o + 1, 1, p);
            }
            {
              let v = gr(d, 1),
                p = gr(m, 1);
              const g = d.length + 1,
                A = m.length + 1;
              for (; v < g && p < A; ) {
                const S = d.charCodeAt(v - 1),
                  C = d.charCodeAt(p - 1);
                if (S !== C) break;
                v++, p++;
              }
              (v < g || p < A) &&
                this._pushTrimWhitespaceCharChange(i, s + 1, v, g, o + 1, p, A);
            }
          }
          s++, o++;
        }
    ...
    _pushTrimWhitespaceCharChange(t, r, n, i, s, o, l) {
      if (this._mergeTrimWhitespaceCharChange(t, r, n, i, s, o, l)) return;
      let u;
      this.shouldComputeCharChanges && (u = [new ft(r, n, r, i, s, o, s, l)]),
        t.push(new ht(r, r, s, s, u));
    }
    _mergeTrimWhitespaceCharChange(t, r, n, i, s, o, l) {
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ? !1
        : c.originalEndLineNumber + 1 === r && c.modifiedEndLineNumber + 1 === s
          ? ((c.originalEndLineNumber = r),
            (c.modifiedEndLineNumber = s),
            this.shouldComputeCharChanges &&
              c.charChanges &&
              c.charChanges.push(new ft(r, n, r, i, s, o, s, l)),
            !0)
          : !1;
    }
  }
  ...
  class ks {
    ...
    _getPrefixSum(t) {
      ...
      r === 0 && ((this.prefixSum[0] = this.values[0]), r++),
  ...
  class Ms {
      ...
      for (const n of r)
        this._acceptDeleteRange(n.range),
          this._acceptInsertText(
            new le(n.range.startLineNumber, n.range.startColumn),
            n.text
          );
    ...
    _acceptInsertText(t, r) {
      ...
      (n[n.length - 1] += this._lines[t.lineNumber - 1].substring(
        ...
        this._setLineText(
          t.lineNumber - 1,
          this._lines[t.lineNumber - 1].substring(0, t.column - 1) + n[0]
        );
  ...
  function Ts(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const r of Ps) e.indexOf(r) >= 0 || (t += "\\" + r);
  ...
  function pr(e, t, r, n, i) {
    if ((i || (i = kt.first(Ln)), r.length > i.maxLen)) {
      let c = e - i.maxLen / 2;
      return (
        c < 0 ? (c = 0) : (n += c),
        (r = r.substring(c, e + i.maxLen / 2)),
        pr(e, t, r, n, i)
      );
    }
    const s = Date.now(),
  ...
  class vr {
    constructor(t) {
      ...
      (this._defaultValue = r),
        (this._asciiMap = vr._createAsciiMap(r)),
        (this._map = new Map());
    }
    static _createAsciiMap(t) {
      const r = new Uint8Array(256);
      for (let n = 0; n < 256; n++) r[n] = t;
      return r;
    }
    set(t, r) {
      const n = An(r);
  ...
  function Rs() {
    if (dt === null) {
      dt = new vr(0);
      const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
      for (let r = 0; r < e.length; r++) dt.set(e.charCodeAt(r), 1);
      const t = ".,;:";
      for (let r = 0; r < t.length; r++) dt.set(t.charCodeAt(r), 2);
    }
    return dt;
  }
  class It {
      ...
      for (let s = 1, o = t.getLineCount(); s <= o; s++) {
        ...
        for (; c < u; ) {
          ...
          if (d === 13) {
            ...
            C === 1 && (i.push(It._createLink(n, l, s, h, c)), (A = !0));
          } else if (d === 12) {
            let C;
            S === 91 ? ((v = !0), (C = 0)) : (C = n.get(S)),
              C === 1 ? (A = !0) : (d = 13);
          } else (d = r.nextState(d, S)), d === 0 && (A = !0);
          A && ((d = 1), (m = !1), (v = !1), (g = !1), (h = c + 1), (f = S)),
            c++;
        }
  ...
  (function (e) {
    function t(r) {
      return r === e.None || r === e.Cancelled || r instanceof Rt
        ? !0
        : !r || typeof r != "object"
          ? !1
  ...
  class Us {
    ...
    cancel() {
      this._token
        ? this._token instanceof Rt && this._token.cancel()
    ...
    dispose(t = !1) {
      t && this.cancel(),
        ...
        this._token
          ? this._token instanceof Rt && this._token.dispose()
          : (this._token = Dt.None);
    }
  }
  class yr {
  ...
  (function () {
    ...
    for (const i of t) {
      ...
      if (
        (n[l] || ((n[l] = !0), (Bs[u] = l), (qs[u.toLowerCase()] = l)), !r[c])
      ) {
        if (((r[c] = !0), !h))
          throw new Error(
            `String representation missing for key code ${c} around scan code ${u}`
          );
        Ot.define(c, h), Cr.define(c, m || h), _r.define(c, v || m || h);
      }
      f && (js[f] = c);
    }
  })();
  ...
  class fe extends J {
    ...
    setEndPosition(t, r) {
      return this.getDirection() === 0
        ? new fe(this.startLineNumber, this.startColumn, t, r)
        : new fe(t, r, this.startLineNumber, this.startColumn);
    }
    getPosition() {
      return new le(this.positionLineNumber, this.positionColumn);
    }
    getSelectionStart() {
      return new le(this.selectionStartLineNumber, this.selectionStartColumn);
    }
    setStartPosition(t, r) {
      return this.getDirection() === 0
        ? new fe(t, r, this.endLineNumber, this.endColumn)
        : new fe(this.endLineNumber, this.endColumn, t, r);
    }
    static fromPositions(t, r = t) {
    ...
    static fromRange(t, r) {
      return r === 0
        ? new fe(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
        : new fe(
            t.endLineNumber,
            t.endColumn,
            t.startLineNumber,
    ...
    static selectionsArrEqual(t, r) {
      ...
      for (let n = 0, i = t.length; n < i; n++)
        if (!this.selectionsEqual(t[n], r[n])) return !1;
      return !0;
    }
  ...
  (a._allCodicons = []),
    ...
    (a.gitPullRequestAbandoned = new a("git-pull-request-abandoned", {
      fontCharacter: "\\ea64"
    })),
    ...
    (a.gitBranchCreate = new a("git-branch-create", {
      fontCharacter: "\\ea68"
    })),
    (a.gitBranchDelete = new a("git-branch-delete", {
      fontCharacter: "\\ea68"
    })),
    ...
    (a.debugBreakpoint = new a("debug-breakpoint", {
      fontCharacter: "\\ea71"
    })),
    (a.debugBreakpointDisabled = new a("debug-breakpoint-disabled", {
      fontCharacter: "\\ea71"
    })),
    (a.debugHint = new a("debug-hint", { fontCharacter: "\\ea71" })),
    (a.primitiveSquare = new a("primitive-square", {
      fontCharacter: "\\ea72"
    })),
    ...
    (a.desktopDownload = new a("desktop-download", {
      fontCharacter: "\\ea78"
    })),
    ...
    (a.kebabHorizontal = new a("kebab-horizontal", {
      fontCharacter: "\\ea7c"
    })),
    ...
    (a.organizationFilled = new a("organization-filled", {
      fontCharacter: "\\ea7e"
    })),
    (a.organizationOutline = new a("organization-outline", {
      fontCharacter: "\\ea7e"
    })),
    ...
    (a.fileDirectoryCreate = new a("file-directory-create", {
      fontCharacter: "\\ea80"
    })),
    ...
    (a.symbolNamespace = new a("symbol-namespace", {
      fontCharacter: "\\ea8b"
    })),
    ...
    (a.symbolConstructor = new a("symbol-constructor", {
      fontCharacter: "\\ea8c"
    })),
    ...
    (a.symbolStructure = new a("symbol-structure", {
      fontCharacter: "\\ea91"
    })),
    (a.symbolStruct = new a("symbol-struct", { fontCharacter: "\\ea91" })),
    (a.symbolParameter = new a("symbol-parameter", {
      fontCharacter: "\\ea92"
    })),
    (a.symbolTypeParameter = new a("symbol-type-parameter", {
      fontCharacter: "\\ea92"
    })),
    (a.symbolKey = new a("symbol-key", { fontCharacter: "\\ea93" })),
    (a.symbolText = new a("symbol-text", { fontCharacter: "\\ea93" })),
    (a.symbolReference = new a("symbol-reference", {
      fontCharacter: "\\ea94"
    })),
    ...
    (a.activateBreakpoints = new a("activate-breakpoints", {
      fontCharacter: "\\ea97"
    })),
    ...
    (a.arrowSmallRight = new a("arrow-small-right", {
      fontCharacter: "\\ea9f"
    })),
    ...
    (a.debugBreakpointConditionalUnverified = new a(
      "debug-breakpoint-conditional-unverified",
      { fontCharacter: "\\eaa6" }
    )),
    (a.debugBreakpointConditional = new a("debug-breakpoint-conditional", {
      fontCharacter: "\\eaa7"
    })),
    (a.debugBreakpointConditionalDisabled = new a(
      "debug-breakpoint-conditional-disabled",
      { fontCharacter: "\\eaa7" }
    )),
    (a.debugBreakpointDataUnverified = new a(
      "debug-breakpoint-data-unverified",
      { fontCharacter: "\\eaa8" }
    )),
    (a.debugBreakpointData = new a("debug-breakpoint-data", {
      fontCharacter: "\\eaa9"
    })),
    (a.debugBreakpointDataDisabled = new a("debug-breakpoint-data-disabled", {
      fontCharacter: "\\eaa9"
    })),
    (a.debugBreakpointLogUnverified = new a("debug-breakpoint-log-unverified", {
      fontCharacter: "\\eaaa"
    })),
    (a.debugBreakpointLog = new a("debug-breakpoint-log", {
      fontCharacter: "\\eaab"
    })),
    (a.debugBreakpointLogDisabled = new a("debug-breakpoint-log-disabled", {
      fontCharacter: "\\eaab"
    })),
    ...
    (a.debugBreakpointUnverified = new a("debug-breakpoint-unverified", {
      fontCharacter: "\\eabc"
    })),
    ...
    (a.commentDiscussion = new a("comment-discussion", {
      fontCharacter: "\\eac7"
    })),
    ...
    (a.debugDisconnect = new a("debug-disconnect", {
      fontCharacter: "\\ead0"
    })),
    ...
    (a.fileSymlinkDirectory = new a("file-symlink-directory", {
      fontCharacter: "\\eaed"
    })),
    (a.fileSymlinkFile = new a("file-symlink-file", {
      fontCharacter: "\\eaee"
    })),
    ...
    (a.lightbulbAutofix = new a("lightbulb-autofix", {
      fontCharacter: "\\eb13"
    })),
    ...
    (a.multipleWindows = new a("multiple-windows", {
      fontCharacter: "\\eb23"
    })),
    ...
    (a.rootFolderOpened = new a("root-folder-opened", {
      fontCharacter: "\\eb45"
    })),
    ...
    (a.splitHorizontal = new a("split-horizontal", {
      fontCharacter: "\\eb56"
    })),
    ...
    (a.wrenchSubaction = new a("wrench-subaction", {
      fontCharacter: "\\eb65"
    })),
    ...
    (a.debugBreakpointFunctionUnverified = new a(
      "debug-breakpoint-function-unverified",
      { fontCharacter: "\\eb87" }
    )),
    (a.debugBreakpointFunction = new a("debug-breakpoint-function", {
      fontCharacter: "\\eb88"
    })),
    (a.debugBreakpointFunctionDisabled = new a(
      "debug-breakpoint-function-disabled",
      { fontCharacter: "\\eb88" }
    )),
    (a.debugStackframeActive = new a("debug-stackframe-active", {
      fontCharacter: "\\eb89"
    })),
    (a.circleSmallFilled = new a("circle-small-filled", {
      fontCharacter: "\\eb8a"
    })),
    (a.debugStackframeDot = new a(
      "debug-stackframe-dot",
      a.circleSmallFilled.definition
    )),
    (a.debugStackframe = new a("debug-stackframe", {
      fontCharacter: "\\eb8b"
    })),
    (a.debugStackframeFocused = new a("debug-stackframe-focused", {
      fontCharacter: "\\eb8b"
    })),
    (a.debugBreakpointUnsupported = new a("debug-breakpoint-unsupported", {
      fontCharacter: "\\eb8c"
    })),
    (a.symbolString = new a("symbol-string", { fontCharacter: "\\eb8d" })),
    (a.debugReverseContinue = new a("debug-reverse-continue", {
      fontCharacter: "\\eb8e"
    })),
    (a.debugStepBack = new a("debug-step-back", { fontCharacter: "\\eb8f" })),
    (a.debugRestartFrame = new a("debug-restart-frame", {
      fontCharacter: "\\eb90"
    })),
    ...
    (a.groupByRefType = new a("group-by-ref-type", {
      fontCharacter: "\\eb97"
    })),
    (a.ungroupByRefType = new a("ungroup-by-ref-type", {
      fontCharacter: "\\eb98"
    })),
    ...
    (a.serverEnvironment = new a("server-environment", {
      fontCharacter: "\\eba3"
    })),
    ...
    (a.circleLargeFilled = new a("circle-large-filled", {
      fontCharacter: "\\ebb4"
    })),
    (a.circleLargeOutline = new a("circle-large-outline", {
      fontCharacter: "\\ebb5"
    })),
    ...
    (a.typeHierarchySub = new a("type-hierarchy-sub", {
      fontCharacter: "\\ebba"
    })),
    (a.typeHierarchySuper = new a("type-hierarchy-super", {
      fontCharacter: "\\ebbb"
    })),
    (a.gitPullRequestCreate = new a("git-pull-request-create", {
      fontCharacter: "\\ebbc"
    })),
    (a.runAbove = new a("run-above", { fontCharacter: "\\ebbd" })),
    (a.runBelow = new a("run-below", { fontCharacter: "\\ebbe" })),
    (a.notebookTemplate = new a("notebook-template", {
      fontCharacter: "\\ebbf"
    })),
    (a.debugRerun = new a("debug-rerun", { fontCharacter: "\\ebc0" })),
    (a.workspaceTrusted = new a("workspace-trusted", {
      fontCharacter: "\\ebc1"
    })),
    (a.workspaceUntrusted = new a("workspace-untrusted", {
      fontCharacter: "\\ebc2"
    })),
    (a.workspaceUnspecified = new a("workspace-unspecified", {
      fontCharacter: "\\ebc3"
    })),
    ...
    (a.terminalPowershell = new a("terminal-powershell", {
      fontCharacter: "\\ebc7"
    })),
    ...
    (a.debugLineByLine = new a("debug-line-by-line", {
      fontCharacter: "\\ebd0"
    })),
    ...
    (a.gitPullRequestClosed = new a("git-pull-request-closed", {
      fontCharacter: "\\ebda"
    })),
    (a.gitPullRequestDraft = new a("git-pull-request-draft", {
      fontCharacter: "\\ebdb"
    })),
    ...
    (a.debugContinueSmall = new a("debug-continue-small", {
      fontCharacter: "\\ebe0"
    })),
    ...
    (a.layoutActivitybarLeft = new a("layout-activitybar-left", {
      fontCharacter: "\\ebec"
    })),
    (a.layoutActivitybarRight = new a("layout-activitybar-right", {
      fontCharacter: "\\ebed"
    })),
    (a.layoutPanelLeft = new a("layout-panel-left", {
      fontCharacter: "\\ebee"
    })),
    (a.layoutPanelCenter = new a("layout-panel-center", {
      fontCharacter: "\\ebef"
    })),
    (a.layoutPanelJustify = new a("layout-panel-justify", {
      fontCharacter: "\\ebf0"
    })),
    (a.layoutPanelRight = new a("layout-panel-right", {
      fontCharacter: "\\ebf1"
    })),
    (a.layoutPanel = new a("layout-panel", { fontCharacter: "\\ebf2" })),
    (a.layoutSidebarLeft = new a("layout-sidebar-left", {
      fontCharacter: "\\ebf3"
    })),
    (a.layoutSidebarRight = new a("layout-sidebar-right", {
      fontCharacter: "\\ebf4"
    })),
    (a.layoutStatusbar = new a("layout-statusbar", {
      fontCharacter: "\\ebf5"
    })),
    (a.layoutMenubar = new a("layout-menubar", { fontCharacter: "\\ebf6" })),
    (a.layoutCentered = new a("layout-centered", { fontCharacter: "\\ebf7" })),
    (a.layoutSidebarRightOff = new a("layout-sidebar-right-off", {
      fontCharacter: "\\ec00"
    })),
    (a.layoutPanelOff = new a("layout-panel-off", { fontCharacter: "\\ec01" })),
    (a.layoutSidebarLeftOff = new a("layout-sidebar-left-off", {
      fontCharacter: "\\ec02"
    })),
    ...
    (a.arrowCircleDown = new a("arrow-circle-down", {
      fontCharacter: "\\ebfc"
    })),
    (a.arrowCircleLeft = new a("arrow-circle-left", {
      fontCharacter: "\\ebfd"
    })),
    (a.arrowCircleRight = new a("arrow-circle-right", {
      fontCharacter: "\\ebfe"
    })),
    ...
    (a.commentUnresolved = new a("comment-unresolved", {
      fontCharacter: "\\ec0a"
    })),
    (a.gitPullRequestGoToChanges = new a("git-pull-request-go-to-changes", {
      fontCharacter: "\\ec0b"
    })),
    (a.gitPullRequestNewChanges = new a("git-pull-request-new-changes", {
      fontCharacter: "\\ec0c"
    })),
    ...
    (a.treeItemExpanded = new a(
      "tree-item-expanded",
      a.chevronDown.definition
    )),
    (a.treeFilterOnTypeOn = new a(
      "tree-filter-on-type-on",
      a.listFilter.definition
    )),
    (a.treeFilterOnTypeOff = new a(
      "tree-filter-on-type-off",
      a.listSelection.definition
    )),
    ...
    (a.scrollbarButtonLeft = new a(
      "scrollbar-button-left",
      a.triangleLeft.definition
    )),
    (a.scrollbarButtonRight = new a(
      "scrollbar-button-right",
      a.triangleRight.definition
    )),
    (a.scrollbarButtonUp = new a(
      "scrollbar-button-up",
      a.triangleUp.definition
    )),
    (a.scrollbarButtonDown = new a(
      "scrollbar-button-down",
      a.triangleDown.definition
    )),
  ...
  (function (e) {
    ...
    function r(s) {
      if (s instanceof a) return ["codicon", "codicon-" + s.id];
      const o = t.exec(s.id);
      if (!o) return r(a.error);
      const [, l, u] = o,
        c = ["codicon", "codicon-" + l];
  ...
  (function (e) {
    const t = new Map();
    t.set(0, a.symbolMethod),
      t.set(1, a.symbolFunction),
      t.set(2, a.symbolConstructor),
      t.set(3, a.symbolField),
      t.set(4, a.symbolVariable),
      t.set(5, a.symbolClass),
      t.set(6, a.symbolStruct),
      t.set(7, a.symbolInterface),
      t.set(8, a.symbolModule),
      t.set(9, a.symbolProperty),
      t.set(10, a.symbolEvent),
      t.set(11, a.symbolOperator),
      t.set(12, a.symbolUnit),
      t.set(13, a.symbolValue),
      t.set(15, a.symbolEnum),
      t.set(14, a.symbolConstant),
      t.set(15, a.symbolEnum),
      t.set(16, a.symbolEnumMember),
      t.set(17, a.symbolKeyword),
      t.set(27, a.symbolSnippet),
      t.set(18, a.symbolText),
      t.set(19, a.symbolColor),
      t.set(20, a.symbolFile),
      t.set(21, a.symbolReference),
      t.set(22, a.symbolCustomColor),
      t.set(23, a.symbolFolder),
      t.set(24, a.symbolTypeParameter),
      t.set(25, a.account),
      t.set(26, a.issues);
    function r(s) {
      let o = t.get(s);
  ...
  (function (e) {
    const t = new Map();
    t.set(0, a.symbolFile),
      t.set(1, a.symbolModule),
      t.set(2, a.symbolNamespace),
      t.set(3, a.symbolPackage),
      t.set(4, a.symbolClass),
      t.set(5, a.symbolMethod),
      t.set(6, a.symbolProperty),
      t.set(7, a.symbolField),
      t.set(8, a.symbolConstructor),
      t.set(9, a.symbolEnum),
      t.set(10, a.symbolInterface),
      t.set(11, a.symbolFunction),
      t.set(12, a.symbolVariable),
      t.set(13, a.symbolConstant),
      t.set(14, a.symbolString),
      t.set(15, a.symbolNumber),
      t.set(16, a.symbolBoolean),
      t.set(17, a.symbolArray),
      t.set(18, a.symbolObject),
      t.set(19, a.symbolKey),
      t.set(20, a.symbolNull),
      t.set(21, a.symbolEnumMember),
      t.set(22, a.symbolStruct),
      t.set(23, a.symbolEvent),
      t.set(24, a.symbolOperator),
      t.set(25, a.symbolTypeParameter);
    function r(n) {
      let i = t.get(n);
      return (
        i ||
          (console.info("No codicon found for SymbolKind " + n),
          (i = a.symbolProperty)),
        i
      );
    }
  ...
  (function (e) {
    (e[(e.acceptSuggestionOnCommitCharacter = 0)] =
      ...
      (e[(e.unfoldOnClickAfterEndOfLine = 44)] = "unfoldOnClickAfterEndOfLine"),
      ...
      (e[(e.mouseWheelScrollSensitivity = 69)] = "mouseWheelScrollSensitivity"),
      (e[(e.mouseWheelZoom = 70)] = "mouseWheelZoom"),
      (e[(e.multiCursorMergeOverlapping = 71)] = "multiCursorMergeOverlapping"),
      ...
      (e[(e.renderValidationDecorations = 89)] = "renderValidationDecorations"),
      ...
      (e[(e.suggestOnTriggerCharacters = 111)] = "suggestOnTriggerCharacters"),
  ...
  (mt.CtrlCmd = 2048), (mt.Shift = 1024), (mt.Alt = 512), (mt.WinCtrl = 256);
  function Gs() {
    return {
      editor: void 0,
      languages: void 0,
  ...
  function Xs(e, t, r, n, i) {
    return Js(e, t, r, n, i) && Zs(e, t, r, n, i);
  }
  class Qs {
    constructor(t, r) {
    ...
    next(t) {
      ...
      do {
        if (
          this._prevMatchStartIndex + this._prevMatchLength === r ||
          ((n = this._searchRegex.exec(t)), !n)
        )
          return null;
        const i = n.index,
          s = n[0].length;
        if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            Qa(t, r, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || Xs(this._wordSeparators, t, r, i, s))
        )
          return n;
      } while (n);
      return null;
  ...
  class Ys {
    static computeUnicodeHighlights(t, r, n) {
      ...
      l === "allNonBasicAscii"
        ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (u = new RegExp(`${Ks(Array.from(l))}`, "g"));
      const c = new Qs(null, u),
        h = [];
      let f = !1,
        d,
        m = 0,
        v = 0,
        p = 0;
      e: for (let g = i, A = s; g <= A; g++) {
        const S = t.getLineContent(g),
          C = S.length;
        c.reset(0);
        do
          if (((d = c.next(S)), d)) {
            ...
            const w = S.substring(N, x),
              b = pr(N + 1, Nn, S, 0),
              y = o.shouldHighlightNonBasicASCII(w, b ? b.word : null);
            if (y !== 0) {
              y === 3 ? m++ : y === 2 ? v++ : y === 1 ? p++ : $a();
              const _ = 1e3;
              if (h.length >= _) {
      ...
      switch (n.shouldHighlightNonBasicASCII(t, null)) {
        ...
        case 3: {
          const s = t.codePointAt(0),
            o = n.ambiguousCharacters.getPrimaryConfusable(s),
            l = ge
              .getLocales()
              .filter(
                u =>
                  !ge
                    .getInstance(new Set([...r.allowedLocales, u]))
                    .isAmbiguous(s)
              );
          return {
            kind: 0,
  ...
  function Ks(e, t) {
    return `[${Ha(e.map(n => String.fromCodePoint(n)).join(""))}]`;
  }
  class yi {
    constructor(t) {
      (this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = ge.getInstance(new Set(t.allowedLocales)));
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return "allNonBasicAscii";
      const t = new Set();
      if (this.options.invisibleCharacters)
        for (const r of Ee.codePoints) Ci(String.fromCodePoint(r)) || t.add(r);
...
` ||
  ...
  class eo extends Ms {
    ...
    getWordAtPosition(t, r) {
      const n = pr(t.column, Es(r), this._lines[t.lineNumber - 1], 0);
      return n
        ? new J(t.lineNumber, n.startColumn, t.lineNumber, n.endColumn)
        : null;
    }
    words(t) {
      const r = this._lines,
    ...
    getValueInRange(t) {
      ...
      for (let o = n + 1; o < i; o++) s.push(this._lines[o]);
  ...
  class Ge {
    ...
    computeUnicodeHighlights(t, r, n) {
      return ze(this, void 0, void 0, function* () {
        ...
        return i
          ? Ys.computeUnicodeHighlights(i, r, n)
          : {
              ranges: [],
              hasMore: !1,
    ...
    computeDiff(t, r, n, i) {
      return ze(this, void 0, void 0, function* () {
        const s = this._getModel(t),
          o = this._getModel(r);
        return !s || !o ? null : Ge.computeDiff(s, o, n, i);
      });
    }
    static computeDiff(t, r, n, i) {
      const s = t.getLinesContent(),
        o = r.getLinesContent(),
        u = new Ls(s, o, {
        ...
        c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(t, r);
    ...
    computeMoreMinimalEdits(t, r) {
      return ze(this, void 0, void 0, function* () {
        ...
        for (let { range: o, text: l, eol: u } of r) {
          if ((typeof u == "number" && (s = u), J.isEmpty(o) && !l)) continue;
          const c = n.getValueInRange(o);
          if (((l = l.replace(/\r\n|\n|\r/g, n.eol)), c === l)) continue;
          if (Math.max(l.length, c.length) > Ge._diffLimit) {
            i.push({ range: o, text: l });
            continue;
          }
          const h = us(c, l, !1),
            f = n.offsetAt(J.lift(o).getStartPosition());
          for (const d of h) {
            const m = n.positionAt(f + d.originalStart),
              v = n.positionAt(f + d.originalStart + d.originalLength),
              p = {
        ...
        e: for (const u of t) {
          ...
          if (!!c) {
            for (const h of c.words(o))
              if (
                !(h === r || !isNaN(Number(h))) &&
                (l.add(h), l.size > Ge._suggestionsLimit)
              )
                break e;
          }
        }
    ...
    navigateValueSet(t, r, n, i, s) {
      return ze(this, void 0, void 0, function* () {
        ...
        return wr.INSTANCE.navigateValueSet(r, u, c, h, n);
      });
    }
    loadForeignModule(t, r, n) {
      const o = {
        host: qa(n, (l, u) => this._host.fhr(l, u)),
        getMirrorModels: () => this._getModels()
      };
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(o, r)),
          Promise.resolve(lr(this._foreignModule)))
    ...
    fmr(t, r) {
      ...
      try {
        return Promise.resolve(
          this._foreignModule[t].apply(this._foreignModule, r)
        );
      } catch (n) {
        return Promise.reject(n);
      }
  ...
  (Ge._diffLimit = 1e5),
    ...
    typeof importScripts == "function" && (ee.monaco = Gs());
  let xr = !1;
  function _i(e) {
    if (xr) return;
    xr = !0;
   ...
   *-----------------------------------------------------------------------------*/ function Mr(
    ...
    function d(C, N) {
      for (var x = 0, w = 0; x < C || !N; ) {
        ...
        if (b >= 48 && b <= 57) w = w * 16 + b - 48;
        else if (b >= 65 && b <= 70) w = w * 16 + b - 65 + 10;
        else if (b >= 97 && b <= 102) w = w * 16 + b - 97 + 10;
        else break;
        n++, x++;
      }
      return x < C && (w = -1), w;
    ...
    function v() {
      ...
      else for (n++; n < e.length && nt(e.charCodeAt(n)); ) n++;
      if (n < e.length && e.charCodeAt(n) === 46)
        if ((n++, n < e.length && nt(e.charCodeAt(n))))
          for (n++; n < e.length && nt(e.charCodeAt(n)); ) n++;
        else return (f = 3), e.substring(C, n);
      var N = n;
...
`;
    ...
    function g() {
      ...
      if (Pr(C)) {
        do n++, (i += String.fromCharCode(C)), (C = e.charCodeAt(n));
        while (Pr(C));
        return (o = 15);
      }
      if (gt(C))
...
`)),
      ...
      switch (C) {
        ...
        case 47:
          ...
          if (e.charCodeAt(n + 1) === 47) {
            for (n += 2; n < r && !gt(e.charCodeAt(n)); ) n++;
          ...
          if (e.charCodeAt(n + 1) === 42) {
            ...
            for (var x = r - 1, w = !1; n < x; ) {
              ...
              n++,
                gt(b) &&
                  (b === 13 && e.charCodeAt(n) === 10 && n++, l++, (c = n));
            }
        ...
        case 57:
          return (i += v()), (o = 11);
        default:
          for (; n < r && A(C); ) n++, (C = e.charCodeAt(n));
          if (s !== n) {
  ...
  function to(e, t, r) {
    var n, i, s, o, l;
    if (t) {
      for (o = t.offset, l = o + t.length, s = o; s > 0 && !Si(e, s - 1); ) s--;
      for (var u = l; u < e.length && !Si(e, u); ) u++;
      (i = e.substring(s, u)), (n = ro(i, r));
    } else (i = e), (n = 0), (s = 0), (o = 0), (l = e.length);
    var c = no(r, e),
      h = !1,
      f = 0,
      d;
    ...
    function g() {
      var P = m.scan();
      for (h = !1; P === 15 || P === 14; ) (h = h || P === 14), (P = m.scan());
    ...
    function S(P, I, B) {
      !v &&
        (!t || (I < l && B > o)) &&
        e.substring(I, B) !== P &&
        A.push({ offset: I, length: B - I, content: P });
    }
    var C = g();
    if (C !== 17) {
      var N = m.getTokenOffset() + s,
        x = Tr(d, n);
      S(x, s, N);
    }
    for (; C !== 17; ) {
      for (
        var w = m.getTokenOffset() + m.getTokenLength() + s,
          b = g(),
          y = "",
          _ = !1;
        !h && (b === 12 || b === 13);
        ...
        S(" ", w, k),
          (w = m.getTokenOffset() + m.getTokenLength() + s),
          (_ = b === 12),
          (y = _ ? p() : ""),
          (b = g());
      }
      if (b === 2) C !== 1 && (f--, (y = p()));
      else if (b === 4) C !== 3 && (f--, (y = p()));
      else {
        switch (C) {
          case 3:
          case 1:
...
`.indexOf(e.charAt(t)) !== -1
  ...
  function io(e, t, r) {
    t === void 0 && (t = []), r === void 0 && (r = Ut.DEFAULT);
    var n = null,
      i = [],
      s = [];
    function o(u) {
  ...
  function Er(e) {
    switch (e.type) {
      ...
      case "object":
        for (
          var t = Object.create(null), r = 0, n = e.children;
          r < n.length;
          r++
        ) {
          var i = n[r],
            s = i.children[1];
          s && (t[i.children[0].value] = Er(s));
        }
        return t;
      case "null":
      case "string":
  ...
  function so(e, t, r) {
    ...
    function w() {
      ...
      for (var _ = !1; n.getToken() !== 2 && n.getToken() !== 17; ) {
        if (n.getToken() === 5) {
          if ((_ || S(4, [], []), d(","), A(), n.getToken() === 2 && g)) break;
        } else _ && S(6, [], []);
        x() || S(4, [], [2, 5]), (_ = !0);
      }
    ...
    function b() {
      ...
      for (var _ = !1; n.getToken() !== 4 && n.getToken() !== 17; ) {
        if (n.getToken() === 5) {
          if ((_ || S(4, [], []), d(","), A(), n.getToken() === 4 && g)) break;
        } else _ && S(6, [], []);
        y() || S(4, [], [4, 5]), (_ = !0);
      }
  ...
  function pt(e, t) {
    ...
    if (Array.isArray(e)) {
      ...
      for (r = 0; r < e.length; r++) if (!pt(e[r], t[r])) return !1;
    } else {
      var i = [];
      for (n in e) i.push(n);
      i.sort();
      var s = [];
      for (n in t) s.push(n);
      if ((s.sort(), !pt(i, s))) return !1;
      for (r = 0; r < i.length; r++) if (!pt(e[i[r]], t[i[r]])) return !1;
    }
    return !0;
  }
  function he(e) {
  ...
  (function (e) {
    function t(n, i) {
      return (
        n === Number.MAX_VALUE && (n = Bt.MAX_VALUE),
        i === Number.MAX_VALUE && (i = Bt.MAX_VALUE),
        { line: n, character: i }
      );
    }
    e.create = t;
    function r(n) {
      var i = n;
      return (
        L.objectLiteral(i) && L.uinteger(i.line) && L.uinteger(i.character)
      );
    }
    e.is = r;
  })(be || (be = {}));
  ...
  (function (e) {
    function t(n, i, s, o) {
      ...
      if (be.is(n) && be.is(i)) return { start: n, end: i };
      throw new Error(
    ...
    function r(n) {
      var i = n;
      return L.objectLiteral(i) && be.is(i.start) && be.is(i.end);
    }
    e.is = r;
  })(W || (W = {}));
  var bt;
  (function (e) {
    ...
    function r(n) {
      var i = n;
      return (
        L.defined(i) && W.is(i.range) && (L.string(i.uri) || L.undefined(i.uri))
      );
    }
    e.is = r;
  })(bt || (bt = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        ...
        (W.is(i.targetSelectionRange) || L.undefined(i.targetSelectionRange)) &&
        (W.is(i.originSelectionRange) || L.undefined(i.originSelectionRange))
      );
    }
    e.is = r;
  })(ki || (ki = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      var i = n;
      return W.is(i.range) && Fr.is(i.color);
    }
    e.is = r;
  })(xi || (xi = {}));
  var Mi;
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.string(i.label) &&
        (L.undefined(i.textEdit) || we.is(i)) &&
        (L.undefined(i.additionalTextEdits) ||
          L.typedArray(i.additionalTextEdits, we.is))
      );
    }
    e.is = r;
  })(Mi || (Mi = {}));
  ...
  (function (e) {
    function t(n, i, s, o, l) {
      var u = { startLine: n, endLine: i };
      return (
        L.defined(s) && (u.startCharacter = s),
        L.defined(o) && (u.endCharacter = o),
        L.defined(l) && (u.kind = l),
        u
      );
    }
    e.create = t;
  ...
  (function (e) {
    function t(n, i, s, o, l, u) {
      ...
      return (
        L.defined(s) && (c.severity = s),
        L.defined(o) && (c.code = o),
        L.defined(l) && (c.source = l),
        L.defined(u) && (c.relatedInformation = u),
        c
      );
    }
    e.create = t;
    function r(n) {
      ...
      return (
        ...
        (L.undefined(s.relatedInformation) ||
          L.typedArray(s.relatedInformation, Vr.is))
      );
    }
    e.is = r;
  })(Me || (Me = {}));
  ...
  (function (e) {
    ...
    function i(s) {
      var o = s;
      return L.objectLiteral(o) && L.string(o.newText) && W.is(o.range);
    }
    e.is = i;
  })(we || (we = {}));
  var at;
  ...
  (function (e) {
    ...
    function i(s) {
      var o = s;
      return we.is(o) && (at.is(o.annotationId) || ne.is(o.annotationId));
    }
    e.is = i;
  })(Oe || (Oe = {}));
  var qt;
  (function (e) {
    ...
    function r(n) {
      var i = n;
      return L.defined(i) && Wt.is(i.textDocument) && Array.isArray(i.edits);
    }
    e.is = r;
  })(qt || (qt = {}));
  var Ct;
        ...
        (i.options === void 0 ||
          ((i.options.overwrite === void 0 || L.boolean(i.options.overwrite)) &&
            (i.options.ignoreIfExists === void 0 ||
              L.boolean(i.options.ignoreIfExists)))) &&
        (i.annotationId === void 0 || ne.is(i.annotationId))
      );
    }
    e.is = r;
  })(Ct || (Ct = {}));
  ...
  (function (e) {
    function t(n, i, s, o) {
      var l = { kind: "rename", oldUri: n, newUri: i };
      return (
        s !== void 0 &&
        ...
        (i.options === void 0 ||
          ((i.options.recursive === void 0 || L.boolean(i.options.recursive)) &&
            (i.options.ignoreIfNotExists === void 0 ||
              L.boolean(i.options.ignoreIfNotExists)))) &&
        (i.annotationId === void 0 || ne.is(i.annotationId))
      );
    }
    e.is = r;
      ...
      return (
        ...
        (n.documentChanges === void 0 ||
          n.documentChanges.every(function (i) {
            return L.string(i.kind)
              ? Ct.is(i) || _t.is(i) || St.is(i)
              : qt.is(i);
          }))
      );
    }
  ...
  (function () {
    ...
    return (
        ...
        if (Wt.is(t)) {
          ...
          if (!n) {
            ...
            this._workspaceEdit.documentChanges.push(s),
              (n = new $t(i, this._changeAnnotations)),
      ...
      (e.prototype.createFile = function (t, r, n) {
        ...
        var i;
        at.is(r) || ne.is(r) ? (i = r) : (n = r);
        var s, o;
        if (
          (i === void 0
            ? (s = Ct.create(t, n))
            : ((o = ne.is(i) ? i : this._changeAnnotations.manage(i)),
              (s = Ct.create(t, n, o))),
          this._workspaceEdit.documentChanges.push(s),
          o !== void 0)
        )
      ...
      (e.prototype.renameFile = function (t, r, n, i) {
        ...
        var s;
        at.is(n) || ne.is(n) ? (s = n) : (i = n);
        var o, l;
        if (
          (s === void 0
            ? (o = _t.create(t, r, i))
            : ((l = ne.is(s) ? s : this._changeAnnotations.manage(s)),
              (o = _t.create(t, r, i, l))),
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.defined(i) &&
        L.string(i.uri) &&
        (i.version === null || L.integer(i.version))
      );
    }
    e.is = r;
  })(Wt || (Wt = {}));
  ...
  (function (e) {
    function t(r) {
      var n = r;
      return L.objectLiteral(r) && Pe.is(n.kind) && L.string(n.value);
    }
    e.is = t;
  })(Dr || (Dr = {}));
  var me;
  ...
  (function (e) {
    ...
    function r(n) {
      var i = n;
      return i && L.string(i.newText) && W.is(i.insert) && W.is(i.replace);
    }
    e.is = r;
  })(Oi || (Oi = {}));
  var Ui;
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.string(i) ||
        (L.objectLiteral(i) && L.string(i.language) && L.string(i.value))
      );
    }
    e.is = r;
  })(Ht || (Ht = {}));
  ...
  (function (e) {
    function t(r) {
      ...
      return (
        ...
        (Dr.is(n.contents) ||
          Ht.is(n.contents) ||
          L.typedArray(n.contents, Ht.is)) &&
        (r.range === void 0 || W.is(r.range))
      );
    }
    e.is = t;
  })(Bi || (Bi = {}));
  ...
  (function (e) {
    function t(r, n) {
      ...
      var o = { label: r };
      return (
        L.defined(n) && (o.documentation = n),
        L.defined(i) ? (o.parameters = i) : (o.parameters = []),
        o
      );
    }
    e.create = t;
  ...
  (function (e) {
    function t(r, n, i, s, o) {
      var l = { name: r, kind: n, location: { uri: s, range: i } };
  ...
  (function (e) {
    function t(n, i, s, o, l, u) {
      var c = { name: n, detail: i, kind: s, range: o, selectionRange: l };
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.defined(i) &&
        L.typedArray(i.diagnostics, Me.is) &&
        (i.only === void 0 || L.typedArray(i.only, L.string))
      );
    }
    e.is = r;
  })(Xi || (Xi = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        i &&
        L.string(i.title) &&
        (i.diagnostics === void 0 || L.typedArray(i.diagnostics, Me.is)) &&
        (i.kind === void 0 || L.string(i.kind)) &&
        (i.edit !== void 0 || i.command !== void 0) &&
        (i.command === void 0 || yt.is(i.command)) &&
        (i.isPreferred === void 0 || L.boolean(i.isPreferred)) &&
        (i.edit === void 0 || Ir.is(i.edit))
      );
    }
    e.is = r;
  })(Qi || (Qi = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.defined(i) &&
        W.is(i.range) &&
        (L.undefined(i.command) || yt.is(i.command))
      );
    }
    e.is = r;
  })(Yi || (Yi = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      ...
      return (
        L.defined(i) &&
        W.is(i.range) &&
        (L.undefined(i.target) || L.string(i.target))
      );
    }
    e.is = r;
  })(ea || (ea = {}));
  ...
  (function (e) {
    ...
    function r(n) {
      var i = n;
      return (
        i !== void 0 && W.is(i.range) && (i.parent === void 0 || e.is(i.parent))
      );
    }
    e.is = r;
  })(zt || (zt = {}));
  ...
  (function (e) {
    ...
    function r(s) {
      ...
      return !!(
        L.defined(o) &&
        L.string(o.uri) &&
        (L.undefined(o.languageId) || L.string(o.languageId)) &&
        L.uinteger(o.lineCount) &&
        L.func(o.getText) &&
        L.func(o.positionAt) &&
        L.func(o.offsetAt)
      );
      ...
      for (
        var l = s.getText(),
          u = i(o, function (v, p) {
            ...
            return g === 0
              ? v.range.start.character - p.range.start.character
              : g;
          }),
          c = l.length,
          h = u.length - 1;
    ...
    function i(s, o) {
      ...
      for (; h < u.length; ) s[d++] = u[h++];
      for (; f < c.length; ) s[d++] = c[f++];
      return s;
    }
  })(ta || (ta = {}));
  var go = (function () {
...
` &&
      ...
      update(e, t) {
        for (let r of e)
          if (Gt.isIncremental(r)) {
            ...
            const o = Math.max(n.start.line, 0),
              l = Math.max(n.end.line, 0);
            let u = this._lineOffsets;
            const c = ra(r.text, !1, i);
            if (l - o === c.length)
              for (let f = 0, d = c.length; f < d; f++) u[f + o + 1] = c[f];
            else
              c.length < 1e4
                ? u.splice(o + 1, l - o, ...c)
                : (this._lineOffsets = u =
                    u.slice(0, o + 1).concat(c, u.slice(l + 1)));
  ...
  (function (e) {
    function t(i, s, o, l) {
      return new Gt(i, s, o, l);
    }
    e.create = t;
    function r(i, s, o) {
      if (i instanceof Gt) return i.update(s, o), i;
      throw new Error(
  ...
  var Je = (function () {
    ...
    wo = {
      ...
      hostname: {
        errorMessage: D("hostnameFormatWarning", "String is not a hostname."),
        pattern:
          /^(?=.{1,253}\.?$)[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?(?:\.[a-z0-9](?:[-0-9a-z]{0,61}[0-9a-z])?)*\.?$/i
      },
      ipv4: {
        errorMessage: D("ipv4FormatWarning", "String is not an IPv4 address."),
        pattern:
          /^(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)$/
      },
      ipv6: {
        errorMessage: D("ipv6FormatWarning", "String is not an IPv6 address."),
        pattern:
    ...
    _o = (function (e) {
      ...
      function t(r, n) {
        var i = e.call(this, r, n) || this;
        return (
          (i.type = "number"), (i.isInteger = !0), (i.value = Number.NaN), i
        );
      }
      return t;
    })(Ze),
  ...
  var No = (function () {
      ...
      return (
        ...
        (e.prototype.include = function (t) {
          return (
            (this.focusOffset === -1 || oa(t, this.focusOffset)) &&
            t !== this.exclude
          );
        }),
  ...
  var la = (function () {
    ...
    return (
      (e.prototype.getNodeFromOffset = function (t, r) {
        if ((r === void 0 && (r = !1), this.root)) return lo(this.root, t, r);
      }),
        ...
        if (this.root) {
          var r = function (n) {
            var i = t(n),
              s = n.children;
            if (Array.isArray(s))
              for (var o = 0; o < s.length && i; o++) i = r(s[o]);
            return i;
          };
          r(this.root);
        }
      ...
      (e.prototype.validate = function (t, r, n) {
        if ((n === void 0 && (n = de.Warning), this.root && r)) {
          var i = new ce();
          return (
            re(this.root, r, i, Br.instance),
            i.problems.map(function (s) {
              var o,
                l = W.create(
                  t.positionAt(s.location.offset),
                  t.positionAt(s.location.offset + s.location.length)
                );
              return Me.create(
                l,
                s.message,
                (o = s.severity) !== null && o !== void 0 ? o : n,
                s.code
              );
            })
          );
      ...
      (e.prototype.getMatchingSchemas = function (t, r, n) {
        r === void 0 && (r = -1);
        var i = new No(r, n);
        return this.root && t && re(this.root, t, new ce(), i), i.schemas;
      }),
      e
    );
  })();
  function re(e, t, r, n) {
    ...
    function s() {
      function h(I) {
        return (
          i.type === I ||
          (I === "integer" && i.type === "number" && i.isInteger)
        );
      }
      if (
      ...
      var N = function (I, B) {
        for (var Y = [], H = void 0, E = 0, M = I; E < M.length; E++) {
          var F = M[E],
            V = ue(F),
            R = new ce(),
            U = n.newSub();
          if ((re(i, V, R, U), R.hasProblems() || Y.push(V), !H))
            H = { schema: V, validationResult: R, matchingSchemas: U };
          else if (!B && !R.hasProblems() && !H.validationResult.hasProblems())
            H.matchingSchemas.merge(U),
              (H.validationResult.propertiesMatches += R.propertiesMatches),
              (H.validationResult.propertiesValueMatches +=
                R.propertiesValueMatches);
          else {
            var $ = R.compare(H.validationResult);
            $ > 0
              ? (H = { schema: V, validationResult: R, matchingSchemas: U })
              : $ === 0 &&
                (H.matchingSchemas.merge(U),
                H.validationResult.mergeEnumValues(R));
          }
        }
        return (
          Y.length > 1 &&
          ...
          H &&
            (r.merge(H.validationResult),
            (r.propertiesMatches += H.validationResult.propertiesMatches),
            (r.propertiesValueMatches +=
              H.validationResult.propertiesValueMatches),
            n.merge(H.matchingSchemas)),
          Y.length
        );
      };
      Array.isArray(t.anyOf) && N(t.anyOf, !1),
        Array.isArray(t.oneOf) && N(t.oneOf, !0);
      var x = function (I) {
          var B = new ce(),
            Y = n.newSub();
          re(i, ue(I), B, Y),
            r.merge(B),
            (r.propertiesMatches += B.propertiesMatches),
            (r.propertiesValueMatches += B.propertiesValueMatches),
            n.merge(Y);
        },
        w = function (I, B, Y) {
          var H = ue(I),
            E = new ce(),
            M = n.newSub();
          re(i, H, E, M), n.merge(M), E.hasProblems() ? Y && x(Y) : B && x(B);
        },
        b = ue(t.if);
      if ((b && w(b, ue(t.then), ue(t.else)), Array.isArray(t.enum))) {
        for (var y = Xe(i), _ = !1, k = 0, T = t.enum; k < T.length; k++) {
          var P = T[k];
          if (pt(y, P)) {
            _ = !0;
            break;
      ...
      if (xe(t.const)) {
        ...
        pt(y, t.const)
          ...
          : (r.problems.push({
              ...
              message:
                t.errorMessage ||
                D("constWarning", "Value must be {0}.", JSON.stringify(t.const))
            }),
            (r.enumValueMatch = !1)),
    ...
    function o(h, f, d, m) {
      ...
      function p(k) {
        var T,
          P = /^(-?\d+)(?:\.(\d+))?(?:e([-+]\d+))?$/.exec(k.toString());
        return (
          P && {
            value: Number(P[1] + (P[2] || "")),
            multiplier:
              (((T = P[2]) === null || T === void 0 ? void 0 : T.length) || 0) -
              (parseInt(P[3]) || 0)
          }
        );
      }
      if (he(f.multipleOf)) {
        var g = -1;
        if (Number.isInteger(f.multipleOf)) g = v % f.multipleOf;
        else {
          var A = p(f.multipleOf),
            S = p(v);
          if (A && S) {
            var C = Math.pow(10, Math.abs(S.multiplier - A.multiplier));
            S.multiplier < A.multiplier ? (S.value *= C) : (A.value *= C),
              (g = S.value % A.value);
          }
        }
        g !== 0 &&
      ...
      he(y) &&
        ...
        d.problems.push({
          location: { offset: h.offset, length: h.length },
          message: D("minimumWarning", "Value is below the minimum of {0}.", y)
        });
      ...
      he(_) &&
        ...
        d.problems.push({
          location: { offset: h.offset, length: h.length },
          message: D("maximumWarning", "Value is above the maximum of {0}.", _)
        });
    }
    function l(h, f, d, m) {
      if (
        (he(f.minLength) &&
          h.value.length < f.minLength &&
          d.problems.push({
            location: { offset: h.offset, length: h.length },
            message: D(
              "minLengthWarning",
      ...
      if (f.format)
        switch (f.format) {
          ...
          case "uri-reference":
            {
              var p = void 0;
              if (!h.value) p = D("uriEmpty", "URI expected.");
              else {
                var g =
                  /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(
                    h.value
                ...
                g
                  ...
                  : (p = D("uriMissing", "URI is expected."));
              }
              p &&
                d.problems.push({
                  location: { offset: h.offset, length: h.length },
                  message:
                    f.patternErrorMessage ||
                    f.errorMessage ||
                    D("uriFormatWarning", "String is not a URI: {0}", p)
                });
            }
            break;
          case "color-hex":
          ...
          case "ipv6":
            var A = wo[f.format];
            (!h.value || !A.pattern.exec(h.value)) &&
              d.problems.push({
                location: { offset: h.offset, length: h.length },
                message:
                  f.patternErrorMessage || f.errorMessage || A.errorMessage
              });
        }
    }
    function u(h, f, d, m) {
      if (Array.isArray(f.items)) {
        for (var v = f.items, p = 0; p < v.length; p++) {
          var g = v[p],
            ...
            C = h.items[p];
          C
            ? (re(C, A, S, m), d.mergePropertyMatch(S))
            : h.items.length >= v.length && d.propertiesValueMatches++;
        }
        if (h.items.length > v.length)
          if (typeof f.additionalItems == "object")
            for (var N = v.length; N < h.items.length; N++) {
              var S = new ce();
              re(h.items[N], f.additionalItems, S, m), d.mergePropertyMatch(S);
            }
          else
            f.additionalItems === !1 &&
              d.problems.push({
        ...
        if (x)
          for (var w = 0, b = h.items; w < b.length; w++) {
            var C = b[w],
              S = new ce();
            re(C, x, S, m), d.mergePropertyMatch(S);
          }
      }
      var y = ue(f.contains);
      if (y) {
        var _ = h.items.some(function (P) {
          var I = new ce();
          return re(P, y, I, Br.instance), !I.hasProblems();
        });
        _ ||
          d.problems.push({
            location: { offset: h.offset, length: h.length },
    ...
    function c(h, f, d, m) {
      for (
        var v = Object.create(null), p = [], g = 0, A = h.properties;
        g < A.length;
        g++
      ) {
        var S = A[g],
      ...
      if (Array.isArray(f.required))
        for (var N = 0, x = f.required; N < x.length; N++) {
          ...
          if (!v[w]) {
            var b =
                h.parent && h.parent.type === "property" && h.parent.keyNode,
              y = b
                ? { offset: b.offset, length: b.length }
                : { offset: h.offset, length: 1 };
            d.problems.push({
              location: y,
              message: D(
      ...
      var _ = function (Ca) {
        for (var Yr = p.indexOf(Ca); Yr >= 0; )
          p.splice(Yr, 1), (Yr = p.indexOf(Ca));
      };
      if (f.properties)
        for (var k = 0, T = Object.keys(f.properties); k < T.length; k++) {
          var w = T[k];
          _(w);
          var P = f.properties[w],
            I = v[w];
          if (I)
            if (_e(P))
              if (P) d.propertiesMatches++, d.propertiesValueMatches++;
              else {
                var S = I.parent;
                d.problems.push({
                  location: {
              ...
              var B = new ce();
              re(I, P, B, m), d.mergePropertyMatch(B);
            }
        }
      if (f.patternProperties)
        for (var Y = 0, H = Object.keys(f.patternProperties); Y < H.length; Y++)
          for (
            var E = H[Y], M = jt(E), F = 0, V = p.slice(0);
            F < V.length;
            F++
          ) {
            var w = V[F];
      ...
      if (typeof f.additionalProperties == "object")
        for (var R = 0, U = p; R < U.length; R++) {
          ...
          if (I) {
            var B = new ce();
            re(I, f.additionalProperties, B, m), d.mergePropertyMatch(B);
          }
        }
      else if (f.additionalProperties === !1 && p.length > 0)
        for (var $ = 0, Ne = p; $ < Ne.length; $++) {
          var w = Ne[$],
            I = v[w];
          if (I) {
            var S = I.parent;
      ...
      if (
        ...
        he(f.minProperties) &&
          h.properties.length < f.minProperties &&
          d.problems.push({
            location: { offset: h.offset, length: h.length },
            message: D(
              "MinPropWarning",
        ...
        for (
          var ie = 0, pe = Object.keys(f.dependencies);
          ie < pe.length;
          ie++
        ) {
          var C = pe[ie],
            lt = v[C];
          if (lt) {
            var Le = f.dependencies[C];
            if (Array.isArray(Le))
              for (var Xr = 0, va = Le; Xr < va.length; Xr++) {
                var ba = va[Xr];
                v[ba]
              ...
              if (P) {
                var B = new ce();
                re(h, P, B, m), d.mergePropertyMatch(B);
              }
            }
          }
        }
      var wa = ue(f.propertyNames);
      if (wa)
        for (var Qr = 0, ya = h.properties; Qr < ya.length; Qr++) {
          var ol = ya[Qr],
            C = ol.keyNode;
          C && re(C, wa, d, Br.instance);
        }
    }
  }
  function ko(e, t) {
    ...
    function u(w, b, y, _, k) {
      if ((k === void 0 && (k = de.Error), r.length === 0 || y !== n)) {
        var T = W.create(e.positionAt(y), e.positionAt(_));
        r.push(Me.create(T, w, k, b, e.languageId)), (n = y);
      }
    }
    ...
    function h() {
      switch (s.getTokenError()) {
        case 4:
          return (
            c(
              D("InvalidUnicode", "Invalid unicode sequence in string."),
              q.InvalidUnicode
            ),
            !0
          );
        ...
        case 3:
          return (
            c(
              D("UnexpectedEndOfNumber", "Unexpected end of number."),
              q.UnexpectedEndOfNumber
            ),
            !0
          );
        case 1:
          return (
            c(
              D("UnexpectedEndOfComment", "Unexpected end of comment."),
              q.UnexpectedEndOfComment
            ),
            !0
          );
        case 2:
          return (
            c(
              D("UnexpectedEndOfString", "Unexpected end of string."),
              q.UnexpectedEndOfString
            ),
            !0
          );
        case 6:
    ...
    function f(w, b) {
      return (
        (w.length = s.getTokenOffset() + s.getTokenLength() - w.offset),
        b && l(),
        w
      );
    }
    function d(w) {
      if (s.getToken() === 3) {
        var b = new Co(w, s.getTokenOffset());
        l();
        for (var y = !1; s.getToken() !== 4 && s.getToken() !== 17; ) {
          if (s.getToken() === 5) {
            y || c(D("ValueExpected", "Value expected"), q.ValueExpected);
            var _ = s.getTokenOffset();
            if ((l(), s.getToken() === 4)) {
              y &&
                u(
                  D("TrailingComma", "Trailing comma"),
                  q.TrailingComma,
                  _,
                  _ + 1
                );
          ...
          } else y && c(D("ExpectedComma", "Expected comma"), q.CommaExpected);
          var k = C(b);
          k
            ? b.items.push(k)
            : c(
                D("PropertyExpected", "Value expected"),
                q.ValueExpected,
                void 0,
                [],
                [4, 5]
        ...
        return s.getToken() !== 4
          ? c(
              D("ExpectedCloseBracket", "Expected comma or closing bracket"),
              q.CommaOrCloseBacketExpected,
              b
            )
          : f(b, !0);
      }
    }
    var m = new jr(void 0, 0, 0);
    function v(w, b) {
      var y = new So(w, s.getTokenOffset(), m),
        _ = g(y);
      if (!_)
        if (s.getToken() === 16) {
          c(
            D("DoubleQuotesExpected", "Property keys must be doublequoted"),
            q.Undefined
          );
          var k = new jr(y, s.getTokenOffset(), s.getTokenLength());
      ...
      if (
        (T
          ? (u(
              D("DuplicateKeyWarning", "Duplicate object key"),
              q.DuplicateKey,
              y.keyNode.offset,
              y.keyNode.offset + y.keyNode.length,
              de.Warning
            ),
            typeof T == "object" &&
              u(
        ...
        (c(D("ColonExpected", "Colon expected"), q.ColonExpected),
        s.getToken() === 10 &&
          e.positionAt(_.offset + _.length).line <
            e.positionAt(s.getTokenOffset()).line)
      )
        return (y.length = _.length), y;
      var P = C(y);
      return P
        ? ((y.valueNode = P), (y.length = P.offset + P.length - y.offset), y)
        : c(
            D("ValueExpected", "Value expected"),
            q.ValueExpected,
            y,
            [],
            [2, 5]
    ...
    function p(w) {
      if (s.getToken() === 1) {
        var b = new Ao(w, s.getTokenOffset()),
          y = Object.create(null);
        l();
        for (var _ = !1; s.getToken() !== 2 && s.getToken() !== 17; ) {
          if (s.getToken() === 5) {
            _ ||
              c(D("PropertyExpected", "Property expected"), q.PropertyExpected);
          ...
          } else _ && c(D("ExpectedComma", "Expected comma"), q.CommaExpected);
          var T = v(b, y);
          T
            ? b.properties.push(T)
            : c(
                D("PropertyExpected", "Property expected"),
                q.PropertyExpected,
                void 0,
                [],
                [2, 5]
        ...
        return s.getToken() !== 2
          ? c(
              D("ExpectedCloseBrace", "Expected comma or closing brace"),
              q.CommaOrCloseBraceExpected,
              b
            )
          : f(b, !0);
      }
    ...
    function g(w) {
      if (s.getToken() === 10) {
        var b = new jr(w, s.getTokenOffset());
        return (b.value = s.getTokenValue()), f(b, !0);
      }
    }
    function A(w) {
      if (s.getToken() === 11) {
        var b = new _o(w, s.getTokenOffset());
    ...
    function S(w) {
      switch (s.getToken()) {
        case 7:
          return f(new yo(w, s.getTokenOffset()), !0);
        case 8:
          return f(new aa(w, !0, s.getTokenOffset()), !0);
        case 9:
          return f(new aa(w, !1, s.getTokenOffset()), !0);
        default:
          return;
      }
    }
    ...
    return (
      x !== 17 &&
        ...
        N
          ? s.getToken() !== 17 &&
            c(D("End of file expected", "End of file expected."), q.Undefined)
          : c(
              D("Invalid symbol", "Expected a JSON object, array or literal."),
              q.Undefined
            )),
      new la(N, r, o)
    );
...
`,
          ...
          var l = o[s];
          (i += n + JSON.stringify(l) + ": " + $r(e[l], n, r)),
            s < o.length - 1 && (i += ","),
            (i += `
`);
        }
      ...
      return (
        ...
        (e.prototype.doComplete = function (t, r, n) {
          ...
          if (
            ...
            f = W.create(
              t.positionAt(u.offset),
              t.positionAt(u.offset + u.length)
            );
          else {
            var d = l - h.length;
            d > 0 && o[d - 1] === '"' && d--,
              (f = W.create(t.positionAt(d), r));
          }
          var m = {},
            v = {
              add: function (p) {
                var g = p.label,
                  A = m[g];
                if (A)
                  A.documentation || (A.documentation = p.documentation),
                    A.detail || (A.detail = p.detail);
                else {
                  if (((g = g.replace(/[\n]/g, "\u21B5")), g.length > 60)) {
                  ...
                  f &&
                    p.insertText !== void 0 &&
                    (p.textEdit = we.replace(f, p.insertText)),
                    (p.label = g),
                    (m[g] = p),
                    s.items.push(p);
                }
            ...
            .then(function (p) {
              ...
              if (u && u.type === "string") {
                ...
                N &&
                  ...
                  ((A = !N.valueNode),
                  (C = N),
                  (S = o.substr(u.offset + 1, u.length - 2)),
                  N && (u = N.parent));
              }
              if (u && u.type === "object") {
                if (u.offset === l) return s;
                var x = u.properties;
                x.forEach(function (_) {
                  (!C || C !== _) && (m[_.keyNode.value] = Rr.create("__"));
                });
                var w = "";
                A && (w = i.evaluateSeparatorAfter(t, t.offsetAt(f.end))),
                  p
                    ? i.getPropertyCompletions(p, n, u, A, w, v)
                    : i.getSchemaLessPropertyCompletions(n, u, S, v);
                var b = qr(u);
                i.contributions.forEach(function (_) {
                  var k = _.collectPropertyCompletions(
                    t.uri,
                    b,
                    h,
                    A,
              ...
              return (
                p
                  ? i.getValueCompletions(p, n, u, l, t, v, y)
                  : i.getSchemaLessValueCompletions(n, u, l, t, v),
                i.contributions.length > 0 &&
                  i.getContributedValueCompletions(n, u, l, t, v, g),
                i.promiseConstructor.all(g).then(function () {
                ...
                Object.keys(h).forEach(function (p) {
                  ...
                  if (
                    ...
                    var A = {
                      ...
                      documentation:
                        l.fromMarkup(g.markdownDescription) ||
                        g.description ||
                        ""
                    };
                    g.suggestSortText !== void 0 &&
                      (A.sortText = g.suggestSortText),
                      A.insertText &&
                        vt(A.insertText, "$1".concat(s)) &&
                        (A.command = {
                          title: "Suggest",
              ...
              if (
                ...
                var d = function (p, g) {
                  ...
                  var A = {
                    ...
                    documentation:
                      g ||
                      l.fromMarkup(f.markdownDescription) ||
                      f.description ||
                      ""
                  };
                  f.suggestSortText !== void 0 &&
                    (A.sortText = f.suggestSortText),
                    A.insertText &&
                      vt(A.insertText, "$1".concat(s)) &&
                      (A.command = {
                        title: "Suggest",
                ...
                if (f.enum)
                  for (var m = 0; m < f.enum.length; m++) {
                    var v = void 0;
                    f.markdownEnumDescriptions &&
                    m < f.markdownEnumDescriptions.length
                      ? (v = l.fromMarkup(f.markdownEnumDescriptions[m]))
                      : f.enumDescriptions &&
                        m < f.enumDescriptions.length &&
                        (v = f.enumDescriptions[m]),
                      d(f.enum[m], v);
                  }
                f.const && d(f.const);
              }
        ...
        (e.prototype.getSchemaLessPropertyCompletions = function (t, r, n, i) {
          ...
          if (r.parent)
            if (r.parent.type === "property") {
              ...
              r.parent.type === "array" &&
                r.parent.items.forEach(function (u) {
        ...
        (e.prototype.getSchemaLessValueCompletions = function (t, r, n, i, s) {
          ...
          var u = this.evaluateSeparatorAfter(i, l),
            c = function (m) {
              m.parent &&
                !oa(m.parent, n, !0) &&
                s.add({
                ...
                m.type === "boolean" &&
                  o.addBooleanValueCompletion(!m.value, u, s);
            };
          if (r.type === "property" && n > (r.colonOffset || 0)) {
            ...
            t.visit(function (m) {
              ...
              f === "$schema" &&
                r.parent &&
                !r.parent.parent &&
                this.addDollarSchemaCompletions(u, s);
          }
          if (r.type === "array")
              ...
              t.visit(function (m) {
                return (
                  m.type === "property" &&
                    m.keyNode.value === d &&
                    m.valueNode &&
                    m.valueNode.type === "array" &&
                    m.valueNode.items.forEach(c),
                  !0
                );
              });
            } else r.items.forEach(c);
        }),
        (e.prototype.getValueCompletions = function (t, r, n, i, s, o, l) {
          ...
          if (
            (n &&
              (n.type === "string" ||
                ...
                n.type === "boolean" ||
                n.type === "null") &&
              ((u = n.offset + n.length), (h = n), (n = n.parent)),
            !n)
          ) {
          ...
          if (n && (c !== void 0 || n.type === "array")) {
            for (
              var d = this.evaluateSeparatorAfter(s, u),
                m = r.getMatchingSchemas(t.schema, n.offset, h),
                v = 0,
                p = m;
              v < p.length;
              v++
              ...
              if (g.node === n && !g.inverted && g.schema) {
                ...
                if (c !== void 0) {
                  ...
                  if (g.schema.patternProperties && !S)
                    for (
                      var N = 0, x = Object.keys(g.schema.patternProperties);
                      N < x.length;
                      N++
                    ) {
                      var w = x[N],
            ...
            c === "$schema" &&
              ...
              l.boolean &&
                (this.addBooleanValueCompletion(!0, d, o),
                this.addBooleanValueCompletion(!1, d, o)),
              l.null && this.addNullValueCompletion(d, o);
          }
        }),
        ...
        (e.prototype.addDefaultValueCompletions = function (t, r, n, i) {
          ...
          if (xe(t.default)) {
            ...
            n.add({
              ...
              insertTextFormat: Q.Snippet,
              detail: Wr("json.suggest.default", "Default value")
            }),
              (o = !0);
          }
          Array.isArray(t.examples) &&
            t.examples.forEach(function (h) {
            ...
            Array.isArray(t.defaultSnippets) &&
              t.defaultSnippets.forEach(function (h) {
                var f = t.type,
                  d = h.body,
                  m = h.label,
                  v,
                ...
                if (xe(d)) {
                  t.type;
                  for (var g = i; g > 0; g--) d = [d];
                  (v = s.getInsertTextForSnippetValue(d, r)),
                    (p = s.getFilterTextForSnippetValue(d)),
                    (m = m || s.getLabelForSnippetValue(d));
...
` + C
                ...
                n.add({
                  ...
                  label: m,
                  documentation:
                    s.fromMarkup(h.markdownDescription) || h.description,
                  insertText: v,
                  insertTextFormat: Q.Snippet,
                  filterText: p
                }),
        ...
        (e.prototype.addEnumValueCompletions = function (t, r, n) {
          if (
            ...
            for (var i = 0, s = t.enum.length; i < s; i++) {
              var o = t.enum[i],
                l = this.fromMarkup(t.markdownDescription) || t.description;
              t.markdownEnumDescriptions &&
              i < t.markdownEnumDescriptions.length &&
              this.doesSupportMarkdown()
                ? (l = this.fromMarkup(t.markdownEnumDescriptions[i]))
                : t.enumDescriptions &&
                  i < t.enumDescriptions.length &&
                  (l = t.enumDescriptions[i]),
                n.add({
                  kind: this.getSuggestionKind(t.type),
        ...
        (e.prototype.collectTypes = function (t, r) {
          if (!(Array.isArray(t.enum) || xe(t.const))) {
            var n = t.type;
            Array.isArray(n)
        ...
        (e.prototype.addFillerValueCompletions = function (t, r, n) {
          t.object &&
            n.add({
              ...
              insertTextFormat: Q.Snippet,
              detail: Wr("defaults.object", "New object"),
              documentation: ""
            }),
            t.array &&
              n.add({
                ...
                insertText: this.getInsertTextForGuessedValue([], r),
                insertTextFormat: Q.Snippet,
                detail: Wr("defaults.array", "New array"),
                documentation: ""
              });
        }),
          ...
          if (r) {
            if (Array.isArray(r.defaultSnippets)) {
              if (r.defaultSnippets.length === 1) {
                ...
                xe(c) && (l = this.getInsertTextForSnippetValue(c, ""));
              }
            ...
            if (
              (r.enum &&
                (!l &&
                  r.enum.length === 1 &&
                  (l = this.getInsertTextForGuessedValue(r.enum[0], "")),
                (u += r.enum.length)),
              xe(r.default) &&
                (l || (l = this.getInsertTextForGuessedValue(r.default, "")),
                u++),
              Array.isArray(r.examples) &&
                r.examples.length &&
                (l ||
                  (l = this.getInsertTextForGuessedValue(r.examples[0], "")),
                (u += r.examples.length)),
              u === 0)
            ) {
              ...
              switch (
                (h ||
                  (r.properties ? (h = "object") : r.items && (h = "array")),
                h)
              ) {
                case "boolean":
                  l = "$1";
...
\r\v":{[,]}`.indexOf(i.charAt(n)) === -1;
        ...
        (e.prototype.findItemAtOffset = function (t, r, n) {
          for (
            var i = it(r.getText(), !0), s = t.items, o = s.length - 1;
            o >= 0;
            o--
          ) {
            var l = s[o];
            if (n > l.offset + l.length) {
              ...
              var u = i.scan();
              return u === 5 && n >= i.getTokenOffset() + i.getTokenLength()
                ? o + 1
                : o;
            } else if (n >= l.offset) return o;
          }
          return 0;
        }),
        (e.prototype.isInComment = function (t, r, n) {
          var i = it(t.getText(), !1);
          i.setPosition(r);
          for (
            var s = i.scan();
            s !== 17 && i.getTokenOffset() + i.getTokenLength() < n;
        ...
        (e.prototype.fromMarkup = function (t) {
          if (t && this.doesSupportMarkdown())
            return { kind: Pe.Markdown, value: t };
        }),
        (e.prototype.doesSupportMarkdown = function () {
          if (!xe(this.supportsMarkdown)) {
            ...
            this.supportsMarkdown =
              ...
              t.completionItem.documentationFormat.indexOf(Pe.Markdown) !== -1;
          }
          return this.supportsMarkdown;
        }),
        (e.prototype.doesSupportsCommitCharacters = function () {
          if (!xe(this.supportsCommitCharacters)) {
            var t =
              this.clientCapabilities.textDocument &&
              this.clientCapabilities.textDocument.completion;
            this.supportsCommitCharacters =
              t &&
              t.completionItem &&
              !!t.completionItem.commitCharactersSupport;
          }
        ...
        (e.prototype.doHover = function (t, r, n) {
          ...
          for (
            ...
            var d = this.contributions[f],
              m = d.getInfoContribution(t.uri, h);
            if (m)
          ...
          return this.schemaService
            ...
            .then(function (v) {
              if (v && s) {
                var p = n.getMatchingSchemas(v.schema, s.offset),
                  g = void 0,
                  A = void 0,
                  S = void 0,
                  C = void 0;
                p.every(function (x) {
                  if (
                    ...
                    (A =
                      ...
                      Hr(x.schema.description)),
                    x.schema.enum)
                  ) {
                    var w = x.schema.enum.indexOf(Xe(s));
                    x.schema.markdownEnumDescriptions
                      ? (S = x.schema.markdownEnumDescriptions[w])
                      : x.schema.enumDescriptions &&
                        (S = Hr(x.schema.enumDescriptions[w])),
                      S &&
                        ((C = x.schema.enum[w]),
...
$3`
      ...
      return (
        (e.prototype.configure = function (t) {
          t &&
            ...
            (this.commentSeverity = t.allowComments ? void 0 : de.Error));
        }),
        (e.prototype.doValidation = function (t, r, n, i) {
          ...
          var o = [],
            ...
            c = function (d) {
              var m =
                  n != null && n.trailingCommas
                    ? Jt(n.trailingCommas)
                    : de.Error,
                v =
                  n != null && n.comments ? Jt(n.comments) : s.commentSeverity,
                p =
                  n != null && n.schemaValidation
                    ? Jt(n.schemaValidation)
                    : de.Warning,
                g =
                  n != null && n.schemaRequest
                    ? Jt(n.schemaRequest)
                    : de.Warning;
              if (d) {
                if (d.errors.length && r.root && g) {
                  var A = r.root,
                    S = A.type === "object" ? A.properties[0] : void 0;
                  if (S && S.keyNode.value === "$schema") {
                    ...
                    u(Me.create(N, d.errors[0], g, q.SchemaResolveError));
                  } else {
                    var N = W.create(
                      t.positionAt(A.offset),
                      t.positionAt(A.offset + 1)
                    );
                    u(Me.create(N, d.errors[0], g, q.SchemaResolveError));
                  }
                } else if (p) {
                ...
                ua(d.schema) && (v = void 0), ca(d.schema) && (m = void 0);
              }
              ...
              if (typeof v == "number") {
                ...
                r.comments.forEach(function (k) {
                  u(Me.create(k, _, v, q.CommentNotPermitted));
                });
              }
              return o;
            };
          if (i) {
            var h = i.id || "schemaservice://untitled/" + Fo++,
              f = this.jsonSchemaService.registerExternalSchema(h, [], i);
  ...
  function ua(e) {
    if (e && typeof e == "object") {
      if (_e(e.allowComments)) return e.allowComments;
      if (e.allOf)
  ...
  function ca(e) {
    if (e && typeof e == "object") {
      if (_e(e.allowTrailingCommas)) return e.allowTrailingCommas;
      var t = e;
      if (_e(t.allowsTrailingCommas)) return t.allowsTrailingCommas;
      if (e.allOf)
  ...
  function X(e) {
    return e < fa
      ...
      : e <= Vo
        ? e - fa
        : (e < Zt && (e += Zt - Io), e >= Zt && e <= Do ? e - Zt + 10 : 0);
  }
  function Ro(e) {
    if (e[0] === "#")
      switch (e.length) {
    ...
    return (
      (e.prototype.findDocumentSymbols = function (t, r, n) {
        ...
        var o = n.resultLimit || Number.MAX_VALUE,
          l = t.uri;
        if (
          (l === "vscode://defaultsettings/keybindings.json" ||
            vt(l.toLowerCase(), "/user/keybindings.json")) &&
          s.type === "array"
        ) {
        ...
        for (
          var g = [{ node: s, containerName: "" }],
            A = 0,
            S = !1,
            C = [],
            N = function (w, b) {
              w.type === "array"
                ? w.items.forEach(function (y) {
                    y && g.push({ node: y, containerName: b });
                  })
                : w.type === "object" &&
                  w.properties.forEach(function (y) {
                    var _ = y.valueNode;
                    if (_)
                      if (o > 0) {
                        o--;
                        var k = bt.create(t.uri, Ue(t, y)),
                          T = b ? b + "." + y.keyNode.value : y.keyNode.value;
                        C.push({
                          name: i.getKeyLabel(y),
                          kind: i.getSymbolKind(_.type),
                          location: k,
                          containerName: b
                        }),
                          g.push({ node: _, containerName: T });
                      } else S = !0;
                  });
            };
          A < g.length;
        ...
        return (
          S && n && n.onResultLimitExceeded && n.onResultLimitExceeded(l), C
        );
      }),
      (e.prototype.findDocumentSymbols2 = function (t, r, n) {
          ...
          var A = [],
            ...
            x = function (b, y) {
              b.type === "array"
                ...
                : b.type === "object" &&
                  b.properties.forEach(function (_) {
                    var k = _.valueNode;
                    if (k)
                      if (o > 0) {
                        o--;
                        var T = Ue(t, _),
                          ...
                          I = [],
                          B = {
                            name: i.getKeyLabel(_),
                            kind: i.getSymbolKind(k.type),
                            range: T,
                            selectionRange: P,
                            children: I,
                            detail: i.getDetail(k)
                          };
        ...
        return (
          N && n && n.onResultLimitExceeded && n.onResultLimitExceeded(l), A
        );
      }),
              ...
              for (
                var o =
                    n && typeof n.resultLimit == "number"
                      ? n.resultLimit
                      : Number.MAX_VALUE,
                  l = r.getMatchingSchemas(i.schema),
                  u = {},
                  c = 0,
                  h = l;
                c < h.length;
                ...
                if (
                  !f.inverted &&
                  f.schema &&
                  (f.schema.format === "color" ||
                    f.schema.format === "color-hex") &&
                  f.node &&
                  f.node.type === "string"
                ) {
      ...
      (e.prototype.getColorPresentations = function (t, r, n, i) {
        ...
        return (
          n.alpha === 1
            ? (h = "#".concat(c(o)).concat(c(l)).concat(c(u)))
            : (h = "#"
                .concat(c(o))
                .concat(c(l))
                .concat(c(u))
                .concat(c(Math.round(n.alpha * 255)))),
          s.push({ label: h, textEdit: we.replace(i, JSON.stringify(h)) }),
          s
        );
      }),
      e
  ...
  for (ha in zr.schemas) {
    Xt = zr.schemas[ha];
    for (st in Xt.properties)
      (Qt = Xt.properties[st]),
        typeof Qt == "boolean" && (Qt = Xt.properties[st] = {}),
        (Gr = Uo[st]),
        Gr
          ? (Qt.description = Gr)
          : console.log(
              "".concat(st, ": localize('schema.json.").concat(st, `', "")`)
            );
  }
  var Xt, Qt, Gr, st, ha, da;
  da = (() => {
    var e = {
        470: n => {
          function i(l) {
          ...
          function s(l, u) {
            for (
              var c, h = "", f = 0, d = -1, m = 0, v = 0;
              v <= l.length;
              ++v
            ) {
              if (v < l.length) c = l.charCodeAt(v);
              else {
                if (c === 47) break;
                c = 47;
              }
          ...
          var o = {
            resolve: function () {
              for (
                var l, u = "", c = !1, h = arguments.length - 1;
                h >= -1 && !c;
                h--
              ) {
                var f;
                h >= 0
                  ? (f = arguments[h])
                  : (l === void 0 && (l = process.cwd()), (f = l)),
                  i(f),
                  f.length !== 0 &&
                    ((u = f + "/" + u), (c = f.charCodeAt(0) === 47));
              }
              return (
                (u = s(u, !c)),
                c ? (u.length > 0 ? "/" + u : "/") : u.length > 0 ? u : "."
              );
            },
            ...
            relative: function (l, u) {
              if (
                (i(l),
                i(u),
                l === u || (l = o.resolve(l)) === (u = o.resolve(u)))
              )
                return "";
              for (var c = 1; c < l.length && l.charCodeAt(c) === 47; ++c);
              for (
                var h = l.length, f = h - c, d = 1;
                d < u.length && u.charCodeAt(d) === 47;
                ++d
              );
              for (
                var m = u.length - d, v = f < m ? f : m, p = -1, g = 0;
                g <= v;
                ++g
              ) {
                if (g === v) {
                  if (m > v) {
                    if (u.charCodeAt(d + g) === 47) return u.slice(d + g + 1);
                    if (g === 0) return u.slice(d + g);
                  } else
                    f > v &&
                      (l.charCodeAt(c + g) === 47
                        ? (p = g)
                ...
                if (A !== u.charCodeAt(d + g)) break;
                A === 47 && (p = g);
              }
              var S = "";
              for (g = c + p + 1; g <= h; ++g)
                (g !== h && l.charCodeAt(g) !== 47) ||
                  (S.length === 0 ? (S += "..") : (S += "/.."));
              return S.length > 0
                ? S + u.slice(d + p)
                : ((d += p), u.charCodeAt(d) === 47 && ++d, u.slice(d));
            },
            ...
            basename: function (l, u) {
              ...
              if (u !== void 0 && u.length > 0 && u.length <= l.length) {
                ...
                return (
                  h === f ? (f = v) : f === -1 && (f = l.length), l.slice(h, f)
                );
              }
              for (c = l.length - 1; c >= 0; --c)
            ...
            extname: function (l) {
              i(l);
              for (
                var u = -1, c = 0, h = -1, f = !0, d = 0, m = l.length - 1;
                m >= 0;
                --m
              ) {
            ...
            parse: function (l) {
              ...
              f ? ((u.root = "/"), (c = 1)) : (c = 0);
              for (
                var d = -1, m = 0, v = -1, p = !0, g = l.length - 1, A = 0;
                g >= c;
                --g
              )
              ...
              return (
                ...
                (A === 1 && d === v - 1 && d === m + 1)
                  ? v !== -1 &&
                    (u.base = u.name =
                      m === 0 && f ? l.slice(1, v) : l.slice(m, v))
                  : (m === 0 && f
                      ? ((u.name = l.slice(1, d)), (u.base = l.slice(1, v)))
                      : ((u.name = l.slice(m, d)), (u.base = l.slice(m, v))),
                    (u.ext = l.slice(d, v))),
                m > 0 ? (u.dir = l.slice(0, m - 1)) : f && (u.dir = "/"),
                u
              );
            },
            sep: "/",
        ...
        447: (n, i, s) => {
          ...
          var p = "",
            ...
            A = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/,
            S = (function () {
              function E(M, F, V, R, U, $) {
                $ === void 0 && ($ = !1),
                  typeof M == "object"
                    ? ((this.scheme = M.scheme || p),
                      (this.authority = M.authority || p),
                      (this.path = M.path || p),
                      (this.query = M.query || p),
                      (this.fragment = M.fragment || p))
                    : ((this.scheme = (function (Ne, ie) {
                        return Ne || ie ? Ne : "file";
                      })(M, $)),
                      (this.authority = F || p),
                      (this.path = (function (Ne, ie) {
                        switch (Ne) {
                          case "https":
                          case "http":
                          case "file":
                            ie ? ie[0] !== g && (ie = g + ie) : (ie = g);
                        }
                        return ie;
                      })(this.scheme, V || p)),
                      (this.query = R || p),
              ...
              return (
                (E.isUri = function (M) {
                  return (
                    ...
                    (!!M &&
                      ...
                      typeof M.fragment == "string" &&
                      typeof M.path == "string" &&
                      typeof M.query == "string" &&
                      typeof M.scheme == "string" &&
                      typeof M.fsPath == "string" &&
                      typeof M.with == "function" &&
                ...
                (E.prototype.with = function (M) {
                  ...
                  var F = M.scheme,
                    ...
                    $ = M.fragment;
                  return (
                    F === void 0 ? (F = this.scheme) : F === null && (F = p),
                    V === void 0 ? (V = this.authority) : V === null && (V = p),
                    R === void 0 ? (R = this.path) : R === null && (R = p),
                    U === void 0 ? (U = this.query) : U === null && (U = p),
                    $ === void 0 ? ($ = this.fragment) : $ === null && ($ = p),
                    F === this.scheme &&
                    V === this.authority &&
                    R === this.path &&
                    U === this.query &&
                ...
                (E.file = function (M) {
                  var F = p;
                  if (
                    (o && (M = M.replace(/\\/g, g)), M[0] === g && M[1] === g)
                  ) {
                    var V = M.indexOf(g, 2);
                    V === -1
                      ? ((F = M.substring(2)), (M = g))
                      : ((F = M.substring(2, V)), (M = M.substring(V) || g));
                  }
                ...
                (E.revive = function (M) {
                  if (M) {
                    ...
                    var F = new N(M);
                    return (
                      (F._formatted = M.external),
                      (F._fsPath = M._sep === C ? M.fsPath : null),
                      F
                    );
                  }
                  return M;
            ...
            N = (function (E) {
              ...
              return (
                h(M, E),
                Object.defineProperty(M.prototype, "fsPath", {
                  get: function () {
                    return (
                ...
                (M.prototype.toString = function (F) {
                  return (
                    F === void 0 && (F = !1),
                    F
                      ? _(this, !0)
                ...
                (M.prototype.toJSON = function () {
                  var F = { $mid: 1 };
                  return (
                    this._fsPath && ((F.fsPath = this._fsPath), (F._sep = C)),
            ...
            x =
              ...
              c);
          function w(E, M) {
            for (var F = void 0, V = -1, R = 0; R < E.length; R++) {
              ...
              if (
                ...
                V !== -1 &&
                  ((F += encodeURIComponent(E.substring(V, R))), (V = -1)),
                  F !== void 0 && (F += E.charAt(R));
              else {
                F === void 0 && (F = E.substr(0, R));
                var $ = x[U];
                $ !== void 0
                  ? (V !== -1 &&
                      ((F += encodeURIComponent(E.substring(V, R))), (V = -1)),
            ...
            return (
              V !== -1 && (F += encodeURIComponent(E.substring(V))),
              F !== void 0 ? F : E
            );
          }
          function b(E) {
          ...
          function _(E, M) {
            ...
            if (
              ...
              var pe = U.indexOf("@");
              if (pe !== -1) {
                var lt = U.substr(0, pe);
                (U = U.substr(pe + 1)),
                  (pe = lt.indexOf(":")) === -1
                    ? (V += F(lt, !1))
                    : ((V += F(lt.substr(0, pe), !1)),
                      (V += ":"),
                      (V += F(lt.substr(pe + 1), !1))),
                  (V += "@");
              }
              (pe = (U = U.toLowerCase()).indexOf(":")) === -1
                ? (V += F(U, !1))
                : ((V += F(U.substr(0, pe), !1)), (V += U.substr(pe)));
            }
            if ($) {
              if (
                $.length >= 3 &&
          ...
          var I,
            ...
            Y = function (E, M, F) {
              if (F || arguments.length === 2)
                for (var V, R = 0, U = M.length; R < U; R++)
                  (!V && R in M) ||
                    (V || (V = Array.prototype.slice.call(M, 0, R)),
                    (V[R] = M[R]));
          ...
          (function (E) {
            (E.joinPath = function (M) {
              for (var F = [], V = 1; V < arguments.length; V++)
                F[V - 1] = arguments[V];
              return M.with({ path: H.join.apply(H, Y([M.path], F, !1)) });
            }),
              (E.resolvePath = function (M) {
                for (var F = [], V = 1; V < arguments.length; V++)
                  F[V - 1] = arguments[V];
                var R = M.path || "/";
                return M.with({ path: H.resolve.apply(H, Y([R], F, !1)) });
              }),
              (E.dirname = function (M) {
                var F = H.dirname(M.path);
                return F.length === 1 && F.charCodeAt(0) === 46
                  ? M
                  : M.with({ path: F });
              }),
              (E.basename = function (M) {
                return H.basename(M.path);
              }),
              (E.extname = function (M) {
                return H.extname(M.path);
              });
          })(I || (I = {}));
        }
      },
    ...
    return (
      (r.d = (n, i) => {
        for (var s in i)
          r.o(i, s) &&
            !r.o(n, s) &&
            Object.defineProperty(n, s, { enumerable: !0, get: i[s] });
      }),
  ...
  function jo(e, t) {
    ...
    for (
      var r = String(e),
        ...
        s = t ? !!t.globstar : !1,
        o = !1,
        l = t && typeof t.flags == "string" ? t.flags : "",
        u,
        c = 0,
        h = r.length;
      c < h;
      ...
      function e(t, r) {
        ...
        try {
          for (var n = 0, i = t; n < i.length; n++) {
            ...
            o || (s = s.substring(1)),
              s.length > 0 &&
                (s[0] === qo && (s = s.substring(1)),
                this.globWrappers.push({
                  regexp: jo("**/" + s, { extended: !0, globstar: !0 }),
                  include: o
                }));
          }
          this.uris = r;
    ...
    Wo = (function () {
      function e(t, r, n) {
        (this.service = t),
          ...
          (this.anchors = void 0),
          n &&
            (this.unresolvedSchema = this.service.promise.resolve(new Nt(n)));
      }
      return (
      ...
      return (
        ...
        (e.prototype.getSectionRecursive = function (t, r) {
          ...
          if (r.patternProperties)
            for (
              var i = 0, s = Object.keys(r.patternProperties);
              i < s.length;
              i++
            ) {
              var o = s[i],
    ...
    Ho = (function () {
      ...
      return (
        ...
        (e.prototype.onResourceChange = function (t) {
          ...
          for (
            var i = [t],
              s = Object.keys(this.schemasById).map(function (c) {
            ...
            for (var o = i.pop(), l = 0; l < s.length; l++) {
              var u = s[l];
              u &&
                (u.uri === o || u.dependencies.has(o)) &&
                (u.uri !== o && i.push(u.uri),
                u.clearSchema() && (n = !0),
                (s[l] = void 0));
            }
          return n;
        ...
        (e.prototype.setSchemaContributions = function (t) {
          ...
          if (Array.isArray(t.schemaAssociations))
            for (
              var s = t.schemaAssociations, o = 0, l = s;
              o < l.length;
              o++
            ) {
              var u = l[o],
                c = u.uris.map(je),
                h = this.addFilePatternAssociation(u.pattern, c);
              this.contributionAssociations.push(h);
            }
        }),
        (e.prototype.addSchemaHandle = function (t, r) {
          var n = new Wo(this, t, r);
        ...
        (e.prototype.clearExternalSchemas = function () {
          ...
          for (
            var r = 0, n = this.contributionAssociations;
            r < n.length;
            r++
          ) {
            var i = n[r];
        ...
        (e.prototype.loadSchema = function (t) {
          if (!this.requestService) {
            ...
            return this.promise.resolve(new Nt({}, [r]));
          }
        ...
        (e.prototype.resolveSchemaContent = function (t, r) {
          ...
          if (s.$schema) {
            ...
            o === "https://json-schema.org/draft/2019-09/schema"
              ? i.push(
                  Ae(
              ...
              : o === "https://json-schema.org/draft/2020-12/schema" &&
                i.push(
                  Ae(
          ...
          var l = this.contextService,
            u = function (p, g) {
              g = decodeURIComponent(g);
              var A = p;
              return (
                g[0] === "/" && (g = g.substring(1)),
                g.split("/").some(function (S) {
                  return (
            ...
            d = function (p, g, A, S) {
              l &&
                ...
                (g = l.resolveRelativePath(g, S.uri)),
                (g = je(g));
            ...
            m = function (p, g, A) {
              var S = [];
              return (
                n.traverseNodes(p, function (C) {
                  for (var N = new Set(); C.$ref; ) {
                    var x = C.$ref,
                      w = x.split("#", 2);
        ...
        (e.prototype.traverseNodes = function (t, r) {
          ...
          for (
            ...
            n.has(u) ||
              ...
              o(u.anyOf, u.allOf, u.oneOf, u.items)),
              (u = l.pop());
        }),
        (e.prototype.getSchemaFromProperty = function (t, r) {
          var n, i;
          if (
            ((n = r.root) === null || n === void 0 ? void 0 : n.type) ===
            "object"
          )
            for (var s = 0, o = r.root.properties; s < o.length; s++) {
              var l = o[s];
              if (
                l.keyNode.value === "$schema" &&
                ((i = l.valueNode) === null || i === void 0
                  ? void 0
                  : i.type) === "string"
              ) {
                ...
                return (
                  this.contextService &&
                    !/^\w[\w\d+.-]*:/.test(u) &&
                    (u = this.contextService.resolveRelativePath(u, t)),
                  u
                );
              }
            }
        ...
        (e.prototype.getSchemaForResource = function (t, r) {
          ...
          var s = this.getAssociatedSchemas(t),
            o =
              s.length > 0
                ? this.createCombinedSchema(t, s).getResolvedSchema()
                : this.promise.resolve(void 0);
          return (
            (this.cachedSchemaForResource = { resource: t, resolvedSchema: o }),
            o
          );
        }),
        ...
        (e.prototype.getMatchingSchemas = function (t, r, n) {
          if (n) {
            var i = n.id || "schemaservice://untitled/matchingSchemas/" + zo++,
          ...
          return this.getSchemaForResource(t.uri, r).then(function (o) {
            return o
              ? r.getMatchingSchemas(o.schema).filter(function (l) {
                  return !l.inverted;
                })
              : [];
          });
  ...
  function Go(e) {
    try {
      return ot.parse(e).with({ fragment: null, query: null }).toString(!0);
    } catch {
      return e;
    }
  }
  ...
  function Jo(e, t) {
    ...
    for (; l !== 17; ) {
      switch (l) {
        case 1:
        case 3: {
          var c = e.positionAt(o.getTokenOffset()).line,
            h = {
              startLine: c,
              endLine: c,
        ...
        case 4: {
          ...
          if (i.length > 0 && i[i.length - 1].kind === f) {
            var h = i.pop(),
              d = e.positionAt(o.getTokenOffset()).line;
            h &&
              d > h.startLine + 1 &&
              s !== h.startLine &&
              ((h.endLine = d - 1), u(h), (s = h.startLine));
          }
          break;
        }
        case 13: {
          ...
          o.getTokenError() === 1 && c + 1 < e.lineCount
            ? o.setPosition(e.offsetAt(be.create(c + 1, 0)))
            : c < m &&
              (u({ startLine: c, endLine: m, kind: wt.Comment }), (s = c));
          break;
        }
        case 12: {
          var v = e.getText().substr(o.getTokenOffset(), o.getTokenLength()),
            p = v.match(/^\/\/\s*#(region\b)|(endregion\b)/);
          if (p) {
            var d = e.positionAt(o.getTokenOffset()).line;
            if (p[1]) {
              var h = { startLine: d, endLine: d, kind: wt.Region };
              i.push(h);
            } else {
              for (var g = i.length - 1; g >= 0 && i[g].kind !== wt.Region; )
                g--;
              if (g >= 0) {
                var h = i[g];
                (i.length = g),
    ...
    function n(l) {
      for (var u = e.offsetAt(l), c = r.getNodeFromOffset(u, !0), h = []; c; ) {
        switch (c.type) {
          ...
          case "array":
            var f = c.offset + 1,
              d = c.offset + c.length - 1;
            f < d && u >= f && u <= d && h.push(i(f, d)),
      ...
      for (var v = void 0, p = h.length - 1; p >= 0; p--)
        v = zt.create(h[p], v);
      return v || (v = zt.create(W.create(l, l))), v;
    }
    function i(l, u) {
      return W.create(e.positionAt(l), e.positionAt(u));
    }
    var s = it(e.getText(), !0);
    function o(l, u) {
      s.setPosition(l);
      var c = s.scan();
    ...
    return (
      t.visit(function (n) {
        ...
        if (
          n.type === "property" &&
          n.keyNode.value === "$ref" &&
          ((i = n.valueNode) === null || i === void 0 ? void 0 : i.type) ===
            "string"
        ) {
          ...
          if (o) {
            ...
            r.push({
              target: ""
                .concat(e.uri, "#")
                .concat(l.line + 1, ",")
                .concat(l.character + 1),
              range: Qo(e, n.valueNode)
            });
          }
        }
        return !0;
  ...
  function tl(e) {
    var t = e.promiseConstructor || Promise,
      r = new Ho(e.schemaRequestService, e.workspaceContext, t);
    r.setSchemaContributions(zr);
    var n = new xo(r, e.contributions, t, e.clientCapabilities),
      i = new Mo(r, e.contributions, t),
      s = new Oo(r),
      o = new Eo(r, t);
    return {
      ...
      format: function (l, u, c) {
        var h = void 0;
        if (u) {
          var f = l.offsetAt(u.start),
            d = l.offsetAt(u.end) - f;
          h = { offset: f, length: d };
        }
        var m = {
          tabSize: c ? c.tabSize : 4,
          insertSpaces: (c == null ? void 0 : c.insertSpaces) === !0,
          insertFinalNewline:
            (c == null ? void 0 : c.insertFinalNewline) === !0,
          eol: `
`
        };
        return fo(l.getText(), h, m).map(function (v) {
          return we.replace(
            W.create(l.positionAt(v.offset), l.positionAt(v.offset + v.length)),
            v.content
          );
        });
      }
  ...
  var rl = class {
      ...
      _getTextDocument(e) {
        ...
        for (let r of t)
          if (r.uri.toString() === e)
            return Or.create(e, this._languageId, r.version, r.getValue());
        return null;
      }
    },
    nl = "/".charCodeAt(0),
    Zr = ".".charCodeAt(0);
  function il(e) {
    return e.charCodeAt(0) === nl;
  }
  function al(e, t) {
    if (il(t)) {
      const r = ot.parse(e),
        n = t.split("/");
      return r.with({ path: pa(n) }).toString();
    }
    return sl(e, t);
  }
  function pa(e) {
    ...
    for (const n of e)
      n.length === 0 ||
        (n.length === 1 && n.charCodeAt(0) === Zr) ||
        (n.length === 2 && n.charCodeAt(0) === Zr && n.charCodeAt(1) === Zr
          ? t.pop()
          : t.push(n));
