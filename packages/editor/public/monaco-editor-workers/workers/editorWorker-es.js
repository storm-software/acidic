...
function Un(e) {
  return e instanceof In
    ? !0
    : e instanceof Error && e.name === Be && e.message === Be;
}
...
let B;
typeof U.vscode < "u" && typeof U.vscode.process < "u"
  ? (B = U.vscode.process)
  : typeof process < "u" && (B = process);
const Qn =
    typeof ((xe = B == null ? void 0 : B.versions) === null || xe === void 0
      ? void 0
      : xe.electron) == "string",
  Zn = Qn && (B == null ? void 0 : B.type) === "renderer";
if (typeof navigator == "object" && !Zn)
  (Y = navigator.userAgent),
    (Ue = Y.indexOf("Windows") >= 0),
    (Ie = Y.indexOf("Macintosh") >= 0),
    (Y.indexOf("Macintosh") >= 0 ||
      Y.indexOf("iPad") >= 0 ||
      Y.indexOf("iPhone") >= 0) &&
      !!navigator.maxTouchPoints &&
      navigator.maxTouchPoints > 0,
    (Ee = Y.indexOf("Linux") >= 0),
    (wn = !0),
    On({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
    (pe = de),
    (Ve = pe);
else if (typeof B == "object") {
  (Ue = B.platform === "win32"),
    (Ie = B.platform === "darwin"),
    (Ee = B.platform === "linux"),
    Ee && !!B.env.SNAP && B.env.SNAP_REVISION,
    B.env.CI || B.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
    (pe = de),
    (Ve = de);
...
wn && U.importScripts;
const j = Y,
  Xn = typeof U.postMessage == "function" && !U.importScripts;
(() => {
  if (Xn) {
    const e = [];
...
(function (e) {
  ...
  function A(b, g, m = w => w) {
    const w = (...E) => _.fire(m(...E)),
      ...
      _ = new O({ onFirstListenerAdd: N, onLastListenerRemove: L });
    return _.event;
  }
    ...
    (this._disposed = !1),
      ...
      (this._perfMon =
        !((r = this._options) === null || r === void 0) && r._profName
          ? new De(this._options._profName)
          : void 0),
      (this._deliveryQueue =
...
function He(e) {
  const t = [];
  for (const r of sr(e)) typeof e[r] == "function" && t.push(r);
  return t;
}
function ir(e, t) {
  const r = i =>
...
_n = z;
z.ambiguousCharacterData = new Cn(() =>
  JSON.parse(
...
class Nr {
    ...
    const i = new O({
      onFirstListenerAdd: () => {
        (s = String(++this._lastSentReq)),
          ...
          this._send(new _r(this._workerId, s, t, r));
      },
      onLastListenerRemove: () => {
        this._pendingEmitters.delete(s),
          this._send(new Lr(this._workerId, s)),
          (s = null);
      }
    });
    return i.event;
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then(
      ...
      i => {
        i.detail instanceof Error && (i.detail = ct(i.detail)),
          this._send(new ut(this._workerId, r, void 0, ct(i)));
      }
    );
  }
...
class Sr {
  ...
  _handleMessage(t, r) {
    if (t === wr) return this.initialize(r[0], r[1], r[2], r[3]);
  ...
  initialize(t, r, s, i) {
    ...
    return this._requestHandlerFactory
      ? ((this._requestHandler = this._requestHandlerFactory(l)),
        Promise.resolve(He(this._requestHandler)))
      : (r &&
...
function Ar(e, t) {
  t = ht(149417, t);
  for (let r = 0, s = e.length; r < s; r++) t = ht(e.charCodeAt(r), t);
  return t;
}
class ft {
  constructor(t) {
...
class J {
  constructor(t, r, s = null) {
    ...
    const [i, a, o] = J._getElements(t),
      [l, u, c] = J._getElements(r);
  ...
  static _getElements(t) {
    ...
    if (J._isStringArray(r)) {
      ...
      for (let i = 0, a = r.length; i < a; i++) s[i] = Ar(r[i], 0);
      return [r, s, !0];
    }
  ...
  ElementsAreStrictEqual(t, r) {
    ...
    const s = J._getStrictElement(this._originalSequence, t),
      i = J._getStrictElement(this._modifiedSequence, r);
    return s === i;
  }
  ...
  ComputeDiffRecursive(t, r, s, i, a) {
    for (a[0] = !1; t <= r && s <= i && this.ElementsAreEqual(t, s); ) t++, s++;
  ...
  ConcatenateChanges(t, r) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], r[0], s)) {
      ...
      return (
        oe.Copy(t, 0, i, 0, t.length - 1),
        (i[t.length - 1] = s[0]),
        oe.Copy(r, 1, i, t.length, r.length - 1),
        i
      );
    } else {
      const i = new Array(t.length + r.length);
      return (
        oe.Copy(t, 0, i, 0, t.length), oe.Copy(r, 0, i, t.length, r.length), i
      );
    }
  }
...
function V(e, t) {
  if (typeof e != "string") throw new vn(t, "string", e);
}
function M(e) {
  return e === T || e === q;
}
      ...
      if (!(o === c - 1 || l === 1))
        if (l === 2) {
          if (
            i.length < 2 ||
            a !== 2 ||
            i.charCodeAt(i.length - 1) !== ee ||
            i.charCodeAt(i.length - 2) !== ee
          ) {
            if (i.length > 2) {
              const f = i.lastIndexOf(r);
              f === -1
                ? ((i = ""), (a = 0))
                : ((i = i.slice(0, f)), (a = i.length - 1 - i.lastIndexOf(r))),
                (o = c),
                (l = 0);
              continue;
            } else if (i.length !== 0) {
...
const I = {
      ...
      for (let i = e.length - 1; i >= -1; i--) {
        ...
        if (o === 1) M(f) && ((l = 1), (c = !0));
          ...
          if (((c = !0), M(a.charCodeAt(1)))) {
            let h = 2,
              d = h;
            for (; h < o && !M(a.charCodeAt(h)); ) h++;
            if (h < o && h !== d) {
              const C = a.slice(d, h);
              for (d = h; h < o && M(a.charCodeAt(h)); ) h++;
              if (h < o && h !== d) {
                for (d = h; h < o && !M(a.charCodeAt(h)); ) h++;
                (h === o || h !== d) &&
                  ((u = `\\\\${C}\\${a.slice(d, h)}`), (l = h));
    ...
    normalize(e) {
      ...
      if (M(a))
        if (((i = !0), M(e.charCodeAt(1)))) {
          ...
          if (l < t && l !== u) {
            const c = e.slice(u, l);
            for (u = l; l < t && M(e.charCodeAt(l)); ) l++;
            if (l < t && l !== u) {
              for (u = l; l < t && !M(e.charCodeAt(l)); ) l++;
    ...
    isAbsolute(e) {
      ...
      return (
        M(r) || (t > 2 && Z(r) && e.charCodeAt(1) === Q && M(e.charCodeAt(2)))
      );
    },
    join(...e) {
    ...
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === q) {
        if (t.charCodeAt(1) === q) {
          ...
          if (r !== Fr && r !== ee) return `\\\\?\\UNC\\${t.slice(2)}`;
        }
      } else if (
        Z(t.charCodeAt(0)) &&
        t.charCodeAt(1) === Q &&
    ...
    dirname(e) {
      ...
      if (M(i)) {
        ...
        Z(i) &&
          e.charCodeAt(1) === Q &&
          ((r = t > 2 && M(e.charCodeAt(2)) ? 3 : 2), (s = r));
      let a = -1,
        o = !0;
      for (let l = t - 1; l >= s; --l)
        if (M(e.charCodeAt(l))) {
    ...
    parse(e) {
      ...
      if (M(i)) {
        if (((s = 1), M(e.charCodeAt(1)))) {
          let h = 2,
            d = h;
          for (; h < r && !M(e.charCodeAt(h)); ) h++;
          if (h < r && h !== d) {
            for (d = h; h < r && M(e.charCodeAt(h)); ) h++;
            if (h < r && h !== d) {
              for (d = h; h < r && !M(e.charCodeAt(h)); ) h++;
              h === r ? (s = h) : h !== d && (s = h + 1);
            }
  ...
  W = {
    ...
    relative(e, t) {
      if (
        (V(e, "from"),
        V(t, "to"),
        e === t || ((e = W.resolve(e)), (t = W.resolve(t)), e === t))
      )
        return "";
      const r = 1,
        s = e.length,
...
class ne {
  ...
  static joinPath(t, ...r) {
    ...
    return (
      ge && t.scheme === "file"
        ? (s = ne.file(I.join(Ge(t, !0), ...r)).path)
        : (s = W.join(t.path, ...r)),
      t.with({ path: s })
    );
  }
    ...
    if (t) {
      if (t instanceof ne) return t;
      {
        ...
        return (
          ...
          (r._fsPath = t._sep === An ? t.fsPath : null),
          r
        );
      }
    } else return t;
...
class le extends ne {
  ...
  toString(t = !1) {
    return t
      ? Oe(this, !0)
      : (this._formatted || (this._formatted = Oe(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    ...
    return (
      this._fsPath && ((t.fsPath = this._fsPath), (t._sep = An)),
...
function Ir(e) {
  ...
  for (let r = 0; r < e.length; r++) {
    const s = e.charCodeAt(r);
    s === 35 || s === 63
      ? (t === void 0 && (t = e.substr(0, r)), (t += yn[s]))
      : t !== void 0 && (t += e[r]);
  }
  return t !== void 0 ? t : e;
}
...
class $r {
  constructor(t, r, s) {
    (this.shouldComputeCharChanges = s.shouldComputeCharChanges),
      ...
      (this.original = new wt(t)),
      (this.modified = new wt(r)),
      (this.continueLineDiff = Ct(s.maxComputationTime)),
      (this.continueCharDiff = Ct(
      ...
      for (; a < f && o < h; ) {
        ...
        if (d !== C) {
          ...
          }
          {
            ...
            (v < k || A < R) &&
              this._pushTrimWhitespaceCharChange(i, a + 1, v, k, o + 1, A, R);
          }
        }
        a++, o++;
      }
  ...
  _pushTrimWhitespaceCharChange(t, r, s, i, a, o, l) {
    ...
    let u;
    this.shouldComputeCharChanges && (u = [new be(r, s, r, i, a, o, a, l)]),
      t.push(new me(r, r, a, a, u));
  }
    ...
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
      ...
      : c.originalEndLineNumber + 1 === r && c.modifiedEndLineNumber + 1 === a
        ? ((c.originalEndLineNumber = r),
          ...
          this.shouldComputeCharChanges &&
            c.charChanges &&
            c.charChanges.push(new be(r, s, r, i, a, o, a, l)),
          !0)
        : !1;
  }
}
    ...
    for (const s of r)
      this._acceptDeleteRange(s.range),
        this._acceptInsertText(
          new H(s.range.startLineNumber, s.range.startColumn),
          s.text
        );
...
function Qr(e = "") {
  let t = "(-?\\d*\\.\\d\\w*)|([^";
  for (const r of jr) e.indexOf(r) >= 0 || (t += "\\" + r);
...
class ot {
  constructor(t) {
    ...
    (this._defaultValue = r),
      (this._asciiMap = ot._createAsciiMap(r)),
...
function e1() {
  if (fe === null) {
    fe = new ot(0);
    const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
    for (let r = 0; r < e.length; r++) fe.set(e.charCodeAt(r), 1);
    const t = ".,;:";
    for (let r = 0; r < t.length; r++) fe.set(t.charCodeAt(r), 2);
  }
  return fe;
}
class Me {
...
class Ze {
  ...
  valueSetReplace(t, r, s) {
    let i = t.indexOf(r);
    return i >= 0
      ? ((i += s ? 1 : -1), i < 0 ? (i = t.length - 1) : (i %= t.length), t[i])
      : null;
  }
}
Ze.INSTANCE = new Ze();
...
(function (e) {
  function t(r) {
    return r === e.None || r === e.Cancelled || r instanceof Ne
      ? !0
      : !r || typeof r != "object"
        ? !1
...
class Ne {
  ...
  get onCancellationRequested() {
    return this._isCancelled
      ? Dn
      : (this._emitter || (this._emitter = new O()), this._emitter.event);
  }
  dispose() {
...
class n1 {
  ...
  cancel() {
    this._token
      ? this._token instanceof Ne && this._token.cancel()
      : (this._token = Re.Cancelled);
  }
  dispose(t = !1) {
    t && this.cancel(),
      this._parentListener && this._parentListener.dispose(),
      this._token
        ? this._token instanceof Ne && this._token.dispose()
        : (this._token = Re.None);
  }
}
class lt {
...
const ve = new lt(),
  ...
  i1 = /* @__PURE__ */ Object.create(null);
(function () {
  const e = "",
    t = [
  ...
  for (const i of t) {
    ...
    if (
      (s[l] || ((s[l] = !0), (s1[u] = l), (i1[u.toLowerCase()] = l)), !r[c])
    ) {
      if (((r[c] = !0), !f))
        throw new Error(
...
n.debugBreakpointDataUnverified = new n("debug-breakpoint-data-unverified", {
  fontCharacter: "\\eaa8"
});
  ...
  next(t) {
    ...
    do {
      ...
      if (i === this._prevMatchStartIndex && a === this._prevMatchLength) {
        if (a === 0) {
          mr(t, r, this._searchRegex.lastIndex) > 65535
      ...
      if (
        ...
        !this._wordSeparators || d1(this._wordSeparators, t, r, i, a))
      )
        return s;
    } while (s);
    return null;
...
class g1 {
  static computeUnicodeHighlights(t, r, s) {
    ...
    l === "allNonBasicAscii"
      ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
      : (u = new RegExp(`${b1(Array.from(l))}`, "g"));
    const c = new m1(null, u),
      f = [];
    let h = !1,
      d,
      C = 0,
      v = 0,
      A = 0;
    e: for (let k = i, R = a; k <= R; k++) {
      const P = t.getLineContent(k),
        y = P.length;
      c.reset(0);
      do
        if (((d = c.next(P)), d)) {
...
class mn {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const r of K.codePoints) gn(String.fromCodePoint(r)) || t.add(r);
      ...
      for (const o of r) {
        ...
        (i = i || u),
          !u &&
            ...
            !K.isInvisibleCharacter(l) &&
            (a = !0);
      }
    return !i && a
      ? 0
      : this.options.invisibleCharacters && !gn(t) && K.isInvisibleCharacter(s)
        ? 2
...
class w1 extends Or {
      ...
      *[Symbol.iterator]() {
        for (;;)
          if (o < l.length) {
            ...
            (o += 1), yield u;
          } else if (i < r.length) (a = r[i]), (l = s(a, t)), (o = 0), (i += 1);
          else break;
      }
    };
  }
  ...
  _validatePosition(t) {
    if (!H.isIPosition(t)) throw new Error("bad position");
...
class re {
  ...
  computeUnicodeHighlights(t, r, s) {
    return te(this, void 0, void 0, function* () {
      ...
      return i
        ? g1.computeUnicodeHighlights(i, r, s)
        : {
            ranges: [],
            hasMore: !1,
      ...
      e: for (const u of t) {
        ...
        if (!!c) {
          for (const f of c.words(o))
            if (
              !(f === r || !isNaN(Number(f))) &&
              (l.add(f), l.size > re._suggestionsLimit)
            )
              break e;
        }
      }
  ...
  loadForeignModule(t, r, s) {
    ...
    return this._foreignModuleFactory
      ? ((this._foreignModule = this._foreignModuleFactory(o, r)),
        Promise.resolve(He(this._foreignModule)))
