...
var Ca = (e, t, r) =>
  t in e
    ...
    : (e[t] = r);
var st = (e, t, r) => (Ca(e, typeof t != "symbol" ? t + "" : t, r), r);
class _a {
  constructor() {
    (this.listeners = []),
...
function tn(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: r,
      stack: n,
      noTelemetry: it.isErrorNoTelemetry(e)
    };
  }
  return e;
}
...
function Na(e) {
  return e instanceof La
    ? !0
    : e instanceof Error && e.name === cr && e.message === cr;
}
class La extends Error {
  constructor() {
    super(cr), (this.name = this.message);
  }
}
...
class Pa {
  constructor() {
    (this.dispose = () => {}), (this.unset = () => {}), (this.isset = () => !1);
  }
  set(t) {
    let r = t;
    return (
...
typeof re.vscode < "u" && typeof re.vscode.process < "u"
  ? (te = re.vscode.process)
  : typeof process < "u" && (te = process);
const Ia =
    typeof ((Kt = te == null ? void 0 : te.versions) === null || Kt === void 0
      ? void 0
      : Kt.electron) == "string",
  Da = Ia && (te == null ? void 0 : te.type) === "renderer";
if (typeof navigator == "object" && !Da)
  (Ve = navigator.userAgent),
    (fr = Ve.indexOf("Windows") >= 0),
    (hr = Ve.indexOf("Macintosh") >= 0),
    (Ve.indexOf("Macintosh") >= 0 ||
      Ve.indexOf("iPad") >= 0 ||
      Ve.indexOf("iPhone") >= 0) &&
      !!navigator.maxTouchPoints &&
      navigator.maxTouchPoints > 0,
    (er = Ve.indexOf("Linux") >= 0),
    (Gi = !0),
    Fa({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
    (At = ut),
    (tr = At);
else if (typeof te == "object") {
  (fr = te.platform === "win32"),
    (hr = te.platform === "darwin"),
    (er = te.platform === "linux"),
    er && !!te.env.SNAP && te.env.SNAP_REVISION,
  ...
  if (e)
    try {
      ...
      (At = t.locale), (tr = r || ut), (Va = t._translationsConfigFile);
    } catch {}
...
Gi && re.importScripts;
const Le = Ve,
  Oa = typeof re.postMessage == "function" && !re.importScripts;
(() => {
  if (Oa) {
    const e = [];
...
const Ua = !!(Le && Le.indexOf("Chrome") >= 0);
Le && Le.indexOf("Firefox") >= 0;
!Ua && Le && Le.indexOf("Safari") >= 0;
Le && Le.indexOf("Edg/") >= 0;
Le && Le.indexOf("Android") >= 0;
const ja = re.performance && typeof re.performance.now == "function";
class Jt {
  constructor(t) {
    (this._highResolution = ja && t),
...
(function (e) {
  ...
  e.signal = s;
  function o(...w) {
    return (b, y = null, _) => Ma(...w.map(k => k(T => b.call(y, T), null, _)));
  }
  e.any = o;
  function l(w, b, y, _) {
    let k = y;
        ...
        onFirstListenerAdd() {
          P = w(M => {
            Q++,
              ...
              (B = setTimeout(() => {
                const F = I;
                (I = void 0), (B = void 0), (!_ || Q > 1) && E.fire(F), (Q = 0);
              }, y));
          });
        },
        onLastListenerRemove() {
  ...
  function p(w, b, y = _ => _) {
    const _ = (...I) => P.fire(y(...I)),
      ...
      P = new Ae({ onFirstListenerAdd: k, onLastListenerRemove: T });
    return P.event;
  }
  ...
  class N {
    constructor(b, y) {
      ...
      (this.emitter = new Ae(_)), y && y.add(this.emitter);
    }
    beginUpdate(b) {
      this._counter++;
    }
...
class Zt {
  constructor(t) {
    (this._listenerCount = 0),
      ...
      (this._name = `${t}_${Zt._idPool++}`);
  }
  start(t) {
    (this._stopWatch = new Jt(!0)), (this._listenerCount = t);
  }
  stop() {
    if (this._stopWatch) {
...
class Hr {
  ...
  static create() {
    var t;
    return new Hr((t = new Error().stack) !== null && t !== void 0 ? t : "");
  }
  print() {
    console.warn(
      this.value
...
class Ae {
  ...
  get event() {
    return (
      this._event ||
        (this._event = (t, r, n) => {
          var i, s, o;
          this._listeners || (this._listeners = new Dt());
  ...
  fire(t) {
    var r, n;
    if (this._listeners) {
      this._deliveryQueue || (this._deliveryQueue = new $a());
...
function mr(e) {
  const t = [];
  for (const r of Ha(e)) typeof e[r] == "function" && t.push(r);
  return t;
}
function za(e, t) {
  const r = i =>
...
Zi = pe;
pe.ambiguousCharacterData = new Ji(() =>
  JSON.parse(
...
pe._locales = new Ji(() =>
  Object.keys(pe.ambiguousCharacterData.getValue()).filter(
    e => !e.startsWith("_")
  )
);
class Oe {
...
class us {
  ...
  sendMessage(t, r) {
    ...
    return new Promise((i, s) => {
      (this._pendingReplies[n] = {
        ...
        this._send(new as(this._workerId, n, t, r));
    });
  }
  listen(t, r) {
    let n = null;
    const i = new Ae({
      onFirstListenerAdd: () => {
        (n = String(++this._lastSentReq)),
          ...
          this._send(new ss(this._workerId, n, t, r));
      },
      onLastListenerRemove: () => {
        this._pendingEmitters.delete(n),
          this._send(new ls(this._workerId, n)),
          (n = null);
      }
    });
    return i.event;
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then(
      ...
      i => {
        i.detail instanceof Error && (i.detail = tn(i.detail)),
          this._send(new rn(this._workerId, r, void 0, tn(i)));
      }
    );
  }
  _handleSubscribeEventMessage(t) {
    const r = t.req,
      n = this._handler.handleEvent(
        ...
        this._send(new os(this._workerId, r, i));
      });
...
function Qi(e) {
  return e[0] === "o" && e[1] === "n" && Xi(e.charCodeAt(2));
}
function Yi(e) {
  return /^onDynamic/.test(e) && Xi(e.charCodeAt(9));
}
function cs(e, t, r) {
  const n = o =>
      function () {
...
class fs {
  ...
  _handleMessage(t, r) {
    if (t === is) return this.initialize(r[0], r[1], r[2], r[3]);
  ...
  initialize(t, r, n, i) {
    ...
    return this._requestHandlerFactory
      ? ((this._requestHandler = this._requestHandlerFactory(l)),
        Promise.resolve(mr(this._requestHandler)))
      : (r &&
          (typeof r.baseUrl < "u" && delete r.baseUrl,
          typeof r.paths < "u" && typeof r.paths.vs < "u" && delete r.paths.vs,
...
function hs(e, t) {
  t = nn(149417, t);
  for (let r = 0, n = e.length; r < n; r++) t = nn(e.charCodeAt(r), t);
  return t;
}
class an {
  constructor(t) {
...
function ds(e, t, r) {
  return new Re(new an(e), new an(t)).ComputeDiff(r).changes;
}
class Ze {
  static Assert(t, r) {
...
class Re {
  constructor(t, r, n = null) {
    ...
    const [i, s, o] = Re._getElements(t),
      [l, u, c] = Re._getElements(r);
  ...
  static _getElements(t) {
    ...
    if (Re._isStringArray(r)) {
      ...
      for (let i = 0, s = r.length; i < s; i++) n[i] = hs(r[i], 0);
      return [r, n, !0];
    }
  ...
  ElementsAreStrictEqual(t, r) {
    ...
    const n = Re._getStrictElement(this._originalSequence, t),
      i = Re._getStrictElement(this._modifiedSequence, r);
    return n === i;
  }
  ...
  ConcatenateChanges(t, r) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], r[0], n)) {
      ...
      return (
        Xe.Copy(t, 0, i, 0, t.length - 1),
        (i[t.length - 1] = n[0]),
        Xe.Copy(r, 1, i, t.length, r.length - 1),
        i
      );
    } else {
      const i = new Array(t.length + r.length);
      return (
        Xe.Copy(t, 0, i, 0, t.length), Xe.Copy(r, 0, i, t.length, r.length), i
      );
    }
  }
...
if (typeof re.vscode < "u" && typeof re.vscode.process < "u") {
  ...
  typeof process < "u"
    ...
    : (tt = {
        get platform() {
          return mt ? "win32" : Ra ? "darwin" : "linux";
        },
        get arch() {},
        get env() {
          return {};
...
function Z(e, t) {
  if (typeof e != "string") throw new Ki(t, "string", e);
}
function j(e) {
  return e === K || e === se;
}
        ...
        if (l === 2) {
          if (
            ...
            if (i.length > 2) {
              ...
              h === -1
                ? ((i = ""), (s = 0))
                : ((i = i.slice(0, h)), (s = i.length - 1 - i.lastIndexOf(r))),
                (o = c),
                (l = 0);
              continue;
            } else if (i.length !== 0) {
...
function ea(e, t) {
  if (t === null || typeof t != "object")
    throw new Ki("pathObject", "Object", t);
...
const ae = {
    ...
    isAbsolute(e) {
      ...
      return (
        j(r) || (t > 2 && Te(r) && e.charCodeAt(1) === Pe && j(e.charCodeAt(2)))
      );
    },
    join(...e) {
    ...
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === se) {
        if (t.charCodeAt(1) === se) {
          ...
          if (r !== ws && r !== Ue) return `\\\\?\\UNC\\${t.slice(2)}`;
        }
      } else if (
        Te(t.charCodeAt(0)) &&
        t.charCodeAt(1) === Pe &&
  ...
  ce = {
    resolve(...e) {
      ...
      return (t = Rt(t, !r, "/", vr)), r ? `/${t}` : t.length > 0 ? t : ".";
    },
    normalize(e) {
...
He === "win32" ? ae.normalize : ce.normalize;
He === "win32" ? ae.resolve : ce.resolve;
He === "win32" ? ae.relative : ce.relative;
He === "win32" ? ae.dirname : ce.dirname;
He === "win32" ? ae.basename : ce.basename;
He === "win32" ? ae.extname : ce.extname;
He === "win32" ? ae.sep : ce.sep;
const ys = /^\w[\w\d+.-]*$/,
  Cs = /^\//,
  _s = /^\/\//;
function on(e, t) {
...
class Be {
  ...
  static file(t) {
    let r = G;
    if ((mt && (t = t.replace(/\\/g, ve)), t[0] === ve && t[1] === ve)) {
      const n = t.indexOf(ve, 2);
      n === -1
        ? ((r = t.substring(2)), (t = ve))
        : ((r = t.substring(2, n)), (t = t.substring(n) || ve));
    }
    return new Qe("file", r, t, G, G);
  }
  static from(t) {
    const r = new Qe(t.scheme, t.authority, t.path, t.query, t.fragment);
    return on(r, !0), r;
  }
  static joinPath(t, ...r) {
    if (!t.path)
    ...
    return (
      mt && t.scheme === "file"
        ? (n = Be.file(ae.join(br(t, !0), ...r)).path)
        : (n = ce.join(t.path, ...r)),
      t.with({ path: n })
    );
  }
    ...
    if (t) {
      if (t instanceof Be) return t;
      {
        ...
        return (
          ...
          (r._fsPath = t._sep === ta ? t.fsPath : null),
          r
        );
      }
    } else return t;
...
const ta = mt ? 1 : void 0;
class Qe extends Be {
  constructor() {
    super(...arguments), (this._formatted = null), (this._fsPath = null);
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = br(this, !1)), this._fsPath;
  }
  toString(t = !1) {
    return t
      ? wr(this, !0)
      : (this._formatted || (this._formatted = wr(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    ...
    return (
      this._fsPath && ((t.fsPath = this._fsPath), (t._sep = ta)),
...
function ln(e, t) {
  ...
  return (
    n !== -1 && (r += encodeURIComponent(e.substring(n))), r !== void 0 ? r : e
  );
}
function Ls(e) {
  let t;
  for (let r = 0; r < e.length; r++) {
    const n = e.charCodeAt(r);
    n === 35 || n === 63
      ? (t === void 0 && (t = e.substr(0, r)), (t += ra[n]))
      : t !== void 0 && (t += e[r]);
  }
  return t !== void 0 ? t : e;
}
...
function Nt(e) {
  return e.match(un) ? e.replace(un, t => na(t)) : e;
}
class ue {
  constructor(t, r) {
  ...
  static createFromDiffResult(t, r, n, i, s, o, l) {
    ...
    if (
      ...
      if (m.getElements().length > 0 && v.getElements().length > 0) {
        let p = ia(m, v, s, !0).changes;
        l && (p = Ms(p)), (d = []);
        for (let g = 0, A = p.length; g < A; g++)
          d.push(gt.createFromDiffChange(p[g], m, v));
      }
    }
    return new ft(u, c, h, f, d);
  }
}
class Ps {
  constructor(t, r, n) {
    (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
      ...
      (this.continueLineDiff = fn(n.maxComputationTime)),
      (this.continueCharDiff = fn(
  ...
  _pushTrimWhitespaceCharChange(t, r, n, i, s, o, l) {
    ...
    let u;
    this.shouldComputeCharChanges && (u = [new gt(r, n, r, i, s, o, s, l)]),
      t.push(new ft(r, r, s, s, u));
  }
    ...
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
      ...
      : c.originalEndLineNumber + 1 === r && c.modifiedEndLineNumber + 1 === s
        ? ((c.originalEndLineNumber = r),
          ...
          this.shouldComputeCharChanges &&
            c.charChanges &&
            c.charChanges.push(new gt(r, n, r, i, s, o, s, l)),
          !0)
        : !1;
  }
}
    ...
    for (const n of r)
      this._acceptDeleteRange(n.range),
        this._acceptInsertText(
          new ue(n.range.startLineNumber, n.range.startColumn),
          n.text
        );
...
function Is(e = "") {
  let t = "(-?\\d*\\.\\d\\w*)|([^";
  for (const r of Vs) e.indexOf(r) >= 0 || (t += "\\" + r);
...
function zr(e, t, r, n, i) {
  if ((i || (i = Vt.first(sa)), r.length > i.maxLen)) {
    let c = e - i.maxLen / 2;
    return (
      c < 0 ? (c = 0) : (n += c),
...
class Gr {
  constructor(t) {
    ...
    (this._defaultValue = r),
      (this._asciiMap = Gr._createAsciiMap(r)),
...
function Bs() {
  if (ot === null) {
    ot = new Gr(0);
    const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
    for (let r = 0; r < e.length; r++) ot.set(e.charCodeAt(r), 1);
    const t = ".,;:";
    for (let r = 0; r < t.length; r++) ot.set(t.charCodeAt(r), 2);
  }
  return ot;
}
class Ot {
    ...
    for (let s = 1, o = t.getLineCount(); s <= o; s++) {
      ...
      for (; c < u; ) {
        ...
        if (d === 13) {
          ...
          C === 1 && (i.push(Ot._createLink(n, l, s, h, c)), (A = !0));
        } else if (d === 12) {
          let C;
      ...
      d === 13 && i.push(Ot._createLink(n, l, s, h, u));
    }
    return i;
  }
}
...
class _r {
  ...
  valueSetReplace(t, r, n) {
    let i = t.indexOf(r);
    return i >= 0
      ? ((i += n ? 1 : -1), i < 0 ? (i = t.length - 1) : (i %= t.length), t[i])
      : null;
  }
}
_r.INSTANCE = new _r();
...
(function (e) {
  function t(r) {
    return r === e.None || r === e.Cancelled || r instanceof Et
      ? !0
      : !r || typeof r != "object"
        ? !1
...
class $s {
  ...
  get token() {
    return this._token || (this._token = new Et()), this._token;
  }
  cancel() {
    this._token
      ? this._token instanceof Et && this._token.cancel()
  ...
  dispose(t = !1) {
    t && this.cancel(),
      ...
      this._token
        ? this._token instanceof Et && this._token.dispose()
        : (this._token = Ut.None);
  }
}
class Jr {
...
(function () {
  ...
  for (const i of t) {
    ...
    if (
      (n[l] || ((n[l] = !0), (Hs[u] = l), (zs[u.toLowerCase()] = l)), !r[c])
    ) {
      if (((r[c] = !0), !h))
        throw new Error(
          `String representation missing for key code ${c} around scan code ${u}`
        );
      Ft.define(c, h), Sr.define(c, m || h), Ar.define(c, v || m || h);
    }
    f && (Ws[f] = c);
  }
})();
...
class he extends J {
  ...
  setEndPosition(t, r) {
    return this.getDirection() === 0
      ? new he(this.startLineNumber, this.startColumn, t, r)
      : new he(t, r, this.startLineNumber, this.startColumn);
  }
  getPosition() {
  ...
  setStartPosition(t, r) {
    return this.getDirection() === 0
      ? new he(t, r, this.endLineNumber, this.endColumn)
      : new he(this.endLineNumber, this.endColumn, t, r);
  }
  static fromPositions(t, r = t) {
  ...
  static fromRange(t, r) {
    return r === 0
      ? new he(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
      : new he(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
...
a.debugBreakpointDataUnverified = new a("debug-breakpoint-data-unverified", {
  fontCharacter: "\\eaa8"
});
...
(function (e) {
  (e[(e.acceptSuggestionOnCommitCharacter = 0)] =
    ...
    (e[(e.revealHorizontalRightPadding = 91)] = "revealHorizontalRightPadding"),
...
function eo(e, t, r, n, i) {
  return Ys(e, t, r, n, i) && Ks(e, t, r, n, i);
}
class to {
  constructor(t, r) {
  ...
  next(t) {
    ...
    do {
      ...
      if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          ts(t, r, this._searchRegex.lastIndex) > 65535
      ...
      if (
        ...
        !this._wordSeparators || eo(this._wordSeparators, t, r, i, s))
      )
        return n;
    } while (n);
    return null;
...
class ro {
  static computeUnicodeHighlights(t, r, n) {
    ...
    l === "allNonBasicAscii"
      ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
      : (u = new RegExp(`${no(Array.from(l))}`, "g"));
    const c = new to(null, u),
      h = [];
    let f = !1,
      d,
      m = 0,
          ...
          l = pe
            ...
            .filter(
              u =>
                !pe
                  .getInstance(
                    /* @__PURE__ */ new Set([...r.allowedLocales, u])
                  )
                  .isAmbiguous(s)
            );
        return {
...
class si {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const r of Oe.codePoints) oi(String.fromCodePoint(r)) || t.add(r);
      ...
      for (const o of r) {
        ...
        (i = i || u),
          !u &&
            ...
            !Oe.isInvisibleCharacter(l) &&
            (s = !0);
      }
    return !i && s
      ? 0
      : this.options.invisibleCharacters && !oi(t) && Oe.isInvisibleCharacter(n)
        ? 2
...
class io extends Fs {
  ...
  getWordAtPosition(t, r) {
    const n = zr(t.column, Ds(r), this._lines[t.lineNumber - 1], 0);
    return n
      ...
      *[Symbol.iterator]() {
        for (;;)
          if (o < l.length) {
            ...
            (o += 1), yield u;
          } else if (i < r.length) (s = r[i]), (l = n(s, t)), (o = 0), (i += 1);
          else break;
      }
    };
  }
  ...
  _validatePosition(t) {
    if (!ue.isIPosition(t)) throw new Error("bad position");
...
class qe {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new io(Be.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  computeUnicodeHighlights(t, r, n) {
    return je(this, void 0, void 0, function* () {
      ...
      return i
        ? ro.computeUnicodeHighlights(i, r, n)
        : {
            ranges: [],
            hasMore: !1,
  ...
  computeDiff(t, r, n, i) {
    return je(this, void 0, void 0, function* () {
      const s = this._getModel(t),
        o = this._getModel(r);
      return !s || !o ? null : qe.computeDiff(s, o, n, i);
    });
  }
      ...
      e: for (const u of t) {
        ...
        if (!!c) {
          for (const h of c.words(o))
            if (
              !(h === r || !isNaN(Number(h))) &&
              (l.add(h), l.size > qe._suggestionsLimit)
            )
              break e;
        }
      }
  ...
  navigateValueSet(t, r, n, i, s) {
    return je(this, void 0, void 0, function* () {
      ...
      return _r.INSTANCE.navigateValueSet(r, u, c, h, n);
    });
  }
  loadForeignModule(t, r, n) {
    ...
    return this._foreignModuleFactory
      ? ((this._foreignModule = this._foreignModuleFactory(o, r)),
        Promise.resolve(mr(this._foreignModule)))
...
typeof importScripts == "function" && (re.monaco = Qs());
let Pr = !1;
function la(e) {
  if (Pr) return;
  Pr = !0;
...
function Zr(e, t) {
  ...
  function v() {
    ...
    else for (n++; n < e.length && Ke(e.charCodeAt(n)); ) n++;
    if (n < e.length && e.charCodeAt(n) === 46)
      if ((n++, n < e.length && Ke(e.charCodeAt(n))))
        for (n++; n < e.length && Ke(e.charCodeAt(n)); ) n++;
    ...
    switch (C) {
      ...
      case 47:
        ...
        if (e.charCodeAt(n + 1) === 47) {
          for (n += 2; n < r && !lt(e.charCodeAt(n)); ) n++;
      ...
      case 45:
        if (
          ((i += String.fromCharCode(C)), n++, n === r || !Ke(e.charCodeAt(n)))
        )
          return (o = 16);
      case 48:
      case 49:
...
function ao(e, t, r) {
  var n, i, s, o, l;
  if (t) {
    for (o = t.offset, l = o + t.length, s = o; s > 0 && !li(e, s - 1); ) s--;
    for (var u = l; u < e.length && !li(e, u); ) u++;
    (i = e.substring(s, u)), (n = so(i, r));
  } else (i = e), (n = 0), (s = 0), (o = 0), (l = e.length);
  var c = oo(r, e),
    h = !1,
    f = 0,
    d;
  r.insertSpaces ? (d = ir(" ", r.tabSize || 4)) : (d = "	");
  var m = Zr(i, !1),
    v = !1;
  function p() {
    return c + ir(d, n + f);
...
function lo(e, t, r) {
  t === void 0 && (t = []), r === void 0 && (r = jt.DEFAULT);
  var n = null,
    i = [],
    s = [];
  function o(u) {
...
function Tr(e) {
  switch (e.type) {
    case "array":
      return e.children.map(Tr);
    case "object":
      for (
        var t = /* @__PURE__ */ Object.create(null), r = 0, n = e.children;
        r < n.length;
        r++
      ) {
        var i = n[r],
          s = i.children[1];
        s && (t[i.children[0].value] = Tr(s));
      }
      return t;
    case "null":
    case "string":
...
function ht(e, t) {
  ...
  if (Array.isArray(e)) {
    ...
    for (r = 0; r < e.length; r++) if (!ht(e[r], t[r])) return !1;
  } else {
    var i = [];
    for (n in e) i.push(n);
    i.sort();
    var s = [];
    for (n in t) s.push(n);
    if ((s.sort(), !ht(i, s))) return !1;
    for (r = 0; r < i.length; r++) if (!ht(e[i[r]], t[i[r]])) return !1;
  }
  return !0;
}
function fe(e) {
...
(function (e) {
  function t(n, i) {
    return (
      n === Number.MAX_VALUE && (n = qt.MAX_VALUE),
...
(function (e) {
  ...
  function r(n) {
    var i = n;
    return (
      L.defined(i) && H.is(i.range) && (L.string(i.uri) || L.undefined(i.uri))
    );
  }
  e.is = r;
})(vt || (vt = {}));
...
(function (e) {
  ...
  function r(n) {
    ...
    return (
      ...
      (H.is(i.targetSelectionRange) || L.undefined(i.targetSelectionRange)) &&
      (H.is(i.originSelectionRange) || L.undefined(i.originSelectionRange))
    );
  }
  e.is = r;
})(ci || (ci = {}));
...
(function (e) {
  ...
  function r(n) {
    var i = n;
    return H.is(i.range) && Er.is(i.color);
  }
  e.is = r;
})(fi || (fi = {}));
var hi;
...
(function (e) {
  ...
  function r(n) {
    var i = n;
    return L.defined(i) && vt.is(i.location) && L.string(i.message);
  }
  e.is = r;
})(Fr || (Fr = {}));
var me;
  ...
  function r(n) {
    ...
    return (
      ...
      (L.undefined(s.relatedInformation) ||
        L.typedArray(s.relatedInformation, Fr.is))
    );
  }
  e.is = r;
})(xe || (xe = {}));
...
(function (e) {
  ...
  function i(s) {
    var o = s;
    return we.is(o) && (nt.is(o.annotationId) || ie.is(o.annotationId));
  }
  e.is = i;
})(De || (De = {}));
var $t;
...
(function (e) {
  ...
  function r(n) {
    ...
    return (
      ...
      (i.annotationId === void 0 || ie.is(i.annotationId))
    );
  }
  e.is = r;
})(wt || (wt = {}));
    ...
    return (
      ...
      (n.documentChanges === void 0 ||
        n.documentChanges.every(function (i) {
          return L.string(i.kind) ? wt.is(i) || yt.is(i) || Ct.is(i) : $t.is(i);
        }))
    );
  }
  e.is = t;
...
var Lt = (function () {
  ...
  pi = (function () {
    function e(t) {
      (this._annotations =
        t === void 0 ? /* @__PURE__ */ Object.create(null) : t),
        (this._counter = 0),
        (this._size = 0);
    }
    return (
...
(function () {
  ...
  return (
      ...
      if (Wt.is(t)) {
        ...
        if (!n) {
          ...
          this._workspaceEdit.documentChanges.push(s),
            (n = new Lt(i, this._changeAnnotations)),
    ...
    (e.prototype.createFile = function (t, r, n) {
      ...
      var i;
      nt.is(r) || ie.is(r) ? (i = r) : (n = r);
      var s, o;
      if (
        (i === void 0
          ? (s = wt.create(t, n))
          : ((o = ie.is(i) ? i : this._changeAnnotations.manage(i)),
            (s = wt.create(t, n, o))),
        this._workspaceEdit.documentChanges.push(s),
        o !== void 0)
      )
    ...
    (e.prototype.renameFile = function (t, r, n, i) {
      ...
      var s;
      nt.is(n) || ie.is(n) ? (s = n) : (i = n);
      var o, l;
      if (
        (s === void 0
          ? (o = yt.create(t, r, i))
          : ((l = ie.is(s) ? s : this._changeAnnotations.manage(s)),
            (o = yt.create(t, r, i, l))),
...
(function (e) {
  function t(r) {
    var n = r;
    return L.objectLiteral(r) && Me.is(n.kind) && L.string(n.value);
  }
  e.is = t;
})(Ir || (Ir = {}));
var de;
...
(function (e) {
  ...
  function r(n) {
    ...
    return (
      L.defined(i) &&
      L.typedArray(i.diagnostics, xe.is) &&
...
(function (e) {
  ...
  function r(n) {
    ...
    return (
      i &&
      L.string(i.title) &&
      (i.diagnostics === void 0 || L.typedArray(i.diagnostics, xe.is)) &&
...
(function (e) {
  ...
  function r(n) {
    ...
    return (
      L.defined(i) &&
      H.is(i.range) &&
      (L.undefined(i.command) || bt.is(i.command))
    );
  }
  e.is = r;
})(Ii || (Ii = {}));
...
(function (e) {
  ...
  function r(n) {
    var i = n;
    return (
      i !== void 0 && H.is(i.range) && (i.parent === void 0 || e.is(i.parent))
    );
  }
  e.is = r;
})(zt || (zt = {}));
...
(function (e) {
  ...
  function n(s, o) {
    for (
      ...
      if (m <= c) l = l.substring(0, d) + f.newText + l.substring(m, l.length);
...
var Gt = class {
    ...
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 &&
          (this._lineOffsets = Ui(this._content, !0)),
        this._lineOffsets
      );
    }
    positionAt(e) {
...
var Mo = (function () {
    ...
    return (
      ...
      (e.prototype.include = function (t) {
        return (
          (this.focusOffset === -1 || ha(t, this.focusOffset)) &&
          t !== this.exclude
        );
      }),
...
var da = (function () {
  ...
  return (
    (e.prototype.getNodeFromOffset = function (t, r) {
      if ((r === void 0 && (r = !1), this.root)) return ho(this.root, t, r);
    }),
...
function ee(e, t, r, n) {
  ...
  function s() {
    function h(I) {
      return (
        i.type === I || (I === "integer" && i.type === "number" && i.isInteger)
      );
    }
    if (
    ...
    var N = function (I, B) {
      for (var Q = [], W = void 0, E = 0, M = I; E < M.length; E++) {
        var F = M[E],
          V = oe(F),
          R = new le(),
          U = n.newSub();
        if ((ee(i, V, R, U), R.hasProblems() || Q.push(V), !W))
          W = { schema: V, validationResult: R, matchingSchemas: U };
        else if (!B && !R.hasProblems() && !W.validationResult.hasProblems())
          W.matchingSchemas.merge(U),
            (W.validationResult.propertiesMatches += R.propertiesMatches),
            (W.validationResult.propertiesValueMatches +=
              R.propertiesValueMatches);
        else {
          var q = R.compare(W.validationResult);
          q > 0
            ? (W = { schema: V, validationResult: R, matchingSchemas: U })
            : q === 0 &&
              (W.matchingSchemas.merge(U),
              W.validationResult.mergeEnumValues(R));
        }
      }
      return (
        Q.length > 1 &&
        ...
        W &&
          (r.merge(W.validationResult),
          (r.propertiesMatches += W.validationResult.propertiesMatches),
          (r.propertiesValueMatches +=
            W.validationResult.propertiesValueMatches),
          n.merge(W.matchingSchemas)),
        Q.length
      );
    };
    ...
    var x = function (I) {
      ...
      w = function (I, B, Q) {
        var W = oe(I),
          E = new le(),
          M = n.newSub();
        ee(i, W, E, M), n.merge(M), E.hasProblems() ? Q && x(Q) : B && x(B);
      },
      b = oe(t.if);
    if ((b && w(b, oe(t.then), oe(t.else)), Array.isArray(t.enum))) {
      for (var y = $e(i), _ = !1, k = 0, T = t.enum; k < T.length; k++) {
        var P = T[k];
        if (ht(y, P)) {
          _ = !0;
          break;
        ...
        case "uri-reference":
          {
            ...
            if (!h.value) p = D("uriEmpty", "URI expected.");
              ...
              g
                ? !g[2] &&
                  f.format === "uri" &&
                  (p = D("uriSchemeMissing", "URI with a scheme is expected."))
  ...
  function u(h, f, d, m) {
    if (Array.isArray(f.items)) {
      for (var v = f.items, p = 0; p < v.length; p++) {
        var g = v[p],
          ...
          C = h.items[p];
        C
          ? (ee(C, A, S, m), d.mergePropertyMatch(S))
    ...
    if (y) {
      var _ = h.items.some(function (P) {
        var I = new le();
        return ee(P, y, I, Ur.instance), !I.hasProblems();
      });
      _ ||
        d.problems.push({
          location: { offset: h.offset, length: h.length },
  ...
  function c(h, f, d, m) {
    ...
    if (Array.isArray(f.required))
      for (var N = 0, x = f.required; N < x.length; N++) {
        var w = x[N];
        if (!v[w]) {
          var b = h.parent && h.parent.type === "property" && h.parent.keyNode,
            y = b
    ...
    var _ = function (en) {
      for (var Yt = p.indexOf(en); Yt >= 0; )
        p.splice(Yt, 1), (Yt = p.indexOf(en));
    };
    if (f.properties)
    ...
    if (f.patternProperties)
      for (var Q = 0, W = Object.keys(f.patternProperties); Q < W.length; Q++)
        for (
          var E = W[Q], M = Bt(E), F = 0, V = p.slice(0);
          F < V.length;
          F++
        ) {
          var w = V[F];
    ...
    if (typeof f.additionalProperties == "object")
      ...
      for (var q = 0, ye = p; q < ye.length; q++) {
        var w = ye[q],
          I = v[w];
        if (I) {
          var S = I.parent;
          d.problems.push({
            ...
            message:
              f.errorMessage ||
              D("DisallowedExtraPropWarning", "Property {0} is not allowed.", w)
          });
        }
      }
    if (
      ...
      for (var ne = 0, ge = Object.keys(f.dependencies); ne < ge.length; ne++) {
        var C = ge[ne],
          Je = v[C];
        if (Je) {
          var Ce = f.dependencies[C];
          if (Array.isArray(Ce))
            for (var Xt = 0, Xr = Ce; Xt < Xr.length; Xt++) {
              var Qr = Xr[Xt];
              v[Qr]
    ...
    var Yr = oe(f.propertyNames);
    if (Yr)
      for (var Qt = 0, Kr = h.properties; Qt < Kr.length; Qt++) {
        var wa = Kr[Qt],
          C = wa.keyNode;
        C && ee(C, Yr, d, Ur.instance);
      }
  }
}
function To(e, t) {
  ...
  function u(w, b, y, _, k) {
    if ((k === void 0 && (k = me.Error), r.length === 0 || y !== n)) {
      var T = H.create(e.positionAt(y), e.positionAt(_));
      r.push(xe.create(T, w, k, b, e.languageId)), (n = y);
    }
  }
  ...
  function h() {
    switch (s.getTokenError()) {
      ...
      case 5:
        return (
          c(
            D("InvalidEscapeCharacter", "Invalid escape character in string."),
  ...
  function d(w) {
    if (s.getToken() === 3) {
      var b = new No(w, s.getTokenOffset());
      l();
      for (var y = !1; s.getToken() !== 4 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          y || c(D("ValueExpected", "Value expected"), $.ValueExpected);
        ...
        } else y && c(D("ExpectedComma", "Expected comma"), $.CommaExpected);
        var k = C(b);
        k
          ? b.items.push(k)
          : c(
  ...
  var m = new ar(void 0, 0, 0);
  function v(w, b) {
    var y = new ko(w, s.getTokenOffset(), m),
      _ = g(y);
    if (!_)
      if (s.getToken() === 16) {
        c(
        ...
        var k = new ar(y, s.getTokenOffset(), s.getTokenLength());
    ...
    if (
      ...
      (c(D("ColonExpected", "Colon expected"), $.ColonExpected),
      s.getToken() === 10 &&
    ...
    return P
      ...
      : c(D("ValueExpected", "Value expected"), $.ValueExpected, y, [], [2, 5]);
  }
  function p(w) {
    if (s.getToken() === 1) {
      ...
      for (var _ = !1; s.getToken() !== 2 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          _ ||
            c(D("PropertyExpected", "Property expected"), $.PropertyExpected);
        ...
        } else _ && c(D("ExpectedComma", "Expected comma"), $.CommaExpected);
        var T = v(b, y);
        T
          ? b.properties.push(T)
          : c(
  ...
  function g(w) {
    if (s.getToken() === 10) {
      var b = new ar(w, s.getTokenOffset());
      return (b.value = s.getTokenValue()), f(b, !0);
    }
  }
  function A(w) {
    if (s.getToken() === 11) {
      var b = new Lo(w, s.getTokenOffset());
  ...
  function S(w) {
    switch (s.getToken()) {
      case 7:
        return f(new Ao(w, s.getTokenOffset()), !0);
      case 8:
        return f(new Bi(w, !0, s.getTokenOffset()), !0);
      case 9:
        return f(new Bi(w, !1, s.getTokenOffset()), !0);
      default:
        return;
    }
  }
  ...
  return (
    x !== 17 &&
      ...
      N
        ? s.getToken() !== 17 &&
          c(D("End of file expected", "End of file expected."), $.Undefined)
        : c(
...
`,
        ...
        var l = o[s];
        (i += n + JSON.stringify(l) + ": " + Br(e[l], n, r)),
          s < o.length - 1 && (i += ","),
          (i += `
`);
      }
  ...
  Eo = (function () {
    ...
    return (
      ...
      (e.prototype.doComplete = function (t, r, n) {
        ...
        if (this.isInComment(t, u ? u.offset : 0, l)) return Promise.resolve(s);
          ...
          .then(function (p) {
            ...
            if (u && u.type === "object") {
              ...
              x.forEach(function (_) {
                (!C || C !== _) && (m[_.keyNode.value] = Dr.create("__"));
              });
              var w = "";
              ...
              Object.keys(h).forEach(function (p) {
                ...
                if (
                  ...
                  var A = {
                    ...
                    documentation:
                      l.fromMarkup(g.markdownDescription) || g.description || ""
                  };
                  g.suggestSortText !== void 0 &&
                    (A.sortText = g.suggestSortText),
                    A.insertText &&
                      pt(A.insertText, "$1".concat(s)) &&
                      (A.command = {
                        title: "Suggest",
      ...
      (e.prototype.getValueCompletions = function (t, r, n, i, s, o, l) {
        ...
        if (n && (c !== void 0 || n.type === "array")) {
              ...
              if (n.type === "array" && g.schema.items)
                if (Array.isArray(g.schema.items)) {
                  ...
                  A < g.schema.items.length &&
                    this.addSchemaValueCompletions(g.schema.items[A], d, o, l);
                } else this.addSchemaValueCompletions(g.schema.items, d, o, l);
              if (c !== void 0) {
                var S = !1;
          ...
          c === "$schema" && !n.parent && this.addDollarSchemaCompletions(d, o),
            l.boolean &&
...
` + C
      ...
      (e.prototype.collectTypes = function (t, r) {
        if (!(Array.isArray(t.enum) || ke(t.const))) {
          var n = t.type;
          Array.isArray(n)
      ...
      (e.prototype.addFillerValueCompletions = function (t, r, n) {
        t.object &&
          n.add({
            ...
            insertTextFormat: Y.Snippet,
            detail: sr("defaults.object", "New object"),
            documentation: ""
          }),
          t.array &&
            n.add({
              ...
              insertText: this.getInsertTextForGuessedValue([], r),
              insertTextFormat: Y.Snippet,
              detail: sr("defaults.array", "New array"),
              documentation: ""
            });
      }),
        ...
        if (r) {
          if (Array.isArray(r.defaultSnippets)) {
            if (r.defaultSnippets.length === 1) {
              ...
              ke(c) && (l = this.getInsertTextForSnippetValue(c, ""));
            }
          ...
          if (
            ...
            Array.isArray(r.examples) &&
              r.examples.length &&
              (l || (l = this.getInsertTextForGuessedValue(r.examples[0], "")),
              (u += r.examples.length)),
            u === 0)
          ) {
            var h = Array.isArray(r.type) ? r.type[0] : r.type;
            switch (
              (h || (r.properties ? (h = "object") : r.items && (h = "array")),
              h)
            ) {
              case "boolean":
                l = "$1";
...
\r\v":{[,]}`.indexOf(i.charAt(n)) === -1;
      ...
      (e.prototype.findItemAtOffset = function (t, r, n) {
        for (
          var i = rt(r.getText(), !0), s = t.items, o = s.length - 1;
          o >= 0;
          o--
        ) {
          var l = s[o];
      ...
      (e.prototype.doesSupportMarkdown = function () {
        if (!ke(this.supportsMarkdown)) {
          ...
          this.supportsMarkdown =
            ...
            t.completionItem.documentationFormat.indexOf(Me.Markdown) !== -1;
        }
        return this.supportsMarkdown;
      }),
      (e.prototype.doesSupportsCommitCharacters = function () {
        if (!ke(this.supportsCommitCharacters)) {
          var t =
            this.clientCapabilities.textDocument &&
            this.clientCapabilities.textDocument.completion;
          this.supportsCommitCharacters =
            t && t.completionItem && !!t.completionItem.commitCharactersSupport;
        }
    ...
    return (
      (e.prototype.configure = function (t) {
        t &&
          ...
          (this.commentSeverity = t.allowComments ? void 0 : me.Error));
      }),
      (e.prototype.doValidation = function (t, r, n, i) {
        ...
        var o = [],
          ...
          c = function (d) {
            var m =
                n != null && n.trailingCommas ? kt(n.trailingCommas) : me.Error,
              v = n != null && n.comments ? kt(n.comments) : s.commentSeverity,
              p =
                n != null && n.schemaValidation
                  ? kt(n.schemaValidation)
                  : me.Warning,
              g =
                n != null && n.schemaRequest ? kt(n.schemaRequest) : me.Warning;
            if (d) {
              if (d.errors.length && r.root && g) {
                ...
                if (S && S.keyNode.value === "$schema") {
                  ...
                  u(xe.create(N, d.errors[0], g, $.SchemaResolveError));
                } else {
                  var N = H.create(
              ...
              ma(d.schema) && (v = void 0), ga(d.schema) && (m = void 0);
            }
            for (var w = 0, b = r.syntaxErrors; w < b.length; w++) {
              var y = b[w];
              if (y.code === $.TrailingComma) {
            ...
            if (typeof v == "number") {
              ...
              r.comments.forEach(function (k) {
                u(xe.create(k, _, v, $.CommentNotPermitted));
              });
            }
            return o;
          };
        if (i) {
          var h = i.id || "schemaservice://untitled/" + Ro++,
...
function ma(e) {
  if (e && typeof e == "object") {
    if (Ne(e.allowComments)) return e.allowComments;
    if (e.allOf)
...
function ga(e) {
  if (e && typeof e == "object") {
    if (Ne(e.allowTrailingCommas)) return e.allowTrailingCommas;
    var t = e;
    if (Ne(t.allowsTrailingCommas)) return t.allowsTrailingCommas;
    if (e.allOf)
...
function X(e) {
  return e < $i
    ...
    : e <= Oo
      ? e - $i
      : (e < xt && (e += xt - Uo), e >= xt && e <= jo ? e - xt + 10 : 0);
}
function Bo(e) {
  if (e[0] === "#")
    switch (e.length) {
    ...
    (e.prototype.findDocumentSymbols = function (t, r, n) {
      ...
      if (
        (l === "vscode://defaultsettings/keybindings.json" ||
          pt(l.toLowerCase(), "/user/keybindings.json")) &&
        s.type === "array"
      ) {
            ...
            for (var d = 0, m = f.properties; d < m.length; d++) {
              ...
              if (v.keyNode.value === "key" && v.valueNode) {
                ...
                if (
                  ...
                  return (
                    n && n.onResultLimitExceeded && n.onResultLimitExceeded(l),
                    u
                  );
              }
            }
...
for (Wi in qr.schemas) {
  Mt = qr.schemas[Wi];
  for (et in Mt.properties)
    (Pt = Mt.properties[et]),
      typeof Pt == "boolean" && (Pt = Mt.properties[et] = {}),
      (lr = $o[et]),
      lr
        ? (Pt.description = lr)
        : console.log(
            "".concat(et, ": localize('schema.json.").concat(et, `', "")`)
          );
}
var Mt, Pt, lr, et, Wi, pa;
pa = (() => {
  var e = {
      470: n => {
        function i(l) {
        ...
        var o = {
          ...
          relative: function (l, u) {
            if (
              (i(l), i(u), l === u || (l = o.resolve(l)) === (u = o.resolve(u)))
            )
              return "";
            ...
            for (
              ...
              if (g === v) {
                if (m > v) {
                  ...
                  f > v &&
                    (l.charCodeAt(c + g) === 47 ? (p = g) : g === 0 && (p = 0));
                break;
              }
      ...
      447: (n, i, s) => {
            ...
            function E(M, F, V, R, U, q) {
              q === void 0 && (q = !1),
                typeof M == "object"
                  ...
                  : ((this.scheme = (function (ye, ne) {
                      return ye || ne ? ye : "file";
                    })(M, q)),
                    (this.authority = F || p),
                    (this.path = (function (ye, ne) {
                      switch (ye) {
                        case "https":
                        case "http":
                        case "file":
            ...
            return (
              ...
              (E.prototype.with = function (M) {
                ...
                return (
                  ...
                  q === void 0 ? (q = this.fragment) : q === null && (q = p),
                  F === this.scheme &&
                  V === this.authority &&
                  R === this.path &&
                  U === this.query &&
        ...
        function _(E, M) {
          ...
          if (
            ...
            var ge = U.indexOf("@");
            if (ge !== -1) {
              var Je = U.substr(0, ge);
              (U = U.substr(ge + 1)),
                (ge = Je.indexOf(":")) === -1
                  ? (V += F(Je, !1))
                  : ((V += F(Je.substr(0, ge), !1)),
                    (V += ":"),
                    (V += F(Je.substr(ge + 1), !1))),
                (V += "@");
            }
            (ge = (U = U.toLowerCase()).indexOf(":")) === -1
              ? (V += F(U, !1))
              : ((V += F(U.substr(0, ge), !1)), (V += U.substr(ge)));
          }
          if (q) {
            if (
              q.length >= 3 &&
        ...
        (function (E) {
          (E.joinPath = function (M) {
            for (var F = [], V = 1; V < arguments.length; V++)
              F[V - 1] = arguments[V];
            return M.with({ path: W.join.apply(W, Q([M.path], F, !1)) });
          }),
            (E.resolvePath = function (M) {
              for (var F = [], V = 1; V < arguments.length; V++)
                F[V - 1] = arguments[V];
              var R = M.path || "/";
              return M.with({ path: W.resolve.apply(W, Q([R], F, !1)) });
            }),
    ...
    function e(t, r) {
      ...
      try {
        for (var n = 0, i = t; n < i.length; n++) {
          ...
          o || (s = s.substring(1)),
            s.length > 0 &&
              (s[0] === zo && (s = s.substring(1)),
              this.globWrappers.push({
                regexp: Wo("**/" + s, { extended: !0, globstar: !0 }),
                include: o
              }));
        }
        this.uris = r;
  ...
  Jo = (function () {
    function e(t, r, n) {
      (this.service = t),
        ...
        (this.anchors = void 0),
        n && (this.unresolvedSchema = this.service.promise.resolve(new ct(n)));
    }
    return (
    ...
    return (
      ...
      (e.prototype.loadSchema = function (t) {
        if (!this.requestService) {
          ...
          return this.promise.resolve(new ct({}, [r]));
        }
      ...
      (e.prototype.traverseNodes = function (t, r) {
        ...
        for (
          ...
          n.has(u) ||
            ...
            s(u.definitions, u.properties, u.patternProperties, u.dependencies),
      ...
      (e.prototype.getSchemaFromProperty = function (t, r) {
        var n, i;
        if (
          ((n = r.root) === null || n === void 0 ? void 0 : n.type) === "object"
        )
          for (var s = 0, o = r.root.properties; s < o.length; s++) {
            var l = o[s];
            if (
              l.keyNode.value === "$schema" &&
              ((i = l.valueNode) === null || i === void 0 ? void 0 : i.type) ===
                "string"
            ) {
      ...
      (e.prototype.getSchemaForResource = function (t, r) {
        ...
        return (
          (this.cachedSchemaForResource = { resource: t, resolvedSchema: o }), o
        );
      }),
      ...
      (e.prototype.getMatchingSchemas = function (t, r, n) {
        if (n) {
          var i = n.id || "schemaservice://untitled/matchingSchemas/" + Xo++,
...
function Qo(e) {
  try {
    return at.parse(e).with({ fragment: null, query: null }).toString(!0);
  } catch {
    return e;
  }
}
    ...
    switch (l) {
      ...
      case 3: {
        var c = e.positionAt(o.getTokenOffset()).line,
          h = { startLine: c, endLine: c, kind: l === 1 ? "object" : "array" };
        i.push(h);
        break;
      }
      case 2:
      ...
      case 13: {
        ...
        o.getTokenError() === 1 && c + 1 < e.lineCount
          ...
          : c < m &&
            (u({ startLine: c, endLine: m, kind: dt.Comment }), (s = c));
        break;
      }
      case 12: {
        ...
        if (p) {
          ...
          if (p[1]) {
            ...
            for (var g = i.length - 1; g >= 0 && i[g].kind !== dt.Region; ) g--;
            if (g >= 0) {
              var h = i[g];
              (i.length = g),
                d > h.startLine &&
...
function Ko(e, t, r) {
  function n(l) {
    ...
    for (var v = void 0, p = h.length - 1; p >= 0; p--) v = zt.create(h[p], v);
    return v || (v = zt.create(H.create(l, l))), v;
  }
  function i(l, u) {
    return H.create(e.positionAt(l), e.positionAt(u));
  }
  var s = rt(e.getText(), !0);
  function o(l, u) {
    s.setPosition(l);
    var c = s.scan();
...
function al(e) {
  var t = e.promiseConstructor || Promise,
    r = new Zo(e.schemaRequestService, e.workspaceContext, t);
  r.setSchemaContributions(qr);
  var n = new Eo(r, e.contributions, t, e.clientCapabilities),
    i = new Fo(r, e.contributions, t),
    s = new qo(r),
    o = new Do(r, t);
  return {
    ...
    format: function (l, u, c) {
      ...
      var m = {
        ...
        insertFinalNewline: (c == null ? void 0 : c.insertFinalNewline) === !0,
        eol: `
`
      };
      return po(l.getText(), h, m).map(function (v) {
        return we.replace(
          H.create(l.positionAt(v.offset), l.positionAt(v.offset + v.length)),
          v.content
        );
      });
    }
...
var sl = class {
    ...
    _getTextDocument(e) {
      ...
      for (let r of t)
        if (r.uri.toString() === e)
          return Rr.create(e, this._languageId, r.version, r.getValue());
      return null;
    }
  },
  ol = "/".charCodeAt(0),
  ur = ".".charCodeAt(0);
function ll(e) {
  return e.charCodeAt(0) === ol;
}
function ul(e, t) {
  if (ll(t)) {
    const r = at.parse(e),
      n = t.split("/");
    return r.with({ path: ba(n) }).toString();
  }
  return cl(e, t);
}
function ba(e) {
  ...
  for (const n of e)
    n.length === 0 ||
      (n.length === 1 && n.charCodeAt(0) === ur) ||
      (n.length === 2 && n.charCodeAt(0) === ur && n.charCodeAt(1) === ur
        ? t.pop()
        : t.push(n));
