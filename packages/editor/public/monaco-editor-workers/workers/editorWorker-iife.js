...
` +
  ...
  function ut(e) {
    if (e instanceof Error) {
      ...
      return {
        ...
        message: r,
        stack: s,
        noTelemetry: ae.isErrorNoTelemetry(e)
      };
    }
    return e;
  }
  ...
  (function (e) {
    function t(p) {
      return (
        p && typeof p == "object" && typeof p[Symbol.iterator] == "function"
      );
    }
    e.is = t;
    ...
    e.first = l;
    function u(p, S) {
      for (const b of p) if (S(b)) return !0;
      return !1;
    }
    e.some = u;
    function c(p, S) {
      for (const b of p) if (S(b)) return b;
    }
    e.find = c;
    function* f(p, S) {
      for (const b of p) S(b) && (yield b);
    }
    e.filter = f;
    function* h(p, S) {
      let b = 0;
      for (const g of p) yield S(g, b++);
    }
    e.map = h;
    function* d(...p) {
      for (const S of p) for (const b of S) yield b;
    }
    e.concat = d;
    function* C(p) {
      for (const S of p) for (const b of S) yield b;
    ...
    function v(p, S, b) {
      let g = b;
      for (const m of p) g = S(g, m);
      return g;
    }
    e.reduce = v;
    function A(p, S) {
      let b = 0;
      for (const g of p) S(g, b++);
    }
    e.forEach = A;
    function* M(p, S, b = p.length) {
      for (
        S < 0 && (S += p.length),
          b < 0 ? (b += p.length) : b > p.length && (b = p.length);
        S < b;
        S++
      )
        yield p[S];
    ...
    function y(p, S, b = (g, m) => g === m) {
      ...
      for (;;) {
        const w = g.next(),
          N = m.next();
        if (w.done !== N.done) return !1;
        if (w.done) return !0;
        if (!b(w.value, N.value)) return !1;
      }
    }
    e.equals = y;
  })(Ce || (Ce = {}));
  ...
  let U;
  typeof B.vscode < "u" && typeof B.vscode.process < "u"
    ? (U = B.vscode.process)
    : typeof process < "u" && (U = process);
  const jn =
    typeof ((Ve = U == null ? void 0 : U.versions) === null || Ve === void 0
      ? void 0
      : Ve.electron) == "string" &&
    (U == null ? void 0 : U.type) === "renderer";
  if (typeof navigator == "object" && !jn)
    (Q = navigator.userAgent),
      (Te = Q.indexOf("Windows") >= 0),
      (Be = Q.indexOf("Macintosh") >= 0),
      (Q.indexOf("Macintosh") >= 0 ||
        Q.indexOf("iPad") >= 0 ||
        Q.indexOf("iPhone") >= 0) &&
        !!navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0,
      (Ue = Q.indexOf("Linux") >= 0),
      (ft = !0),
      Gn({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
      (Le = fe),
      (Ie = Le);
  else if (typeof U == "object") {
    (Te = U.platform === "win32"),
      (Be = U.platform === "darwin"),
      (Ue = U.platform === "linux"),
      Ue && !!U.env.SNAP && U.env.SNAP_REVISION,
      U.env.CI || U.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
      (Le = fe),
      (Ie = fe);
    ...
    if (e)
      try {
        ...
        (Le = t.locale), (Ie = r || fe), (On = t._translationsConfigFile);
      } catch {}
  ...
  ft && B.importScripts;
  const O = Q,
    Zn = typeof B.postMessage == "function" && !B.importScripts;
  (() => {
    if (Zn) {
      const e = [];
      B.addEventListener("message", r => {
      ...
      return r => {
        const s = ++t;
        e.push({ id: s, callback: r }),
          B.postMessage({ vscodeScheduleAsyncWork: s }, "*");
      };
    }
    return e => setTimeout(e);
  })();
  const Yn = !!(O && O.indexOf("Chrome") >= 0);
  O && O.indexOf("Firefox") >= 0,
    !Yn && O && O.indexOf("Safari") >= 0,
    O && O.indexOf("Edg/") >= 0,
    O && O.indexOf("Android") >= 0;
  const Xn = B.performance && typeof B.performance.now == "function";
  class Ne {
    constructor(t) {
      (this._highResolution = Xn && t),
  ...
  (function (e) {
    ...
    function t(b) {
      return (g, m = null, w) => {
        ...
        return (
          (L = b(
            _ => {
              if (!N) return L ? L.dispose() : (N = !0), g.call(m, _);
            },
            null,
            w
          )),
    ...
    function o(...b) {
      return (g, m = null, w) =>
        Hn(...b.map(N => N(L => g.call(m, L), null, w)));
    }
    e.any = o;
    function l(b, g, m, w) {
      let N = m;
    ...
    function c(b, g, m = 100, w = !1, N, L) {
      ...
      const b1 = {
        ...
        De = new j(b1);
      return L == null || L.add(De), De.event;
    }
    e.debounce = c;
    ...
    e.latch = f;
    function h(b, g, m) {
      return [e.filter(b, g, m), e.filter(b, w => !g(w), m)];
    }
    e.split = h;
    function d(b, g = !1, m = []) {
      let w = m.slice(),
    ...
    class C {
      constructor(g) {
        (this.event = g), (this.disposables = new te());
      }
      map(g) {
    ...
    function A(b, g, m = w => w) {
      const w = (...E) => _.fire(m(...E)),
        N = () => b.on(g, w),
        L = () => b.removeListener(g, w),
        _ = new j({ onFirstListenerAdd: N, onLastListenerRemove: L });
      return _.event;
    }
    e.fromNodeEventEmitter = A;
    function M(b, g, m = w => w) {
      const w = (...E) => _.fire(m(...E)),
        N = () => b.addEventListener(g, w),
        L = () => b.removeEventListener(g, w),
        _ = new j({ onFirstListenerAdd: N, onLastListenerRemove: L });
      return _.event;
    }
    ...
    function y(b, g) {
      let m = null;
      function w(L) {
        m == null || m.dispose(), (m = new te()), g(L, m);
      }
      w(void 0);
      const N = b(L => w(L));
      return _e(() => {
    ...
    class p {
      constructor(g, m) {
        ...
        (this.emitter = new j(w)), m && m.add(this.emitter);
      }
      beginUpdate(g) {
        this._counter++;
      }
  ...
  class ve {
    constructor(t) {
      (this._listenerCount = 0),
        ...
        (this._name = `${t}_${ve._idPool++}`);
    }
    start(t) {
      (this._stopWatch = new Ne(!0)), (this._listenerCount = t);
    }
    stop() {
      if (this._stopWatch) {
  ...
  class He {
    ...
    static create() {
      var t;
      return new He((t = new Error().stack) !== null && t !== void 0 ? t : "");
    }
    print() {
      console.warn(
        this.value
...
`)
  ...
  class j {
      ...
      return (
        this._event ||
          (this._event = (t, r, s) => {
            ...
            const f = new Jn(t, r, c),
              h = this._listeners.push(f);
            l &&
            ...
            return (
              s instanceof te ? s.add(d) : Array.isArray(s) && s.push(d), d
            );
          }),
        this._event
      );
    ...
    fire(t) {
      var r, s;
      if (this._listeners) {
        this._deliveryQueue || (this._deliveryQueue = new er());
  ...
  class Kn {
    ...
    push(t, r, s) {
      this._queue.push(new tr(t, r, s));
    }
    clear(t) {
      const r = new pe();
      for (const s of this._queue) s.emitter !== t && r.push(s);
      this._queue = r;
    }
    deliver() {
  ...
  function We(e) {
    const t = [];
    for (const r of nr(e)) typeof e[r] == "function" && t.push(r);
    return t;
  }
  function rr(e, t) {
    const r = i =>
      ...
      s = {};
    for (const i of e) s[i] = r(i);
    return s;
  }
  function sr(e, t = "Unreachable") {
    throw new Error(t);
  }
  class ir {
    constructor(t) {
  ...
  function cr(e, t = e.length - 1) {
    for (let r = t; r >= 0; r--) {
      const s = e.charCodeAt(r);
      if (s !== 32 && s !== 9) return r;
    }
    return -1;
  }
  function gt(e) {
  ...
  (mt = z),
    (z.ambiguousCharacterData = new dt(() =>
      JSON.parse(
    ...
    (z.cache = new ir(e => {
      ...
      function r(c, f) {
        const h = new Map(c);
        for (const [d, C] of f) h.set(d, C);
        return h;
      }
      function s(c, f) {
        if (!c) return f;
        const h = new Map();
        for (const [d, C] of c) f.has(d) && h.set(d, C);
        return h;
      }
      const i = mt.ambiguousCharacterData.getValue();
    ...
    (z._locales = new dt(() =>
      Object.keys(z.ambiguousCharacterData.getValue()).filter(
        e => !e.startsWith("_")
      )
    ));
  class Z {
    ...
    static getData() {
      return this._data || (this._data = new Set(Z.getRawData())), this._data;
    }
    static isInvisibleCharacter(t) {
      return Z.getData().has(t);
    }
  ...
  class pr {
    ...
    sendMessage(t, r) {
      ...
      return new Promise((i, a) => {
        (this._pendingReplies[s] = { resolve: i, reject: a }),
          this._send(new br(this._workerId, s, t, r));
      });
    }
    listen(t, r) {
      let s = null;
      const i = new j({
        onFirstListenerAdd: () => {
          (s = String(++this._lastSentReq)),
            ...
            this._send(new wr(this._workerId, s, t, r));
        },
        onLastListenerRemove: () => {
          this._pendingEmitters.delete(s),
            this._send(new _r(this._workerId, s)),
            (s = null);
        }
      });
      return i.event;
    ...
    _handleRequestMessage(t) {
      ...
      this._handler.handleMessage(t.method, t.args).then(
        i => {
          this._send(new bt(this._workerId, r, i, void 0));
        },
        i => {
          i.detail instanceof Error && (i.detail = ut(i.detail)),
            this._send(new bt(this._workerId, r, void 0, ut(i)));
        }
      );
    }
    _handleSubscribeEventMessage(t) {
      const r = t.req,
        s = this._handler.handleEvent(
          ...
          this._send(new Cr(this._workerId, r, i));
        });
  ...
  function wt(e) {
    return e[0] === "o" && e[1] === "n" && gt(e.charCodeAt(2));
  }
  function Ct(e) {
    return /^onDynamic/.test(e) && gt(e.charCodeAt(9));
  }
  function Lr(e, t, r) {
    const s = o =>
        function () {
  ...
  class Nr {
    ...
    _handleMessage(t, r) {
      if (t === gr) return this.initialize(r[0], r[1], r[2], r[3]);
    ...
    initialize(t, r, s, i) {
      ...
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(l)),
          Promise.resolve(We(this._requestHandler)))
        : (r &&
  ...
  function vr(e, t) {
    t = _t(149417, t);
    for (let r = 0, s = e.length; r < s; r++) t = _t(e.charCodeAt(r), t);
    return t;
  }
  class pt {
    constructor(t) {
    ...
    getElements() {
      ...
      for (let s = 0, i = t.length; s < i; s++) r[s] = t.charCodeAt(s);
      return r;
    }
  }
  function Sr(e, t, r) {
    return new X(new pt(e), new pt(t)).ComputeDiff(r).changes;
  }
  class oe {
    static Assert(t, r) {
  ...
  class X {
    constructor(t, r, s = null) {
      ...
      const [i, a, o] = X._getElements(t),
        [l, u, c] = X._getElements(r);
    ...
    static _getElements(t) {
      ...
      if (X._isStringArray(r)) {
        const s = new Int32Array(r.length);
        for (let i = 0, a = r.length; i < a; i++) s[i] = vr(r[i], 0);
        return [r, s, !0];
      }
    ...
    ElementsAreStrictEqual(t, r) {
      ...
      const s = X._getStrictElement(this._originalSequence, t),
        i = X._getStrictElement(this._modifiedSequence, r);
      return s === i;
    }
    ...
    ComputeDiffRecursive(t, r, s, i, a) {
      for (a[0] = !1; t <= r && s <= i && this.ElementsAreEqual(t, s); )
        t++, s++;
      for (; r >= t && i >= s && this.ElementsAreEqual(r, i); ) r--, i--;
      if (t > r || s > i) {
        let h;
        return (
          s <= i
      ...
      const o = [0],
        l = [0],
        u = this.ComputeRecursionPoint(t, r, s, i, o, l, a),
        c = o[0],
        f = l[0];
      if (u !== null) return u;
      if (!a[0]) {
        ...
        return (
          a[0]
            ? (d = [new Y(c + 1, r - (c + 1) + 1, f + 1, i - (f + 1) + 1)])
            : (d = this.ComputeDiffRecursive(c + 1, r, f + 1, i, a)),
          this.ConcatenateChanges(h, d)
        );
      }
      return [new Y(t, r - t + 1, s, i - s + 1)];
    }
    WALKTRACE(t, r, s, i, a, o, l, u, c, f, h, d, C, v, A, M, R, P) {
      let y = null,
        p = null,
        S = new Lt(),
        b = r,
      ...
      do {
        ...
        L === b || (L < g && c[L - 1] < c[L + 1])
          ? ((h = c[L + 1]),
            (v = h - m - i),
            h < w && S.MarkNextChange(),
            (w = h),
            S.AddModifiedElement(h + 1, v),
            (m = L + 1 - t))
          : ((h = c[L - 1] + 1),
            (v = h - m - i),
            h < w && S.MarkNextChange(),
            (w = h - 1),
            S.AddOriginalElement(h, v + 1),
            (m = L - 1 - t)),
          N >= 0 &&
      ...
      if (((y = S.getReverseChanges()), P[0])) {
        ...
        if (y !== null && y.length > 0) {
          ...
          (L = Math.max(L, E.getOriginalEnd())),
            (_ = Math.max(_, E.getModifiedEnd()));
        }
        p = [new Y(L, d - L + 1, _, A - _ + 1)];
      } else {
        (S = new Lt()),
          (b = o),
          (g = l),
        ...
        do {
          ...
          L === b || (L < g && f[L - 1] >= f[L + 1])
            ? ((h = f[L + 1] - 1),
              ...
              h > w && S.MarkNextChange(),
              (w = h + 1),
              S.AddOriginalElement(h + 1, v + 1),
              (m = L + 1 - a))
            : ((h = f[L - 1]),
              (v = h - m - u),
              h > w && S.MarkNextChange(),
              (w = h),
              S.AddModifiedElement(h + 1, v + 1),
              (m = L - 1 - a)),
            N >= 0 &&
              ((f = this.m_reverseHistory[N]),
              (a = f[0]),
              (b = 1),
              (g = f.length - 1));
        } while (--N >= -1);
    ...
    ComputeRecursionPoint(t, r, s, i, a, o, l) {
      ...
      for (let m = 1; m <= v / 2 + 1; m++) {
        let w = 0,
          N = 0;
        (f = this.ClipDiagonalBound(P - m, m, P, A)),
          (h = this.ClipDiagonalBound(P + m, m, P, A));
        for (let _ = f; _ <= h; _ += 2) {
          _ === f || (_ < h && M[_ - 1] < M[_ + 1])
            ? (u = M[_ + 1])
            : (u = M[_ - 1] + 1),
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(w, L)
        )
          return (
            (l[0] = !0),
            (a[0] = w),
            ...
            L > 0 && 1447 > 0 && m <= 1448
              ...
              : (t++, s++, [new Y(t, r - t + 1, s, i - s + 1)])
          );
        (d = this.ClipDiagonalBound(y - m, m, y, A)),
          (C = this.ClipDiagonalBound(y + m, m, y, A));
        for (let _ = d; _ <= C; _ += 2) {
          _ === d || (_ < C && R[_ - 1] >= R[_ + 1])
            ? (u = R[_ + 1] - 1)
            : (u = R[_ - 1]),
            (c = u - (_ - y) - S);
          const E = u;
          for (; u > t && c > s && this.ElementsAreEqual(u, c); ) u--, c--;
          if (((R[_] = u), g && Math.abs(_ - P) <= m && u <= M[_]))
            return (
              (a[0] = u),
              (o[0] = c),
              E >= M[_] && 1447 > 0 && m <= 1448
        ...
        if (m <= 1447) {
          ...
          (_[0] = P - f + 1),
            le.Copy2(M, f, _, 1, h - f + 1),
            this.m_forwardHistory.push(_),
            (_ = new Int32Array(C - d + 2)),
            (_[0] = y - d + 1),
            le.Copy2(R, d, _, 1, C - d + 1),
    ...
    PrettifyChanges(t) {
      ...
      for (let r = t.length - 1; r >= 0; r--) {
        ...
        if (r > 0) {
          const h = t[r - 1];
          (i = h.originalStart + h.originalLength),
            (a = h.modifiedStart + h.modifiedLength);
        }
        ...
        for (let h = 1; ; h++) {
          ...
          if (
            ...
            (l && !this.ModifiedElementsAreEqual(C, C + s.modifiedLength))
          )
            break;
          const A =
            (d === i && C === a ? 5 : 0) +
            this._boundaryScore(d, s.originalLength, C, s.modifiedLength);
          A > c && ((c = A), (u = h));
        }
      ...
      if (this._hasStrings)
        for (let r = 1, s = t.length; r < s; r++) {
          const i = t[r - 1],
            ...
            l = i.originalStart,
            u = a.originalStart + a.originalLength,
            c = u - l,
            f = i.modifiedStart,
            h = a.modifiedStart + a.modifiedLength,
            d = h - f;
          if (o < 5 && c < 20 && d < 20) {
            ...
            if (C) {
              ...
              (v !== i.originalStart + i.originalLength ||
                A !== i.modifiedStart + i.modifiedLength) &&
                ((i.originalLength = v - i.originalStart),
                (i.modifiedLength = A - i.modifiedStart),
                (a.originalStart = v + o),
                (a.modifiedStart = A + o),
                (a.originalLength = u - a.originalStart),
                (a.modifiedLength = h - a.modifiedStart));
            }
          }
        }
      return t;
    ...
    _contiguousSequenceScore(t, r, s) {
      let i = 0;
      for (let a = 0; a < s; a++) {
        if (!this.ElementsAreEqual(t + a, r + a)) return 0;
    ...
    _boundaryScore(t, r, s, i) {
      const a = this._OriginalRegionIsBoundary(t, r) ? 1 : 0,
        o = this._ModifiedRegionIsBoundary(s, i) ? 1 : 0;
      return a + o;
    }
    ConcatenateChanges(t, r) {
      ...
      if (this.ChangesOverlap(t[t.length - 1], r[0], s)) {
        ...
        return (
          le.Copy(t, 0, i, 0, t.length - 1),
          (i[t.length - 1] = s[0]),
          le.Copy(r, 1, i, t.length, r.length - 1),
          i
        );
      } else {
        const i = new Array(t.length + r.length);
        return (
          le.Copy(t, 0, i, 0, t.length), le.Copy(r, 0, i, t.length, r.length), i
        );
      }
    }
    ChangesOverlap(t, r, s) {
      if (
        ...
        return (
          t.originalStart + t.originalLength >= r.originalStart &&
            (a = r.originalStart + r.originalLength - t.originalStart),
          t.modifiedStart + t.modifiedLength >= r.modifiedStart &&
  ...
  let ce;
  if (typeof B.vscode < "u" && typeof B.vscode.process < "u") {
    const e = B.vscode.process;
    ce = {
      get platform() {
        return e.platform;
      },
    ...
    typeof process < "u"
      ...
      : (ce = {
          get platform() {
            return de ? "win32" : Qn ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function V(e, t) {
    if (typeof e != "string") throw new Nt(t, "string", e);
  }
  function k(e) {
    return e === T || e === q;
  }
        ...
        if (!(o === c - 1 || l === 1))
          if (l === 2) {
            if (
              i.length < 2 ||
              a !== 2 ||
              i.charCodeAt(i.length - 1) !== J ||
              i.charCodeAt(i.length - 2) !== J
            ) {
              if (i.length > 2) {
  ...
  function vt(e, t) {
    if (t === null || typeof t != "object")
      throw new Nt("pathObject", "Object", t);
  ...
  const I = {
      resolve(...e) {
        ...
        for (let i = e.length - 1; i >= -1; i--) {
          let a;
          if (i >= 0) {
            if (((a = e[i]), V(a, "path"), a.length === 0)) continue;
          } else
            t.length === 0
              ? (a = ze())
              : ((a = Ar[`=${t}`] || ze()),
          ...
          if (o === 1) k(f) && ((l = 1), (c = !0));
            ...
            if (((c = !0), k(a.charCodeAt(1)))) {
              let h = 2,
                d = h;
              for (; h < o && !k(a.charCodeAt(h)); ) h++;
              if (h < o && h !== d) {
                const C = a.slice(d, h);
                for (d = h; h < o && k(a.charCodeAt(h)); ) h++;
                if (h < o && h !== d) {
                  for (d = h; h < o && !k(a.charCodeAt(h)); ) h++;
                  (h === o || h !== d) &&
                    ((u = `\\\\${C}\\${a.slice(d, h)}`), (l = h));
      ...
      normalize(e) {
        ...
        if (t === 1) return Ge(a) ? "\\" : e;
        if (k(a))
          if (((i = !0), k(e.charCodeAt(1)))) {
            let l = 2,
              u = l;
            for (; l < t && !k(e.charCodeAt(l)); ) l++;
            if (l < t && l !== u) {
              const c = e.slice(u, l);
              for (u = l; l < t && k(e.charCodeAt(l)); ) l++;
              if (l < t && l !== u) {
                for (u = l; l < t && !k(e.charCodeAt(l)); ) l++;
          ...
          ee(a) &&
            ...
            ((s = e.slice(0, 2)),
            (r = 2),
            t > 2 && k(e.charCodeAt(2)) && ((i = !0), (r = 3)));
        let o = r < t ? Se(e.slice(r), !i, "\\", k) : "";
        return (
          o.length === 0 && !i && (o = "."),
          o.length > 0 && k(e.charCodeAt(t - 1)) && (o += "\\"),
          s === void 0 ? (i ? `\\${o}` : o) : i ? `${s}\\${o}` : `${s}${o}`
        );
      },
      isAbsolute(e) {
        V(e, "path");
        ...
        return (
          k(r) ||
          (t > 2 && ee(r) && e.charCodeAt(1) === K && k(e.charCodeAt(2)))
        );
      },
      join(...e) {
      ...
      relative(e, t) {
        ...
        let a = e.length;
        for (; a - 1 > i && e.charCodeAt(a - 1) === q; ) a--;
        const o = a - i;
        let l = 0;
        ...
        if (d !== f) {
          ...
          if (c > f) {
            if (t.charCodeAt(l + d) === q) return s.slice(l + d + 1);
            if (d === 2) return s.slice(l + d);
          }
          o > f && (e.charCodeAt(i + d) === q ? (h = d) : d === 2 && (h = 3)),
            h === -1 && (h = 0);
        }
        let C = "";
        for (d = i + h + 1; d <= a; ++d)
          (d === a || e.charCodeAt(d) === q) &&
            (C += C.length === 0 ? ".." : "\\..");
        return (
          (l += h),
          C.length > 0
            ? `${C}${s.slice(l, u)}`
            : (s.charCodeAt(l) === q && ++l, s.slice(l, u))
        );
      },
      toNamespacedPath(e) {
        ...
        if (t.charCodeAt(0) === q) {
          if (t.charCodeAt(1) === q) {
            ...
            if (r !== Pr && r !== J) return `\\\\?\\UNC\\${t.slice(2)}`;
          }
        } else if (
          ee(t.charCodeAt(0)) &&
          t.charCodeAt(1) === K &&
      ...
      dirname(e) {
        ...
        if (k(i)) {
          ...
          ee(i) &&
            e.charCodeAt(1) === K &&
            ((r = t > 2 && k(e.charCodeAt(2)) ? 3 : 2), (s = r));
        let a = -1,
          o = !0;
        for (let l = t - 1; l >= s; --l)
          if (k(e.charCodeAt(l))) {
      ...
      parse(e) {
        ...
        let s = 0,
          i = e.charCodeAt(0);
        if (r === 1)
          return k(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
        if (k(i)) {
          if (((s = 1), k(e.charCodeAt(1)))) {
            let h = 2,
              d = h;
            for (; h < r && !k(e.charCodeAt(h)); ) h++;
            if (h < r && h !== d) {
              for (d = h; h < r && k(e.charCodeAt(h)); ) h++;
              if (h < r && h !== d) {
                for (d = h; h < r && !k(e.charCodeAt(h)); ) h++;
                h === r ? (s = h) : h !== d && (s = h + 1);
              }
    ...
    H = {
      resolve(...e) {
        ...
        for (let s = e.length - 1; s >= -1 && !r; s--) {
          const i = s >= 0 ? e[s] : ze();
          V(i, "path"),
            i.length !== 0 && ((t = `${i}/${t}`), (r = i.charCodeAt(0) === T));
        }
        return (t = Se(t, !r, "/", Ge)), r ? `/${t}` : t.length > 0 ? t : ".";
      },
      normalize(e) {
        if ((V(e, "path"), e.length === 0)) return ".";
        const t = e.charCodeAt(0) === T,
          r = e.charCodeAt(e.length - 1) === T;
        return (
          (e = Se(e, !t, "/", Ge)),
          e.length === 0
            ? t
      ...
      relative(e, t) {
        if (
          (V(e, "from"),
          V(t, "to"),
          e === t || ((e = H.resolve(e)), (t = H.resolve(t)), e === t))
        )
          return "";
        const r = 1,
          s = e.length,
        ...
        if (c === l)
          if (o > l) {
            if (t.charCodeAt(a + c) === T) return t.slice(a + c + 1);
            if (c === 0) return t.slice(a + c);
          } else
            i > l && (e.charCodeAt(r + c) === T ? (u = c) : c === 0 && (u = 0));
        let f = "";
        for (c = r + u + 1; c <= s; ++c)
          (c === s || e.charCodeAt(c) === T) &&
            (f += f.length === 0 ? ".." : "/..");
  ...
  (H.win32 = I.win32 = I),
    (H.posix = I.posix = H),
    ne === "win32" ? I.normalize : H.normalize,
    ne === "win32" ? I.resolve : H.resolve,
    ne === "win32" ? I.relative : H.relative,
    ne === "win32" ? I.dirname : H.dirname,
    ne === "win32" ? I.basename : H.basename,
    ne === "win32" ? I.extname : H.extname,
    ne === "win32" ? I.sep : H.sep;
  const Dr = /^\w[\w\d+.-]*$/,
    Fr = /^\//,
    xr = /^\/\//;
  function St(e, t) {
  ...
  class re {
    ...
    with(t) {
      ...
      return (
        r === void 0 ? (r = this.scheme) : r === null && (r = F),
        s === void 0 ? (s = this.authority) : s === null && (s = F),
        i === void 0 ? (i = this.path) : i === null && (i = F),
        a === void 0 ? (a = this.query) : a === null && (a = F),
        o === void 0 ? (o = this.fragment) : o === null && (o = F),
        r === this.scheme &&
        s === this.authority &&
        i === this.path &&
        a === this.query &&
    ...
    static file(t) {
      let r = F;
      if ((de && (t = t.replace(/\\/g, G)), t[0] === G && t[1] === G)) {
        const s = t.indexOf(G, 2);
        s === -1
          ? ((r = t.substring(2)), (t = G))
          : ((r = t.substring(2, s)), (t = t.substring(s) || G));
      }
      return new ue("file", r, t, F, F);
    }
    static from(t) {
      const r = new ue(t.scheme, t.authority, t.path, t.query, t.fragment);
      return St(r, !0), r;
    }
    static joinPath(t, ...r) {
      if (!t.path)
      ...
      return (
        de && t.scheme === "file"
          ? (s = re.file(I.join(Oe(t, !0), ...r)).path)
          : (s = H.join(t.path, ...r)),
        t.with({ path: s })
      );
    }
      ...
      if (t) {
        if (t instanceof re) return t;
        {
          ...
          return (
            ...
            (r._fsPath = t._sep === At ? t.fsPath : null),
            r
          );
        }
      } else return t;
  ...
  class ue extends re {
    ...
    toString(t = !1) {
      return t
        ? je(this, !0)
        : (this._formatted || (this._formatted = je(this, !1)),
          this._formatted);
    }
    toJSON() {
      const t = { $mid: 1 };
      return (
        this._fsPath && ((t.fsPath = this._fsPath), (t._sep = At)),
  ...
  function Br(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      const s = e.charCodeAt(r);
      s === 35 || s === 63
        ? (t === void 0 && (t = e.substr(0, r)), (t += yt[s]))
        : t !== void 0 && (t += e[r]);
    }
    return t !== void 0 ? t : e;
  }
  ...
  function je(e, t) {
    const r = t ? Br : kt;
    let s = "",
      { scheme: i, authority: a, path: o, query: l, fragment: u } = e;
    if (
      (i && ((s += i), (s += ":")),
      (a || i === "file") && ((s += G), (s += G)),
      a)
      ...
      (a = a.toLowerCase()),
        ...
        c === -1
          ? (s += r(a, !1))
          : ((s += r(a.substr(0, c), !1)), (s += a.substr(c)));
    }
    if (o) {
  ...
  function Ae(e) {
    return e.match(Rt) ? e.replace(Rt, t => Mt(t)) : e;
  }
  class W {
    constructor(t, r) {
    ...
    with(t = this.lineNumber, r = this.column) {
      return t === this.lineNumber && r === this.column ? this : new W(t, r);
    }
    delta(t = 0, r = 0) {
  ...
  class x {
    ...
    static plusRange(t, r) {
      ...
      return (
        r.startLineNumber < t.startLineNumber
          ? ((s = r.startLineNumber), (i = r.startColumn))
          : r.startLineNumber === t.startLineNumber
            ? ((s = r.startLineNumber),
              (i = Math.min(r.startColumn, t.startColumn)))
            : ((s = t.startLineNumber), (i = t.startColumn)),
        r.endLineNumber > t.endLineNumber
          ? ((a = r.endLineNumber), (o = r.endColumn))
          : r.endLineNumber === t.endLineNumber
            ? ((a = r.endLineNumber), (o = Math.max(r.endColumn, t.endColumn)))
    ...
    static intersectRanges(t, r) {
      ...
      const l = r.startLineNumber,
        ...
        f = r.endColumn;
      return (
        s < l ? ((s = l), (i = u)) : s === l && (i = Math.max(i, u)),
        a > c ? ((a = c), (o = f)) : a === c && (o = Math.min(o, f)),
        s > a || (s === a && i > o) ? null : new x(s, i, a, o)
      );
    }
    equalsRange(t) {
    ...
    static lift(t) {
      return t
        ? new x(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
        : null;
    }
    static isIRange(t) {
      return (
  ...
  const Ur = 3;
  function Pt(e, t, r, s) {
    return new X(e, t, r).ComputeDiff(s);
  }
  class Dt {
    constructor(t) {
      const r = [],
    ...
    createCharSequence(t, r, s) {
      ...
      for (let u = r; u <= s; u++) {
        ...
        !t &&
          u < s &&
          ((i[l] = 10), (a[l] = u + 1), (o[l] = c.length + 1), l++);
      }
      return new Ir(i, a, o);
    }
  }
  ...
  class me {
    ...
    static createFromDiffChange(t, r, s) {
      const i = r.getStartLineNumber(t.originalStart),
        a = r.getStartColumn(t.originalStart),
  ...
  function qr(e) {
    ...
    for (let s = 1, i = e.length; s < i; s++) {
      const a = e[s],
        o = a.originalStart - (r.originalStart + r.originalLength),
        l = a.modifiedStart - (r.modifiedStart + r.modifiedLength);
      Math.min(o, l) < Ur
        ? ((r.originalLength =
            a.originalStart + a.originalLength - r.originalStart),
          (r.modifiedLength =
            a.modifiedStart + a.modifiedLength - r.modifiedStart))
        : (t.push(a), (r = a));
    }
    return t;
  }
  class ge {
    ...
    static createFromDiffResult(t, r, s, i, a, o, l) {
      ...
      if (
        (r.originalLength === 0
          ? ((u = s.getStartLineNumber(r.originalStart) - 1), (c = 0))
          : ((u = s.getStartLineNumber(r.originalStart)),
            (c = s.getEndLineNumber(r.originalStart + r.originalLength - 1))),
        r.modifiedLength === 0
          ? ((f = i.getStartLineNumber(r.modifiedStart) - 1), (h = 0))
          : ((f = i.getStartLineNumber(r.modifiedStart)),
            (h = i.getEndLineNumber(r.modifiedStart + r.modifiedLength - 1))),
        o &&
          r.originalLength > 0 &&
          r.originalLength < 20 &&
          r.modifiedLength > 0 &&
        ...
        if (C.getElements().length > 0 && v.getElements().length > 0) {
          let A = Pt(C, v, a, !0).changes;
          l && (A = qr(A)), (d = []);
          for (let M = 0, R = A.length; M < R; M++)
            d.push(me.createFromDiffChange(A[M], C, v));
        }
      }
  ...
  class Hr {
    constructor(t, r, s) {
      (this.shouldComputeCharChanges = s.shouldComputeCharChanges),
        ...
        (this.original = new Dt(t)),
        (this.modified = new Dt(r)),
        (this.continueLineDiff = Ft(s.maxComputationTime)),
        (this.continueCharDiff = Ft(
          s.maxComputationTime === 0 ? 0 : Math.min(s.maxComputationTime, 5e3)
        ));
    }
    computeDiff() {
      if (
      ...
      for (let l = -1, u = r.length; l < u; l++) {
        ...
        for (; a < f && o < h; ) {
          const d = this.originalLines[a],
            C = this.modifiedLines[o];
          if (d !== C) {
            {
              let v = Qe(d, 1),
                A = Qe(C, 1);
              for (; v > 1 && A > 1; ) {
                const M = d.charCodeAt(v - 2),
                  R = C.charCodeAt(A - 2);
                if (M !== R) break;
                v--, A--;
              }
              (v > 1 || A > 1) &&
                this._pushTrimWhitespaceCharChange(i, a + 1, 1, v, o + 1, 1, A);
            }
            {
              let v = Ze(d, 1),
                A = Ze(C, 1);
              const M = d.length + 1,
                R = C.length + 1;
              for (; v < M && A < R; ) {
                const P = d.charCodeAt(v - 1),
                  y = d.charCodeAt(A - 1);
                if (P !== y) break;
                v++, A++;
              }
              (v < M || A < R) &&
                this._pushTrimWhitespaceCharChange(i, a + 1, v, M, o + 1, A, R);
            }
          }
          a++, o++;
        }
    ...
    _pushTrimWhitespaceCharChange(t, r, s, i, a, o, l) {
      if (this._mergeTrimWhitespaceCharChange(t, r, s, i, a, o, l)) return;
      let u;
      this.shouldComputeCharChanges && (u = [new me(r, s, r, i, a, o, a, l)]),
        t.push(new ge(r, r, a, a, u));
    }
    _mergeTrimWhitespaceCharChange(t, r, s, i, a, o, l) {
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ? !1
        : c.originalEndLineNumber + 1 === r && c.modifiedEndLineNumber + 1 === a
          ? ((c.originalEndLineNumber = r),
            (c.modifiedEndLineNumber = a),
            this.shouldComputeCharChanges &&
              c.charChanges &&
              c.charChanges.push(new me(r, s, r, i, a, o, a, l)),
            !0)
          : !1;
    }
  }
  ...
  class Wr {
    ...
    removeValues(t, r) {
      ...
      return (
        ...
        r === 0
          ? !1
          : ((this.values = new Uint32Array(s.length - r)),
            this.values.set(s.subarray(0, t), 0),
            this.values.set(s.subarray(t + r), t),
            (this.prefixSum = new Uint32Array(this.values.length)),
            t - 1 < this.prefixSumValidIndex[0] &&
              (this.prefixSumValidIndex[0] = t - 1),
            this.prefixSumValidIndex[0] >= 0 &&
      ...
      for (const s of r)
        this._acceptDeleteRange(s.range),
          this._acceptInsertText(
            new W(s.range.startLineNumber, s.range.startColumn),
            s.text
          );
    ...
    _ensureLineStarts() {
      if (!this._lineStarts) {
        const t = this._eol.length,
          ...
          s = new Uint32Array(r);
        for (let i = 0; i < r; i++) s[i] = this._lines[i].length + t;
        this._lineStarts = new Wr(s);
      }
    }
    _setLineText(t, r) {
      (this._lines[t] = r),
  ...
  function Or(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const r of Gr) e.indexOf(r) >= 0 || (t += "\\" + r);
  ...
  const Tt = new pe();
  Tt.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  function Ye(e, t, r, s, i) {
    if ((i || (i = Ce.first(Tt)), r.length > i.maxLen)) {
      let c = e - i.maxLen / 2;
      return (
        c < 0 ? (c = 0) : (s += c),
  ...
  class Xe {
    constructor(t) {
      ...
      (this._defaultValue = r),
        (this._asciiMap = Xe._createAsciiMap(r)),
        (this._map = new Map());
    }
    static _createAsciiMap(t) {
      const r = new Uint8Array(256);
      for (let s = 0; s < 256; s++) r[s] = t;
      return r;
    }
    set(t, r) {
      const s = Et(r);
  ...
  function Jr() {
    if (be === null) {
      be = new Xe(0);
      const e = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
      for (let r = 0; r < e.length; r++) be.set(e.charCodeAt(r), 1);
      const t = ".,;:";
      for (let r = 0; r < t.length; r++) be.set(t.charCodeAt(r), 2);
    }
    return be;
  }
  class ye {
      ...
      for (let a = 1, o = t.getLineCount(); a <= o; a++) {
        ...
        for (; c < u; ) {
          ...
          if (d === 13) {
            ...
            y === 1 && (i.push(ye._createLink(s, l, a, f, c)), (R = !0));
          } else if (d === 12) {
            let y;
            P === 91 ? ((v = !0), (y = 0)) : (y = s.get(P)),
              y === 1 ? (R = !0) : (d = 13);
          } else (d = r.nextState(d, P)), d === 0 && (R = !0);
          R && ((d = 1), (C = !1), (v = !1), (M = !1), (f = c + 1), (h = P)),
            c++;
        }
        d === 13 && i.push(ye._createLink(s, l, a, f, u));
      }
      return i;
    }
  }
  ...
  class Ke {
    ...
    numberReplace(t, r) {
      ...
      return !isNaN(i) && !isNaN(a) && i === a
        ? i === 0 && !r
          ? null
          : ((i = Math.floor(i * s)), (i += r ? s : -s), String(i / s))
        : null;
    }
    textReplace(t, r) {
  ...
  Ke.INSTANCE = new Ke();
  const Bt = Object.freeze(function (e, t) {
  ...
  (function (e) {
    function t(r) {
      return r === e.None || r === e.Cancelled || r instanceof Me
        ? !0
        : !r || typeof r != "object"
          ? !1
  ...
  (function () {
    ...
    for (const i of t) {
      ...
      if (
        (s[l] || ((s[l] = !0), (n1[u] = l), (r1[u.toLowerCase()] = l)), !r[c])
      ) {
        if (((r[c] = !0), !f))
          throw new Error(
            `String representation missing for key code ${c} around scan code ${u}`
          );
        Re.define(c, f), tt.define(c, C || f), nt.define(c, v || C || f);
      }
      h && (t1[h] = c);
    }
  })();
  ...
  (function (e) {
    function t(l) {
      return Re.keyCodeToStr(l);
    }
    e.toString = t;
    function r(l) {
      return Re.strToKeyCode(l);
    }
    e.fromString = r;
    function s(l) {
    ...
    function a(l) {
      return tt.strToKeyCode(l) || nt.strToKeyCode(l);
    }
  ...
  class $ extends x {
    ...
    setEndPosition(t, r) {
      return this.getDirection() === 0
        ? new $(this.startLineNumber, this.startColumn, t, r)
        : new $(t, r, this.startLineNumber, this.startColumn);
    }
    getPosition() {
    ...
    setStartPosition(t, r) {
      return this.getDirection() === 0
        ? new $(t, r, this.endLineNumber, this.endColumn)
        : new $(this.endLineNumber, this.endColumn, t, r);
    }
    static fromPositions(t, r = t) {
    ...
    static selectionsArrEqual(t, r) {
      ...
      for (let s = 0, i = t.length; s < i; s++)
        if (!this.selectionsEqual(t[s], r[s])) return !1;
      return !0;
    }
  ...
  (n._allCodicons = []),
    ...
    (n.debugBreakpointDataDisabled = new n("debug-breakpoint-data-disabled", {
      fontCharacter: "\\eaa9"
    })),
    (n.debugBreakpointLogUnverified = new n("debug-breakpoint-log-unverified", {
      fontCharacter: "\\eaaa"
    })),
    ...
    (n.circleSmallFilled = new n("circle-small-filled", {
      fontCharacter: "\\eb8a"
    })),
    (n.debugStackframeDot = new n(
      "debug-stackframe-dot",
      n.circleSmallFilled.definition
    )),
    ...
    (n.layoutSidebarRightOff = new n("layout-sidebar-right-off", {
      fontCharacter: "\\ec00"
    })),
    (n.layoutPanelOff = new n("layout-panel-off", { fontCharacter: "\\ec01" })),
    (n.layoutSidebarLeftOff = new n("layout-sidebar-left-off", {
      fontCharacter: "\\ec02"
    })),
    ...
    (n.arrowCircleDown = new n("arrow-circle-down", {
      fontCharacter: "\\ebfc"
    })),
    (n.arrowCircleLeft = new n("arrow-circle-left", {
      fontCharacter: "\\ebfd"
    })),
    (n.arrowCircleRight = new n("arrow-circle-right", {
      fontCharacter: "\\ebfe"
    })),
    ...
    (n.commentUnresolved = new n("comment-unresolved", {
      fontCharacter: "\\ec0a"
    })),
    (n.gitPullRequestGoToChanges = new n("git-pull-request-go-to-changes", {
      fontCharacter: "\\ec0b"
    })),
    (n.gitPullRequestNewChanges = new n("git-pull-request-new-changes", {
      fontCharacter: "\\ec0c"
    })),
  ...
  (function (e) {
    ...
    function r(a) {
      if (a instanceof n) return ["codicon", "codicon-" + a.id];
      const o = t.exec(a.id);
      if (!o) return r(n.error);
      const [, l, u] = o,
        c = ["codicon", "codicon-" + l];
  ...
  (we.CtrlCmd = 2048), (we.Shift = 1024), (we.Alt = 512), (we.WinCtrl = 256);
  function l1() {
    return {
      editor: void 0,
      languages: void 0,
      CancellationTokenSource: e1,
      Emitter: j,
      KeyCode: st,
      KeyMod: we,
      Position: W,
  ...
  function h1(e, t, r, s, i) {
    return c1(e, t, r, s, i) && u1(e, t, r, s, i);
  }
  class f1 {
    constructor(t, r) {
    ...
    next(t) {
      ...
      do {
        ...
        if (i === this._prevMatchStartIndex && a === this._prevMatchLength) {
          if (a === 0) {
            fr(t, r, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || h1(this._wordSeparators, t, r, i, a))
        )
          return s;
      } while (s);
      return null;
  ...
  class d1 {
    static computeUnicodeHighlights(t, r, s) {
      ...
      l === "allNonBasicAscii"
        ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (u = new RegExp(`${m1(Array.from(l))}`, "g"));
      const c = new f1(null, u),
        f = [];
      let h = !1,
        d,
        C = 0,
        v = 0,
        A = 0;
      e: for (let M = i, R = a; M <= R; M++) {
        const P = t.getLineContent(M),
          y = P.length;
        c.reset(0);
        do
          if (((d = c.next(P)), d)) {
            ...
            const b = P.substring(p, S),
              g = Ye(p + 1, Vt, P, 0),
              m = o.shouldHighlightNonBasicASCII(b, g ? g.word : null);
            if (m !== 0) {
              m === 3 ? C++ : m === 2 ? v++ : m === 1 ? A++ : sr();
              const w = 1e3;
              if (f.length >= w) {
                h = !0;
                break e;
              }
              f.push(new x(M, p + 1, M, S + 1));
            }
          }
        while (d);
      }
  ...
  function m1(e, t) {
    return `[${ar(e.map(s => String.fromCodePoint(s)).join(""))}]`;
  }
  class Dn {
    constructor(t) {
      (this.options = t),
        (this.allowedCodePoints = new Set(t.allowedCodePoints)),
        (this.ambiguousCharacters = z.getInstance(new Set(t.allowedLocales)));
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return "allNonBasicAscii";
      const t = new Set();
      if (this.options.invisibleCharacters)
        for (const r of Z.codePoints) Fn(String.fromCodePoint(r)) || t.add(r);
...
` ||
  ...
  class g1 extends zr {
    ...
    getWordAtPosition(t, r) {
      const s = Ye(t.column, jr(r), this._lines[t.lineNumber - 1], 0);
      return s
        ? new x(t.lineNumber, s.startColumn, t.lineNumber, s.endColumn)
        : null;
    }
    words(t) {
      const r = this._lines,
    ...
    positionAt(t) {
      ...
      const r = this._lineStarts.getIndexOf(t),
        s = this._lines[r.index].length;
      return { lineNumber: 1 + r.index, column: 1 + Math.min(r.remainder, s) };
    }
    _validateRange(t) {
    ...
    _validatePosition(t) {
      if (!W.isIPosition(t)) throw new Error("bad position");
      let { lineNumber: r, column: s } = t,
        i = !1;
      if (r < 1) (r = 1), (s = 1), (i = !0);
  ...
  class ie {
    ...
    computeUnicodeHighlights(t, r, s) {
      return se(this, void 0, void 0, function* () {
        ...
        return i
          ? d1.computeUnicodeHighlights(i, r, s)
          : {
              ranges: [],
              hasMore: !1,
    ...
    computeDiff(t, r, s, i) {
      return se(this, void 0, void 0, function* () {
        const a = this._getModel(t),
          o = this._getModel(r);
        return !a || !o ? null : ie.computeDiff(a, o, s, i);
      });
    }
    static computeDiff(t, r, s, i) {
      const a = t.getLinesContent(),
        o = r.getLinesContent(),
        u = new Hr(a, o, {
    ...
    computeMoreMinimalEdits(t, r) {
      return se(this, void 0, void 0, function* () {
        ...
        for (let { range: o, text: l, eol: u } of r) {
          if ((typeof u == "number" && (a = u), x.isEmpty(o) && !l)) continue;
          const c = s.getValueInRange(o);
          if (((l = l.replace(/\r\n|\n|\r/g, s.eol)), c === l)) continue;
          if (Math.max(l.length, c.length) > ie._diffLimit) {
            i.push({ range: o, text: l });
            continue;
          }
          const f = Sr(c, l, !1),
            h = s.offsetAt(x.lift(o).getStartPosition());
          for (const d of f) {
            const C = s.positionAt(h + d.originalStart),
              v = s.positionAt(h + d.originalStart + d.originalLength),
              A = {
        ...
        e: for (const u of t) {
          ...
          if (!!c) {
            for (const f of c.words(o))
              if (
                !(f === r || !isNaN(Number(f))) &&
                (l.add(f), l.size > ie._suggestionsLimit)
              )
                break e;
          }
        }
    ...
    navigateValueSet(t, r, s, i, a) {
      return se(this, void 0, void 0, function* () {
        ...
        return Ke.INSTANCE.navigateValueSet(r, u, c, f, s);
      });
    }
    loadForeignModule(t, r, s) {
      const o = {
        host: rr(s, (l, u) => this._host.fhr(l, u)),
        getMirrorModels: () => this._getModels()
      };
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(o, r)),
          Promise.resolve(We(this._foreignModule)))
  ...
  (ie._diffLimit = 1e5),
    ...
    typeof importScripts == "function" && (B.monaco = l1());
  let lt = !1;
  function xn(e) {
    if (lt) return;
    lt = !0;
