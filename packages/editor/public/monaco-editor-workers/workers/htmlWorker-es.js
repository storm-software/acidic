...
function sa(e) {
  return e instanceof oa
    ? !0
    : e instanceof Error && e.name === jt && e.message === jt;
}
...
let re;
typeof ie.vscode < "u" && typeof ie.vscode.process < "u"
  ? (re = ie.vscode.process)
  : typeof process < "u" && (re = process);
const ga =
    typeof ((Ft = re == null ? void 0 : re.versions) === null || Ft === void 0
      ? void 0
      : Ft.electron) == "string",
  ba = ga && (re == null ? void 0 : re.type) === "renderer";
if (typeof navigator == "object" && !ba)
  (Ee = navigator.userAgent),
    (Gt = Ee.indexOf("Windows") >= 0),
    ($t = Ee.indexOf("Macintosh") >= 0),
    (Ee.indexOf("Macintosh") >= 0 ||
      Ee.indexOf("iPad") >= 0 ||
      Ee.indexOf("iPhone") >= 0) &&
      !!navigator.maxTouchPoints &&
      navigator.maxTouchPoints > 0,
    (Bt = Ee.indexOf("Linux") >= 0),
    (Di = !0),
    ma({ key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] }, "_"),
    (dt = Ke),
    (Pt = dt);
else if (typeof re == "object") {
  (Gt = re.platform === "win32"),
    ($t = re.platform === "darwin"),
    (Bt = re.platform === "linux"),
    Bt && !!re.env.SNAP && re.env.SNAP_REVISION,
    re.env.CI || re.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
    (dt = Ke),
    (Pt = Ke);
...
Di && ie.importScripts;
const Ae = Ee,
  va = typeof ie.postMessage == "function" && !ie.importScripts;
(() => {
  if (va) {
    const e = [];
...
(function (e) {
  ...
  function w(D, p, m = b => b) {
    const b = (...W) => x.fire(m(...W)),
      ...
      x = new ke({ onFirstListenerAdd: I, onLastListenerRemove: C });
    return x.event;
  }
    ...
    (this._disposed = !1),
      ...
      (this._perfMon =
        !((n = this._options) === null || n === void 0) && n._profName
          ? new Wt(this._options._profName)
          : void 0),
      (this._deliveryQueue =
...
function Jt(e) {
  const t = [];
  for (const n of Sa(e)) typeof e[n] == "function" && t.push(n);
  return t;
}
function xa(e, t) {
  const n = i =>
...
Ni = ge;
ge.ambiguousCharacterData = new Ri(() =>
  JSON.parse(
    ...
    const i = new ke({
      ...
      onLastListenerRemove: () => {
        this._pendingEmitters.delete(r),
          this._send(new Oa(this._workerId, r)),
          (r = null);
      }
    });
    return i.event;
    ...
    this._handler.handleMessage(t.method, t.args).then(
      ...
      i => {
        i.detail instanceof Error && (i.detail = Dn(i.detail)),
          this._send(new Rn(this._workerId, n, void 0, Dn(i)));
      }
    );
  }
...
class Ga {
  ...
  _handleMessage(t, n) {
    if (t === Fa) return this.initialize(n[0], n[1], n[2], n[3]);
  ...
  initialize(t, n, r, i) {
    ...
    return this._requestHandlerFactory
      ? ((this._requestHandler = this._requestHandlerFactory(u)),
        Promise.resolve(Jt(this._requestHandler)))
      : (n &&
...
function $a(e, t) {
  t = Nn(149417, t);
  for (let n = 0, r = e.length; n < r; n++) t = Nn(e.charCodeAt(n), t);
  return t;
}
class Un {
  constructor(t) {
...
class Re {
  constructor(t, n, r = null) {
    ...
    const [i, s, l] = Re._getElements(t),
      [u, o, c] = Re._getElements(n);
  ...
  static _getElements(t) {
    ...
    if (Re._isStringArray(n)) {
      ...
      for (let i = 0, s = n.length; i < s; i++) r[i] = $a(n[i], 0);
      return [n, r, !0];
    }
  ...
  ElementsAreStrictEqual(t, n) {
    ...
    const r = Re._getStrictElement(this._originalSequence, t),
      i = Re._getStrictElement(this._modifiedSequence, n);
    return r === i;
  }
  ...
  ComputeDiffRecursive(t, n, r, i, s) {
    ...
    if (!s[0]) {
      ...
      return (
        s[0]
          ? (f = [new Me(c + 1, n - (c + 1) + 1, h + 1, i - (h + 1) + 1)])
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
      ...
      return (
        Ve.Copy(t, 0, i, 0, t.length - 1),
        (i[t.length - 1] = r[0]),
        Ve.Copy(n, 1, i, t.length, n.length - 1),
        i
      );
    } else {
      const i = new Array(t.length + n.length);
      return (
        Ve.Copy(t, 0, i, 0, t.length), Ve.Copy(n, 0, i, t.length, n.length), i
      );
    }
  }
...
function K(e, t) {
  if (typeof e != "string") throw new zi(t, "string", e);
}
function V(e) {
  return e === te || e === le;
}
...
const oe = {
    ...
    isAbsolute(e) {
      ...
      return (
        V(n) || (t > 2 && xe(n) && e.charCodeAt(1) === Se && V(e.charCodeAt(2)))
      );
    },
    join(...e) {
    ...
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === le) {
        if (t.charCodeAt(1) === le) {
          ...
          if (n !== es && n !== Ue) return `\\\\?\\UNC\\${t.slice(2)}`;
        }
      } else if (
        xe(t.charCodeAt(0)) &&
        t.charCodeAt(1) === Se &&
...
class Fe {
  ...
  static file(t) {
    ...
    if ((it && (t = t.replace(/\\/g, ve)), t[0] === ve && t[1] === ve)) {
      ...
      r === -1
        ...
        : ((n = t.substring(2, r)), (t = t.substring(r) || ve));
    }
  ...
  static joinPath(t, ...n) {
    ...
    return (
      it && t.scheme === "file"
        ? (r = Fe.file(oe.join(Kt(t, !0), ...n)).path)
        : (r = he.join(t.path, ...n)),
      t.with({ path: r })
    );
  }
    ...
    if (t) {
      if (t instanceof Fe) return t;
      {
        ...
        return (
          ...
          (n._fsPath = t._sep === Fi ? t.fsPath : null),
          n
        );
      }
    } else return t;
...
class je extends Fe {
  ...
  toString(t = !1) {
    return t
      ? en(this, !0)
      : (this._formatted || (this._formatted = en(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    ...
    return (
      this._fsPath && ((t.fsPath = this._fsPath), (t._sep = Fi)),
...
function zn(e, t) {
  ...
  return (
    r !== -1 && (n += encodeURIComponent(e.substring(r))), n !== void 0 ? n : e
  );
}
function os(e) {
  let t;
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63
      ? (t === void 0 && (t = e.substr(0, n)), (t += Bi[r]))
      : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
...
class hs {
  constructor(t, n, r) {
    (this.shouldComputeCharChanges = r.shouldComputeCharChanges),
      ...
      (this.original = new Fn(t)),
      (this.modified = new Fn(n)),
      (this.continueLineDiff = Bn(r.maxComputationTime)),
      (this.continueCharDiff = Bn(
  ...
  _pushTrimWhitespaceCharChange(t, n, r, i, s, l, u) {
    ...
    let o;
    this.shouldComputeCharChanges && (o = [new at(n, r, n, i, s, l, s, u)]),
      t.push(new tt(n, n, s, s, o));
  }
    ...
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
      ...
      : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === s
        ? ((c.originalEndLineNumber = n),
          ...
          this.shouldComputeCharChanges &&
            c.charChanges &&
            c.charChanges.push(new at(n, r, n, i, s, l, s, u)),
          !0)
        : !1;
  }
}
...
function gs(e = "") {
  let t = "(-?\\d*\\.\\d\\w*)|([^";
  for (const n of ps) e.indexOf(n) >= 0 || (t += "\\" + n);
...
class Cn {
  constructor(t) {
    ...
    (this._defaultValue = n),
      (this._asciiMap = Cn._createAsciiMap(n)),
...
class rn {
  ...
  valueSetReplace(t, n, r) {
    let i = t.indexOf(n);
    return i >= 0
      ? ((i += r ? 1 : -1), i < 0 ? (i = t.length - 1) : (i %= t.length), t[i])
      : null;
  }
}
rn.INSTANCE = new rn();
...
(function (e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof gt
      ? !0
      : !n || typeof n != "object"
        ? !1
...
class gt {
  ...
  get onCancellationRequested() {
    return this._isCancelled
      ? ji
      : (this._emitter || (this._emitter = new ke()), this._emitter.event);
  }
  dispose() {
...
const bt = new Sn(),
  ...
  sn = new Sn(),
  Cs = new Array(230),
  Ss = /* @__PURE__ */ Object.create(null),
...
(function () {
  ...
  for (const i of t) {
    ...
    if (
      (r[u] || ((r[u] = !0), (Ss[o] = u), (xs[o.toLowerCase()] = u)), !n[c])
    ) {
      if (((n[c] = !0), !h))
        throw new Error(
...
class fe extends Z {
  ...
  static fromRange(t, n) {
    return n === 0
      ...
      : new fe(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
  ...
  next(t) {
    ...
    do {
      ...
      if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          Ha(t, n, this._searchRegex.lastIndex) > 65535
      ...
      if (
        ...
        !this._wordSeparators || Is(this._wordSeparators, t, n, i, s))
      )
        return r;
    } while (r);
    return null;
...
class zs {
  static computeUnicodeHighlights(t, n, r) {
    ...
    u === "allNonBasicAscii"
      ? (o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
      : (o = new RegExp(`${Ws(Array.from(u))}`, "g"));
    const c = new Hs(null, o),
      h = [];
    let d = !1,
      f,
      g = 0,
          ...
          u = ge
            ...
            .filter(
              o =>
                !ge
                  .getInstance(
                    /* @__PURE__ */ new Set([...n.allowedLocales, o])
                  )
                  .isAmbiguous(s)
            );
        return {
...
class Ir {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ne.codePoints) Hr(String.fromCodePoint(n)) || t.add(n);
      ...
      for (const l of n) {
        ...
        (i = i || o),
          !o &&
            ...
            !Ne.isInvisibleCharacter(u) &&
            (s = !0);
      }
    return !i && s
      ? 0
      : this.options.invisibleCharacters && !Hr(t) && Ne.isInvisibleCharacter(r)
        ? 2
      ...
      *[Symbol.iterator]() {
        for (;;)
          if (l < u.length) {
            ...
            (l += 1), yield o;
          } else if (i < n.length) (s = n[i]), (u = r(s, t)), (l = 0), (i += 1);
          else break;
      }
    };
  }
...
class Be {
  ...
  computeUnicodeHighlights(t, n, r) {
    return ze(this, void 0, void 0, function* () {
      ...
      return i
        ? zs.computeUnicodeHighlights(i, n, r)
        : {
            ranges: [],
            hasMore: !1,
      ...
      e: for (const o of t) {
        ...
        if (!!c) {
          for (const h of c.words(l))
            if (
              !(h === n || !isNaN(Number(h))) &&
              (u.add(h), u.size > Be._suggestionsLimit)
            )
              break e;
        }
      }
  ...
  loadForeignModule(t, n, r) {
    ...
    return this._foreignModuleFactory
      ? ((this._foreignModule = this._foreignModuleFactory(l, n)),
        Promise.resolve(Jt(this._foreignModule)))
...
(function (e) {
  function t(r, i) {
    return (
      r === Number.MAX_VALUE && (r = At.MAX_VALUE),
      i === Number.MAX_VALUE && (i = At.MAX_VALUE),
      { line: r, character: i }
    );
  }
  e.create = t;
  ...
  function n(r) {
    ...
    return (
      ...
      (A.undefined(s.relatedInformation) ||
        A.typedArray(s.relatedInformation, mn.is))
    );
  }
  e.is = n;
})(xt || (xt = {}));
    ...
    (this._textEditChanges = /* @__PURE__ */ Object.create(null)),
      t !== void 0
        ? ((this._workspaceEdit = t),
          t.documentChanges
            ? ((this._changeAnnotations = new jr(t.changeAnnotations)),
  ...
  return (
      ...
      if (Et.is(t)) {
        ...
        if (!r) {
          ...
          this._workspaceEdit.documentChanges.push(s),
            (r = new mt(i, this._changeAnnotations)),
    ...
    (e.prototype.initDocumentChanges = function () {
      this._workspaceEdit.documentChanges === void 0 &&
        ...
        ((this._changeAnnotations = new jr()),
...
(function (e) {
  ...
  function n(r) {
    ...
    return (
      A.defined(i) &&
      A.typedArray(i.diagnostics, xt.is) &&
...
(function (e) {
  ...
  function n(r) {
    ...
    return (
      i &&
      A.string(i.title) &&
      (i.diagnostics === void 0 || A.typedArray(i.diagnostics, xt.is)) &&
...
(function (e) {
  ...
  function r(s, l) {
    for (
      ...
      if (g <= c) u = u.substring(0, f) + d.newText + u.substring(g, u.length);
...
var Nt = class {
    ...
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 &&
          (this._lineOffsets = mi(this._content, !0)),
        this._lineOffsets
      );
    }
    positionAt(e) {
...
(function (e) {
  ...
  e.create = t;
  function n(i, s, l) {
    if (i instanceof Nt) return i.update(s, l), i;
    throw new Error(
    ...
    return (
      ...
      (e.prototype.advanceUntilChars = function (t) {
        for (; this.position + t.length <= this.source.length; ) {
          for (
            var n = 0;
            n < t.length && this.source.charCodeAt(this.position + n) === t[n];
            n++
          );
      ...
      (e.prototype.advanceWhileChar = function (t) {
        for (
          var n = this.position;
          this.position < this.len && t(this.source.charCodeAt(this.position));
...
function pe(e, t, n, r) {
  ...
  function y() {
    ...
    return M !== U.EOS &&
      _ === i.pos() &&
      !(r && (M === U.StartTagClose || M === U.EndTagClose))
      ? (console.log(
  ...
  function k() {
    var _ = i.pos();
    if (i.eos()) return w(_, U.EOS);
    var L;
    switch (s) {
      case O.WithinComment:
        return i.advanceIfChars([$e, $e, Te])
          ? ((s = O.WithinContent), w(_, U.EndCommentTag))
          : (i.advanceUntilChars([$e, $e, Te]), w(_, U.Comment));
      case O.WithinDoctype:
        return i.advanceIfChar(Te)
          ? ((s = O.WithinContent), w(_, U.EndDoctypeTag))
          : (i.advanceUntilChar(Te), w(_, U.Doctype));
      case O.WithinContent:
        if (i.advanceIfChar(pt)) {
          ...
          return i.advanceIfChar(Ot)
            ? ((s = O.AfterOpeningEndTag), w(_, U.EndTagOpen))
            : ((s = O.AfterOpeningStartTag), w(_, U.StartTagOpen));
        }
        return i.advanceUntilChar(pt), w(_, U.Content);
      case O.AfterOpeningEndTag:
        var M = g();
        return M.length > 0
          ? ((s = O.WithinEndTag), w(_, U.EndTag))
          : i.skipWhitespace()
            ? w(
                _,
                U.Whitespace,
            ...
            : ((s = O.WithinEndTag),
              ...
              _ < i.pos()
                ...
                : k());
      case O.WithinEndTag:
        if (i.skipWhitespace()) return w(_, U.Whitespace);
        ...
        if (r && i.peekChar() === pt)
          return (
            ...
            w(
              _,
              U.EndTagClose,
              Le("error.closingBracketMissing", "Closing bracket missing.")
            )
          );
      ...
      case O.AfterOpeningStartTag:
        return (
          ...
          (d = void 0),
          h.length > 0
            ? ((c = !1), (s = O.WithinTag), w(_, U.StartTag))
            : i.skipWhitespace()
              ? w(
                  _,
                  U.Whitespace,
      ...
      case O.WithinTag:
        return i.skipWhitespace()
          ? ((c = !0), w(_, U.Whitespace))
          : c && ((d = v()), d.length > 0)
            ? ((s = O.AfterAttributeName), (c = !1), w(_, U.AttributeName))
            : i.advanceIfChars([Ot, Te])
              ? ((s = O.WithinContent), w(_, U.StartTagSelfClose))
              : i.advanceIfChar(Te)
                ? (h === "script"
                    ? f && Ks[f]
                      ? (s = O.WithinContent)
      ...
      case O.AfterAttributeName:
        return i.skipWhitespace()
          ? ((c = !0), w(_, U.Whitespace))
          : i.advanceIfChar(js)
            ? ((s = O.BeforeAttributeValue), w(_, U.DelimiterAssign))
            : ((s = O.WithinTag), k());
      ...
      case O.WithinScriptContent:
        for (var p = 1; !i.eos(); ) {
          ...
          if (m.length === 0) return i.goToEnd(), w(_, U.Script);
          if (m === "<!--") p === 1 && (p = 2);
          else if (m === "-->") p = 1;
          else if (m[1] !== "/") p === 2 && (p = 3);
          else if (p === 3) p = 2;
...
function Ut(e) {
  return (
    !!e &&
    eo(to, e.toLowerCase(), function (t, n) {
        ...
        r.parent &&
          ...
          t.getTokenLength()
            ? ((r.startTagEnd = t.getTokenEnd()),
              r.tag && Ut(r.tag) && ((r.closed = !0), (r = r.parent)))
            : (r = r.parent));
        break;
        ...
        return _i(this, void 0, void 0, function () {
          ...
          return yi(this, function (v) {
            switch (v.label) {
              ...
              case 1:
                return (
                  v.trys.push([1, 3, , 4]), (u = []), [4, this.readDirectory(l)]
                );
              case 2:
          ...
          return yo(this, function (h) {
            switch (h.label) {
              case 0:
                ...
                (l = new co(this.lsOptions.fileSystemProvider.readDirectory)),
...
\r`.indexOf(F) >= 0
        ...
        function _(R, N, F) {
          F === void 0 && (F = h);
          var G = w(R, F),
            $ = Ti(c, F, O.WithinEndTag, U.EndTagClose) ? "" : ">",
            j = d;
          for (N && (j = j.parent); j; ) {
            var J = j.tag;
            if (J && (!j.closed || (j.endTagStart && j.endTagStart > h))) {
              ...
              if (ye !== null && Ce !== null && ye !== Ce) {
                var de = ye + "</" + J + $;
                (se.textEdit = ee.replace(w(R - 1 - Ce.length), de)),
                  (se.filterText = Ce + "</" + J);
              }
        ...
        function m(R, N) {
          ...
          if (h > R && h <= N && Ao(c[R])) {
            ...
            (F = w(se, ye)),
              ...
              (G = !1);
          } else (F = w(R, N)), ($ = c.substring(R, h)), (G = !0);
          if (l.length > 0)
            for (
              var Ce = g.toLowerCase(),
                de = v.toLowerCase(),
                He = w(R, N),
                be = 0,
                Ln = l;
        ...
        function C() {
          for (var R = h - 1, N = n.character; R >= 0 && et(c, R); ) R--, N--;
          if (R >= 0 && c[R] === "&") {
            ...
            for (var G in nt)
              if (no(G, ";")) {
                ...
                s.items.push({
                  ...
                  documentation: To(
                    "entity.propose",
                    "Character entity representing '".concat(nt[G], "'")
                  ),
      ...
      (e.prototype.doQuoteComplete = function (t, n, r, i) {
        ...
        if (
          ...
          for (
            var d = pe(t.getText(), h.start), f = d.scan();
            f !== U.EOS && d.getTokenEnd() <= l;
            ...
            if (f === U.AttributeName && d.getTokenEnd() === l - 1)
              return (
                (f = d.scan()),
                f !== U.DelimiterAssign ||
                ((f = d.scan()), f === U.Unknown || f === U.AttributeValue)
                  ? null
                  : c
              );
            f = d.scan();
      ...
      (e.prototype.doTagComplete = function (t, n, r) {
        ...
        if (s === ">") {
          ...
          if (
            ...
            for (
              var u = pe(t.getText(), l.start), o = u.scan();
              o !== U.EOS && u.getTokenEnd() <= i;
      ...
      (e.prototype.doesSupportMarkdown = function () {
        ...
        if (!It(this.supportsMarkdown)) {
          ...
          var i =
            (r =
              (n =
                (t = this.lsOptions.clientCapabilities.textDocument) === null ||
                t === void 0
                  ? void 0
          ...
          this.supportsMarkdown =
            Array.isArray(i) && i.indexOf(_e.Markdown) !== -1;
        }
...
function Ti(e, t, n, r) {
  for (var i = pe(e, t, n), s = i.scan(); s === U.Whitespace; ) s = i.scan();
  return s === r;
}
function Co(e, t, n) {
  for (; t > n && !Ht(e[t - 1]); ) t--;
  ...
  Lo = (function () {
    ...
    return (
      (e.prototype.doHover = function (t, n, r, i) {
        ...
        function d(x, W, B) {
          for (
            var P = function (H) {
                var R = null;
                if (
                  (H.provideTags().forEach(function (N) {
        ...
        function f(x, W, B) {
          for (
            var P = function (H) {
                var R = null;
                if (
                  (H.provideAttributes(x).forEach(function (N) {
        ...
        function v(x, W) {
          ...
          for (var P in nt) {
            var q = null,
              S = "&" + P;
            if (B === S) {
              var T = nt[P].charCodeAt(0).toString(16).toUpperCase(),
                E = "U+";
              if (T.length < 4)
                for (var H = 4 - T.length, R = 0; R < H; ) (E += "0"), (R += 1);
              E += T;
              var N = xo(
                "entity.propose",
                "Character entity representing '"
                  .concat(nt[P], "', unicode equivalent '")
                  .concat(E, "'")
              );
        ...
        function y() {
          for (var x = u - 1, W = n.character; x >= 0 && et(c, x); ) x--, W--;
          for (var B = x + 1, P = W; et(c, B); ) B++, P++;
          if (x >= 0 && c[x] === "&") {
            var q = null;
            return (
              c[B] === ";"
                ? (q = X.create(ne.create(n.line, W), ne.create(n.line, P + 1)))
        ...
        function k(x) {
          for (var W = u - 1, B = "&"; W >= 0 && et(x, W); ) W--;
          for (W = W + 1; et(x, W); ) (B += x[W]), (W += 1);
          return (B += ";"), B;
        }
        ...
        function m(x, W) {
          for (
            var B = pe(t.getText(), x), P = B.scan(), q = void 0;
            P !== U.EOS && B.getTokenEnd() <= W;
      ...
      (e.prototype.doesSupportMarkdown = function () {
        ...
        if (!It(this.supportsMarkdown)) {
          ...
          var i =
            (r =
              (n =
                (t = this.lsOptions.clientCapabilities) === null || t === void 0
                  ? void 0
        ...
        (l.prototype.restart = function () {
          ...
          (l.prototype.peek = function (u) {
            ...
            return (
              (u = u || 0),
              (u += this.__position),
              u >= 0 && u < this.__input_length && (o = this.__input.charAt(u)),
              o
            );
          }),
...
`
            ...
            for (
              ...
              if (this._ch === "/" && this._input.peek() === "*") {
                ...
                S && S.ignore === "start" && (q += d.readIgnored(this._input)),
                  this.print_string(q),
      ...
      function (i) {
        ...
        (s.prototype.restart = function () {
          ...
          (s.prototype.next = function () {
            ...
            return (
              this.hasNext() &&
                ((l = this.__tokens[this.__position]), (this.__position += 1)),
              l
            );
          }),
      ...
      function (i) {
        ...
        (s.prototype.read = function () {
          ...
          (s.prototype.matching = function (l) {
            var u = this._create();
            return (
              (u._match_pattern = this._input.get_regexp(l, !0)), u._update(), u
            );
          }),
...
` +
        ...
        (L.prototype._get_tag_open_token = function (p) {
          ...
          return (
            ...
            (m.is_inline_element =
              y(m.tag_name, this._options.inline) || m.tag_start_char === "{"),
            m
          );
        }),
          (L.prototype._set_tag_position = function (p, m, b, I, C) {
            if (
              ...
              (b.tag_name === "!--" &&
                ...
                b.text.indexOf(`
`) === -1) ||
                (b.is_inline_element || b.is_unformatted || p.print_newline(!1),
        ...
        (L.prototype._do_optional_end_element = function (p) {
          ...
          if (!(p.is_empty_element || !p.is_start_tag || !p.parent)) {
            if (p.tag_name === "body") m = m || this._tag_stack.try_pop("head");
                        ...
                        : p.tag_name === "tbody" || p.tag_name === "tfoot"
                          ? ((m =
                            ...
                            (m =
                              ...
                              this._tag_stack.try_pop("colgroup", ["table"])),
                            (m =
                              m || this._tag_stack.try_pop("thead", ["table"])),
                            (m =
                              m || this._tag_stack.try_pop("tbody", ["table"])))
                          : p.tag_name === "tr"
                            ? ((m =
                                m ||
                                this._tag_stack.try_pop("caption", ["table"])),
          ...
          (v.prototype._read_comment_or_cdata = function (w) {
            ...
            if (w === "<") {
              ...
              L === "!" &&
                ...
                k &&
                  ((y = this._create_token(f.COMMENT, k)), (y.directives = _));
            }
            return y;
          }),
...
function No(e, t, n) {
  var r = e.getText(),
    ...
    l = n.tabSize || 4;
  if (t) {
    for (var u = e.offsetAt(t.start), o = u; o > 0 && Ai(r, o - 1); ) o--;
    o === 0 || ki(r, o - 1) ? (u = o) : o < u && (u = o + 1);
    for (var c = e.offsetAt(t.end), h = c; h < r.length && Ai(r, h); ) h++;
    (h === r.length || ki(r, h)) && (c = h),
      ...
      470: r => {
        ...
        var l = {
          ...
          relative: function (u, o) {
            if (
              (i(u), i(o), u === o || (u = l.resolve(u)) === (o = l.resolve(o)))
            )
              return "";
            ...
            for (
              ...
              if (y === v) {
                if (g > v) {
                  ...
                  d > v &&
                    (u.charCodeAt(c + y) === 47 ? (w = y) : y === 0 && (w = 0));
                break;
              }
      ...
      447: (r, i, s) => {
        ...
        function b(S, T) {
          ...
          if (
            ...
            (j = (N = N.toLowerCase()).indexOf(":")) === -1
              ? (H += E(N, !1))
              : ((H += E(N.substr(0, j), !1)), (H += N.substr(j)));
          }
          if (F) {
            if (
              F.length >= 3 &&
              ...
              (se = F.charCodeAt(1)) >= 65 &&
                se <= 90 &&
                (F = "/"
                  .concat(String.fromCharCode(se + 32), ":")
                  .concat(F.substr(3)));
            else if (F.length >= 2 && F.charCodeAt(1) === 58) {
              var se;
              (se = F.charCodeAt(0)) >= 65 &&
                se <= 90 &&
                (F = ""
                  .concat(String.fromCharCode(se + 32), ":")
                  .concat(F.substr(2)));
    ...
    switch (i) {
      ...
      case U.AttributeValue:
        if (s === "src" || s === "href") {
          ...
          l &&
            typeof u > "u" &&
            ((u = yn(h)), u && t && (u = t.resolveReference(u, e.uri))),
            (l = !1),
            (s = void 0);
        } else if (s === "id") {
...
function Oo(e, t, n) {
  ...
  if (!i.tag) return [];
  var s = [],
    l = xi(U.StartTag, e, i.start),
    u = typeof i.endTagStart == "number" && xi(U.EndTag, e, i.endTagStart);
  return (
    ((l && Si(l, t)) || (u && Si(u, t))) &&
      (l && s.push({ kind: Dt.Read, range: l }),
      u && s.push({ kind: Dt.Read, range: u })),
    s
  );
}
function Ci(e, t) {
...
function Ki(e, t, n, r) {
  var i = jo(t),
    s = Ct.create(e.uri, X.create(e.positionAt(t.start), e.positionAt(t.end))),
    l = {
      name: i,
      location: s,
      containerName: n,
...
function Go(e, t, n, r) {
  var i,
    s = e.offsetAt(t),
    l = r.findNodeAt(s);
  if (!l.tag || !$o(l, s, l.tag)) return null;
  var u = [],
    o = {
          ...
          if (y[1]) s.push({ startLine: h, tagName: "" });
            ...
            if (d >= 0) {
              ...
              (h = f.startLine),
                v > h &&
                  u !== h &&
                  o({ startLine: h, endLine: v, kind: St.Region });
            }
          }
        else {
...
function Yo(e, t) {
  function n(r) {
    for (
      var i = Zo(e, r), s = void 0, l = void 0, u = i.length - 1;
      u >= 0;
      u--
    ) {
      var o = i[u];
  ...
  tl = (function () {
    ...
    return (
      (e.prototype.setDataProviders = function (t, n) {
        var r;
        (this.dataProviders = []),
          t && this.dataProviders.push(new Ji("html5", el)),
...
var al = class {
  constructor(e, t) {
    ...
    if (n != null && n.dataProviders)
      for (const s in n.dataProviders) i.push(il(s, n.dataProviders[s]));
