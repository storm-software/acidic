import { AcidicOperation, AcidicSubscription } from "@acidic/language/ast";
 ...
 */
export default class AcidicSubscriptionValidator
  implements AstValidator<AcidicSubscription>
{
