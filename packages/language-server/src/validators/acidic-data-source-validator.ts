import { AcidicDataSource, isInvocationExpr } from "@acidic/language/ast";
import { SUPPORTED_PROVIDERS } from "@acidic/language/constants";
 ...
 */
export default class AcidicDataSourceValidator
  implements AstValidator<AcidicDataSource>
{
