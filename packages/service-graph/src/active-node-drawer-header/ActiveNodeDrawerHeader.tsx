...
export const ActiveNodeDrawerHeader = ({
	...
	return (
		<div
			className={clsx(
				className,
				"z-40 flex cursor-default flex-col gap-2 bg-gray-700",
			)}
		>
			<div className="bg-slate-200/10">
				<div
					className={clsx(
						"flex min-h-[4rem] w-full flex-col gap-2 border-b-4 bg-gradient-to-r p-2 px-3 transition-colors duration-700 ease-in-out",
						{
