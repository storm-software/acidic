...
# Acidic Engine Application

An application launched by another Acidic application to parse schemas, format files, validate input, and generate code artifacts.
...
Run `nx build acidic-engine` to build the library.

### Running unit tests

Run `nx test acidic-engine` to execute the unit tests via [Jest](https://jestjs.io).

### Linting

Run `nx lint acidic-engine` to run [ESLint](https://eslint.org/) on the package.
