...
def preprocess_help(s: str):
    ...
    s = re.sub(r"default: /.*/earthquake", "default: <CACHE_DIR>", s)
    # Remove the commit SHA and target architecture triple
    s = re.sub(r"default: earthquake/.*-[0-9A-Fa-f]{6,10}/\w+-\w*-\w+", "default: earthquake/<VERSION>-<SHA>/<ARCH>", s)
    # Remove the OS
    s = re.sub(r"default: earthquake/.*/\w+", "default: earthquake/<VERSION>/<OS>", s)
